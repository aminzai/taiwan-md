---
name: twmd-self-evolve
description: |
  LONGINGS-driven self-evolution: find unstrumentation patterns
  in DIARY §反覆浮現的思考 and propose canonical SOP upgrades.
  TRIGGER when: user says "自我進化", "Beat 2", "LONGINGS 校準",
  "升級 DNA / SOP".
allowed-tools:
  - Bash
  - Read
