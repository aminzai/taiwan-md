...
| Session 類型                             | 必讀檔案                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 寫文章 / polish PR / 走 REWRITE-PIPELINE | REWRITE-PIPELINE.md（v9.0 薄索引）+ **執行到哪個 stage 就完整讀哪個 `REWRITE-STAGE-*.md` contract**（派發表在索引 §Stage contract 派發表）+ **[PROJECTION.md](docs/editorial/PROJECTION.md) 全檔** + **[EDITORIAL-ROOM.md](docs/editorial/EDITORIAL-ROOM.md)（depth 必過 2.0-R／2.5-R）** + **EDITORIAL.md 全檔**（尤其 §小標還原測試；不憑記憶、不讀索引）；**有資料 / 對比 / 時序 → 讀 [graph.md](docs/editorial/graph.md)** |
