...
| Session 類型                             | 必讀檔案                                                                                                                                                                                                                                         |
| ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 寫文章 / polish PR / 走 REWRITE-PIPELINE | **REWRITE-PIPELINE-SINGLE.md 全檔**（單檔型，2026-09-19 起現行；v9 多檔型留校察看不讀）＋EDITORIAL.md 全檔＋PROJECTION.md 全檔＋graph.md §一–三、§九＋兩篇範本（黃魚鴞／國宅與居住正義）。⚠️ 材料糧（research raw）主 session 合成時必完整讀一次 |
