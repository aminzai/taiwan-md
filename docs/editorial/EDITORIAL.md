...
status: 'canonical'
current_version: 'v6.19'
last_updated: 2026-09-05
last_session: '2026-09-05-observer-queue-41-chinese-taipei-naming（v6.19：§六 語氣 新增「賽事脈絡的稱名」——OBSERVER-QUEUE #41 哲宇拍板選 B，奧運/亞運/APEC/WHA 脈絡行文主體一律台灣、首次出現加註正式參賽名稱，中華台北保留於直接引述／獎牌榜官方名／解釋名稱本身三種情境）'
...
5. **數字要有象徵重量，不是規格表**（哲宇 2026-08-03 directive）：具體數字進標題是好事（§文字感原則 1「具體的人／地／物」、範例 5「說好三年，放了四十年」），但**數字必須自己扛得起意義**——讀者不用讀內文就能感覺到那個數字在說什麼。三個數字串成一列規格，讀者只會看到「這篇有數據」，感覺不到這個人是誰。判準：**遮住主題名之後，副標剩下的東西還能不能讓人猜到這是誰的人生？**
...
❌ 黃崇仁：一千兩百億債務、四十三家銀行，和一條沒有停下來的產線
   — 三個數字串成規格表。遮住人名，這可以是任何一間欠債重整的公司；
     「一千兩百億」「四十三家」讀者無從感受，「產線沒停」也不知道為什麼重要
✅ 蘭嶼的核廢料：說好三年，放了四十年
   — 同樣是數字，但「三年 vs 四十年」的落差本身就是背叛，不用讀內文就懂
```

**為什麼數字容易失手**：數字看起來客觀、具體、可查證，過得了「不抽象」這關，所以寫手（跟 AI）很容易誤以為堆數字＝夠具體。但**具體 ≠ 有意義**：「四十三家銀行」是具體的，可是讀者心裡沒有一把尺去衡量四十三家算多還算少；「說好三年，放了四十年」也是數字，但它自帶一把尺（承諾 vs 現實），落差就是意義。**數字進標題前先問：這個數字旁邊有沒有一個讓它產生意義的對照物？** 沒有 → 那是規格不是象徵，換掉。
...
- ❌ 引用名人金句當策展人筆記
- ❌ 重複前段論點再講一次
- ❌ **考證報告 dump**（2026-08-04 黃崇仁頭銜筆記，哲宇連兩輪 callout「這整段都不知道在講什麼」）：把查證的推理過程整段重播——證據一（官方紀錄查無）、證據二（指導教授是生理學家）、證據三（回台教生理系）、推論（「比較站得住腳的說法是⋯」）、再替自己辯護（「考證這個頭銜有意義，因為⋯」）。第一輪只做壓縮（證據收攏、刪推論）仍被打回，因為錯的不是長度，是**層級**：勘誤性內容的預設位置是正文一句話或腳註（「這個頭銜比官方紀錄大了一號：⋯」一句帶掉），只有勘誤本身就是策展洞察（黑冠麻鷺型「通行說法把因果搞反了」）才配得上一個筆記的空間。**考證的篇幅跟著讀者價值走，不跟著考證成本走**——查證花了很多力氣，捨不得只寫一句，就是空間錯配的起點
...
### 小標題（H2 段落標）：場景／物件／動作——不是編年體，也不是抽象標籤

> **用語**：這裡的「小標」= 正文裡的 `## H2` 段落標題，**不是** frontmatter `description`（那是 SEO／卡片副標）。  
> 小標是讀者掃目錄時的導航；寫糊 = 整篇「看完還是不知道在看什麼」。

小標有三層工作，缺一層就會「不知所以然」：

| 層                                     | 要回答的問題                 | 失敗時的氣味                 |
| -------------------------------------- | ---------------------------- | ---------------------------- |
| **這段在幹嘛**（對應投影「全局功能」） | 這一步替論點推進了什麼？     | 像章節名：背景、發展、現況   |
| **畫面是什麼**（場景／物件／人）       | 讀者腦中能不能出現一幀圖？   | 抽象名詞堆：機制、邊界、傳承 |
| **中文句子感**（主–述–賓或等同）       | 有沒有人／物在**做**一件事？ | 只有主題詞：結構、爭議、意義 |

#### 禁止（硬）

- 編年體：「2016 年《XX》發行」「2020 金曲 32」（plugin `chronicle-lead`）
- 空殼問句：「為什麼重要？」「現況如何？」「未來展望」
- categorical label：「生平」「作品」「爭議」「現況」「補充」「發展歷程」「概況」「背景」「結語」（「結語」用場景收，不要當分類抽屜）
- **抽象名詞孤島**（2026-07-15 編輯室／AAMA 校準）：「機制怎麼放大」「信任邊界」「名字是證據」若**沒有**底下立刻可還原的人／物／數字，讀者仍不知道這段在看什麼——要嘛加載體（誰／哪／幾），要嘛整句改寫成場面

#### 中文小標的「主–述–賓」機制（不是文法考試，是可讀性）

中文標題不必寫成完整句，但**心裡要能還原成一句有主詞、有動作、有著落的話**。還原不出來 = 抽象標籤。

| 還原測試   | 好的小標（還原句）                                           | 壞的小標（還原不出）               |
| ---------- | ------------------------------------------------------------ | ---------------------------------- |
| 誰／什麼   | 「凌晨的加護病房：22 個人，剩下 12 個」→ 病房裡人從 22 剩 12 | 「護理人力現況」→ ？誰怎樣？       |
| 動作       | 「頂新賣不掉，伊藤忠進場」→ 有人賣、有人進                   | 「股權結構演變」→ 沒有動作         |
| 著落／結果 | 「三十二萬張執照，臨床只剩十九萬雙手」→ 數字落差就是結果     | 「執照與執業之落差分析」→ 報告題目 |

**操作順序（寫每個 H2 前 30 秒）**：

1. 用一句話寫「這段的全局功能」（投影用語）：例如「證明慢是設計不是無能」。
2. 從研究裡挑**一個**可指的載體：人名／地名／物件／精確數字／一句可還原的動作。
3. 用載體寫小標；**禁止**把第 1 步的抽象功能詞直接當 H2（「證明慢是設計」≠ 小標）。
4. 念目錄：五個 H2 連起來要像故事節拍，不像簡報大綱。

**允許的省略**：主詞在上下文已清楚時可省（「賣不掉，伊藤忠進場」）；述語可是狀態（「只剩十二個」）。**不允許**的省略：整句只剩範疇詞。

#### 和報導者長篇的對齊（取樣觀察，非抄格式）

報導者深度稿的中間小標，常見不是百科抽屜，而是：

1. **場面或時刻**：誰在哪、發生什麼（加護病房、走廊、談判桌）。
2. **數字當主詞或賓語**：讓落差本身當標題的脊（「22 人剩 12」「83% 病床」）——數字要**可還原到正文第一段就兌現**，禁止標題黨。
3. **一句人話的命題**：像口語斷言，不是報告小標（「有比例，有沒有人」）——仍要底下立刻有現場或制度著落。
4. **物件／制度當角色**：法條、執照、合照、名單當「誰」，後面接動作或後果。

對照本庫已驗證的 narrative 小標（同精神）：

| 類型       | 例                                                                               |
| ---------- | -------------------------------------------------------------------------------- |
| 物件＋動作 | 「曼徹斯特的那面旗子」「廢墟上的花」                                             |
| 數字落差   | 「從 25 筆到 9,000 筆」「三十二萬張執照，臨床只剩十九萬雙手」                    |
| 人名＋處境 | 「宏碁獎的那隻手，十六年後還在台下」                                             |
| 制度當衝突 | 「第 82 條的雙重要件：醫師刑責合理化背後的爭議」（有條號＝載體，不是裸「爭議」） |

**報導者不會常做的事**（我們也少做）：把「背景／分析／討論」當 H2；用對仗華麗但無載體的文青空句當整段唯一導航。

#### categorical vs narrative（速查表）
...
| 「機制與邊界」     | 「不拿股份，那圖什麼」／「凌晨加護病房：22→12」 | 有人話問題或數字場面 vs 投影內部術語 |

#### 和投影／編輯室的接線

- 投影藍圖 §3 每個 section 的**暫定標題**必須通過本節「還原測試」；全局功能寫在欄位裡，**不要**把「立起悖論／機制放大」這類內部動詞直接當站上 H2（除非改寫成讀者聽得懂的場面句）。
- 編輯室結構席：除 shuffle 外，加問「**光讀 H2 目錄，外行知不知道每段在看什麼？**」一題 no → revise。
- Stage 2.4 小標題先行：5–8 個 H2 **全部**過還原測試再寫正文。

**自檢三題**（寫完 H2 目錄後）：

1. 把所有 H2 列成目錄，能不能讀出敘事弧線？
2. 每一個 H2 能不能還原成「誰／什麼 + 動作或狀態 + 著落」？
3. 有沒有任何一個 H2 可以原封不動搬到另一篇完全不同的文章？（能 = categorical，重寫）

典範：

- 吳哲宇：「複音口琴與一支 Czardas」「廢墟上的花」「鐘錶匠繼續走」「二十年的沉默終於找到出口」
- 安溥：「曼徹斯特的那面旗子」「煉雲：三千兩百塊 LED 拼成的聲明」「9522：一封寫給正在長大的女生的信」
- 黑冠麻鷺：「樟樹榕樹，是 5 公尺高的低海拔森林」「『僵立伸頸』的兩個誤讀」「『大笨鳥』的反向命名學」
- 醫療法（制度題仍可有場面）：「凌晨的加護病房：22 個人，剩下 12 個」「三十二萬張執照，臨床只剩十九萬雙手」
...
#### 全形分號「；」連用（2026-07-19 哲宇 directive）

**繁中自然散文極少用全形分號**。它是翻譯腔 / 學術腔的水印：作者把英文一個帶 `;` 的長句直譯過來，或把「該用句號斷成兩句」「該用頓號列舉」的並列子句硬用 `；` 接起來，讀起來像論文或法律條文，不像人話。

| ❌ 分號腔                                        | ✅ 台灣中文                                          |
| ------------------------------------------------ | ---------------------------------------------------- |
| 「以為 A（…）；以為 B（…）；以為 C（…）。」      | 拆三個句號句，或「以為 A、以為 B、以為 C。」         |
| 「按工程分段切是 13 人；按國籍切有 13 名泰籍。」 | 「按工程分段切，雪隧本體 13 人。換個切法……」（斷句） |
| 「反對聲音一直都在；只是沒被記下來。」           | 「反對聲音一直都在，只是沒被記下來。」（逗號即可）   |

**合法殘餘**：引用官方 / 法律原文（在「」內）、腳註分隔多來源——這兩種 `prose-health` 已豁免（排除腳註行 + code fence）。正文散文的 `；` 一律該問「這裡能不能改句號 / 頓號 / 逗號」。

`prose-health` §8c 自動抓（> 3 處逐處 WARN + 計入 rewrite-stage-3 score budget）。全 corpus 校準顯示 ~42% 文章有 4 + 全形分號——這是 AI 生成語料的系統性水印，不是個案。
...
十種高頻歐化病（第 8「是…的」2026-06-07；第 9「英文式短句開場」2026-07-19 哲宇 directive；第 10「英文隱喻直譯」2026-08-03 round 2）：
...
| **「是 X 的」判斷句** | 「這個選址不是隨便的」「答案是顯而易見的」；動詞片語型：「這四個字，是媒體多年轉述之間慢慢添上去的。」                                                  | 「這個選址不隨便」「答案顯而易見」；「媒體多年轉述之間，慢慢把這四個字添了上去。」（改動作句）或「是⋯添上去的頭銜」（「的」後接名詞） | 「(不)是＋評價形容詞＋的＋句末標點」= 多餘判斷句，去掉「是…的」讓形容詞直接當謂語。**動詞片語型同病**（2026-08-04 哲宇 callout）：「是＋動詞片語＋的＋句號」是英文 cleft 直譯，中文紀實把動作句直接寫出來；「的＋名詞」才是自然定語。`prose-health` plugin 自動 catch 形容詞型（curated 表，避開合法的「是我的／是教書的」）；動詞片語型 regex 打擊面太廣，靠人判 |
| **倒裝子句**          | 「在經歷了三十年民主化後的台灣」                                                                                                                        | 「台灣民主化三十年後」                                                                                                                | 修飾語超過八個字就該搬到後面                                                                                                                                                                                                                                                                                                                                      |
| **英文式短句開場**    | 「協議並沒有收尾。自救會指控補償被打了六七折、有成員被排除在外，爭議一路打進行政法院。」                                                                | 把短開場併入後句，或改成有具體人事時地的句子起頭                                                                                      | 段落以一句短平述句定調、底下再展開 = 英文 topic-sentence 腔（先甩一句短的 setup 再 elaborate）。中文自然行文直接流進主題。**設問（？）、冒號引出引語的引子、日期起頭的場景句（「1978 年通車了。」）是自然中文，不在此列**。`prose-health` §8e 自動抓（v3：≤8 字無條件、9-15 字看是不是宣告型謂語；升計分＋pre-commit 觸檔 >10 升 HARD，見下方第三輪）             |
| **英文隱喻直譯**      | 「同一段時間裡，還有另一本帳。」（another ledger）「三個月後，誰來**把帳算完**」「這**筆帳是有人在問**了」（settle the account，2026-08-04 EZWAY vc=2） | 「同一段時間，錢還有另一條流向。」／「十月底，第一份答案要交出來」／直接進事實                                                        | 英文慣用隱喻逐字搬進中文：中文「帳」只做算帳、一筆帳、舊帳這些延伸，不把「同時期的另一條金錢軌跡」叫「另一本帳」、不把「公共問責」叫「把帳算完」。判準跟三秒檢測法同源：這個比喻中文人講話會用嗎？                                                                                                                                                                |

**第 9 病的隱喻宣告型變體（2026-08-03 round 2）**：8 字門檻外還有一型 9-15 字的段首宣告句——「這個頭銜在轉述裡長大過。」「真正的轉彎發生在 1987 年。」「從結果看，這是他人生的第一場賭。」句子帶隱喻或評價性結論、資訊後置，是同一個 topic-sentence punch 腔的變體。判準：**這是場景還是宣告？**「那是一個耶誕夜。」是場景（合法且好）；「這個頭銜在轉述裡長大過。」是宣告（把該由敘事長出來的判斷先講掉）。改法是把判斷融進資訊句：「『腦神經外科』這四個字，是媒體多年轉述之間慢慢添上去的」。⚠️ 「真正的[轉折／轉機／轉彎]發生在⋯」全站 9 篇在用，已是跨篇簽名檔（同「值得停下來看」22 篇）——具名慣用式 `prose-health` §8e-bis 自動抓，一般形靠這裡的人判。

**第 9 病第三輪（2026-08-19 哲宇 directive「文章裡面還是有很多英文短句在開頭殘留，幫我順過」＋「強化 prose-health、EDITORIAL 跟 rewrite 裡面相關的部分，未來嚴格執行歐化檢查跟改善」）**：同一篇文章哲宇同日兩次點出同一件事，第二次點名的是「這些翻譯很多是在我家跑的。」「純粹之後才輪到後面那一段。」——這兩句都是 12 字、不以「這／那／真正」起頭、下一句三四十字，上一輪的檢查器一處都沒報（它要 ≤8 字、或 9-14 字且句首帶定調詞、且後接 ≥3.5 倍長）。**這個病的本體是「一句短平述句先立在段首定調，底下再展開」的英文段落骨架，跟字數與句首是哪個詞關係不大**：

| ❌ 第三輪反例（同一篇）                                                         | ✅ 順過後                                                                                                              |
| ------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| 這些翻譯很多是在我家跑的。我家裡有一張 3090、一張 4090，重型的策展工作交給雲端⋯ | 翻譯這一層有很大一部分是在我家跑的：重型的策展工作交給雲端，翻譯本身就交給家裡那張 3090 跟那張 4090 上的本地模型去做。 |
| 純粹之後才輪到後面那一段。我們在搜尋引擎上的佔領率一直在擴張⋯                   | 那天我接著講的是純粹之後的事：我們在搜尋引擎上的佔領率一直在擴張⋯                                                      |
| 寫完之後有三席審稿進去。結構主編看論點跟骨架撐不撐得住。減法主編⋯               | 寫完之後會有三席審稿進去，結構主編看論點跟骨架撐不撐得住，減法主編⋯                                                    |
| 搬家日記是它自己寫的。新機器上有一些目錄屬於上一個使用者⋯                       | 搬家那天的日記是它自己寫的，說新機器上有一些目錄屬於上一個使用者⋯                                                      |
| 我的回答是在混濁的河流中淘金。淘金客拿著一個篩網⋯                               | 我的回答是一個比喻，在混濁的河流中淘金：淘金客拿著一個篩網⋯                                                            |

**第三輪之後的判準（寫的人用，不靠工具）**：段首那一句念出來，問三件事——(1) 它是在**陳述一個判斷或狀態**（是／有／叫／可以／一直／也），而不是在寫一個**發生的動作**（了／著／過）？ (2) 它講完之後，底下那幾句是在**展開它**？ (3) 把它接進下一句、或換成一個有人事時地的句子起頭，整段會不會更像人在講話？三個都是 → 改。**不算的**：冒號引出引語或列舉的引子（「我那天的收尾是：」「那天在螢幕上滑下去的順序是這樣：」）、日期或場景起頭的句子（「2026 年 7 月底，鎢供應鏈吵得沸沸揚揚。」）、刻意當節拍的孤句（「我不會在旁邊。」）。**儀器**：`prose-health` §8e v3 同日升級——第二帶改用「宣告型謂語且無事件體標記」加「整段展開 ≥40 字」判，並從 WARN-only 升計分（≥3 處 +1、≥6 處 +2，REWRITE Stage 3 的 score-budget 會咬），pre-commit 觸檔 >10 處升 HARD。校準：992 篇 zh 裡 v2 報 744 處／403 篇，v3 報 2,133 處／650 篇；人眼抽樣 45 條，判斷句主題句佔絕大多數。工具抓得到骨架，抓不到「這句是不是刻意當節拍」——那一題留給寫的人跟第二雙眼。

**自檢口訣**：念出來。如果聽起來像在讀翻譯小說 = 歐化。如果聽起來像在跟朋友講話 = OK。

跟塑膠偵測的「阿媽口訣」一起用：阿媽不會說「透過」，也不會說「作為一個母親」。

### 後台洩漏：廚房的聲音跑到餐廳（2026-08-03 哲宇 directive）

塑膠抓空洞修飾、歐化抓語法結構，這一節抓**作者的工作痕跡跑進成品**。餐廳出菜不會把「這道菜我先炒香再收汁」寫在盤子上；讀者要的是菜，不是備料筆記。

這個病特別難自檢，因為每一句單獨看都「有內容、不空洞、不歐化」——它過得了前面所有關卡。它壞在**說話對象錯了**：這些句子是說給編輯、查核者、或作者自己聽的，不是說給讀者聽的。

**一句判準**：這句話是說給讀者聽的，還是說給我自己（或編輯／查核者）聽的？

八種形狀，八個真實反例（形狀一到六出自 2026-08-03 黃崇仁初稿、形狀七八出自同篇上線版第二輪，哲宇逐條 callout；第二輪完整診斷 → [reports/backstage-leak-round2-2026-08-03.md](../../reports/backstage-leak-round2-2026-08-03.md)）：

| 形狀                     | ❌ 反例                                                                                                                                                                                   | 病灶                                                                                                                                                                                                     | ✅ 改法                                                                                                                                                                                                         |
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **分析框架洩漏**         | 「工廠拆得開⋯一批收藏拆開來就只是一堆個別的畫。**兩件事的動詞不一樣，判斷是同一套。**」                                                                                                   | 用語法術語（動詞）描述一個人怎麼對待他的收藏。**沒有讀者在這一刻會想到「動詞」**——那是作者拆解自己論點時用的鷹架                                                                                         | 把鷹架拆掉，只留畫面：工廠賣掉一台機器還能轉，收藏拆開就只剩一堆個別的畫                                                                                                                                        |
| **寫作動機洩漏**         | 「**要說清楚回來的是什麼樣的公司。**力積電掛牌時是全球第六大⋯」                                                                                                                           | 第一句是投影藍圖給寫手的指令，寫手照抄進正文。這是段落的**寫作動機**，不該是段落的一部分                                                                                                                 | 刪掉整句，直接從「力積電掛牌時是⋯」開始                                                                                                                                                                         |
| **自我評價洩漏**         | 「（查不到員工去向）**這一段誠實的空白值得留著。**」                                                                                                                                      | 「誠實」「值得留著」是作者在稱讚自己有好好處理 negative finding。讀者不在乎作者誠不誠實，只在乎這件事到底知不知道                                                                                        | 直接寫事實狀態：這批員工後來去了哪裡，公開資料裡查不到                                                                                                                                                          |
| **查證過程洩漏**         | 「**這句話有兩個版本在流傳，另一家媒體的版本沒有「不用擔心」四個字。**無論哪個版本⋯」                                                                                                     | 查證分歧是後台工作。正文要嘛採用查證後認定的版本、要嘛不用這句話——**不是把兩個版本攤給讀者再自己分析一輪**                                                                                               | 正文用認定版本的完整逐字，分歧寫進腳註（「另一家媒體的轉述版本略去末四字」）                                                                                                                                    |
| **指揮讀者注意力**       | 「**這裡有一個細節值得停下來看。**台灣媒體多年來寫他的頭銜⋯」「這句話**值得放在千億債務的旁邊一起讀**。」                                                                                 | 作者跳出來舉旗說「現在該注意這個」。好的材料自己有份量——**需要先宣告它重要，通常表示那段還沒寫夠好**                                                                                                     | 刪掉指揮句，直接把細節寫出來；讀者自己會停下來                                                                                                                                                                  |
| **論述鷹架洩漏**         | 「樂觀的人相信事情會變好，他相信的是還來得及。**這兩件事在懸崖邊上完全不同：前者可以等，後者必須動手。**」                                                                                | 作者拆解自己剛造出來的對比給讀者看——讀者得回頭數哪個是前者。散文讓對比自己成立                                                                                                                           | 把對比寫成畫面或動作讓落差自己浮現；或直接收在「他相信的是還來得及」                                                                                                                                            |
| **查無聲明**             | 「**中英文檔案裡找不到任何一件蘋果對力捷的訴訟紀錄**」「這串數字全部出自他本人受訪的敘述，**沒有銀行團或監理機關的獨立版本可以對照**」「P5 廠原有員工的去留，**目前沒有公開說明**」       | 查證的「查無」結論用研究者視角的語言寫進正文——這是查核員報告搜尋範圍與信度分層的話。最有力的證據：兩例的腳註早已寫著同一句話（[^31][^40]），正文是重複求安心                                             | 三徑：**刪**（敘事多半不受損）／**降級進腳註或策展人筆記**（後台的兩個合法的家）／**視角翻轉**——「我查不到」改寫成「誰沒有說」（「員工去留沒有公開說明」→「員工跟著廠交割還是另有安置，美光跟力積電都沒有說」） |
| **懸念預告鷹架**         | 「但『還了』這個說法要成立，**得先確認一件事**：那筆帳，是誰替誰還的。」「**但有一個決定，他從來沒有用同樣的直白談過。那是十年前簽下的**，而它正落在⋯」                                   | 用查核任務的語言與匿名化名詞（一件事／一個決定）製造懸念，揭曉延遲一段以上——英文長文 cliffhanger 直譯。跟「指揮讀者注意力」同族：那條是「看這裡」，這條是「等著看」                                      | 懸念用具體物承載（直接寫「2015 年他在合肥簽下的三份技轉協議，十年後回頭壓在力積電自己身上」），或乾脆揭曉——事實本身的重量夠就不需要藏                                                                           |
| **結構導覽鷹架**         | 「三句話都成立，**也都各自留下一個接著要問的問題**。」→「**先說第一句留下的問題**。⋯」「**再看第二句留下的問題**：個資。」「**第三句留下的問題**最具體。」（2026-08-04 EZWAY）            | 投影藍圖的分段地圖被寫成正文的導覽句。寫手在替自己的章節結構做旁白（給編輯看的地圖），讀者不需要被預告接下來有三站——每一站自己要接得住                                                                   | 刪掉全部導覽句直接進內容：「這三句話，每一句都查得到根據。」然後每段以事實開頭（「做這個 App 的公司叫關貿網路⋯」），段落靠內容承接，不靠編號                                                                    |
| **查核腔第一人稱**       | 「**本文查核期間**，沒有查到任何一起⋯」「**本文查核後確認**：這個框架出自二手評論」「三個版本之間，**沒有一家媒體去交叉印證另一家**」（2026-08-04 EZWAY／外送專法）                       | 查核員的自述（我查了、我比對了、查到什麼時候）跑進正文。比形狀七更直接——形狀七是查無的結論，這形狀連查核的動作都上桌了                                                                                   | 正文陳述世界的狀態（「這組數字流傳很廣，出處只追得到二手報導」／「質疑的那一邊，手上也沒有一起實際發生的外洩事件可以指」），查核範圍與時點降級進腳註或策展人筆記                                                |
| **腳註第一人稱編輯自述** | 「**本文查證階段曾引用**一組數字⋯**複驗時發現**不符⋯**本文因此不再列出**⋯**本文亦不採用**」「**本文取整為**『逾十一億元』」「**本文寫**『六十餘件』」（2026-08-08 新冠疫情與疫苗，41 處） | **住在合法的家裡，但主詞是錯的。** 腳註收的是「證據的狀態」（那份 PDF 無法擷取文字／那個連結已失效），不是「編輯的動作」（我查了、我改引、我因此不寫）。而且「本文因此寫 X」是在告訴讀者他剛剛讀完的東西 | 把主詞從「本文」換回那份資料：「本文無法逐字核對該 PDF」→「該 PDF 無法擷取文字」；純粹的編輯動作自述（本文不寫／本文取整／本文改引）**直接刪**——讀者讀完就看得到文章做了什麼                                    |

> ⚠️ **「值得停下來看／想」是 Taiwan.md 自己的招牌慣性**：878 篇 zh corpus 掃出 **22 篇**在用同一個句式（「很值得停下來想的話」「最值得停下來想一秒的地方」「這一段值得停下來想一秒」）。這種跨文章的口頭禪靠人眼永遠抓不到——每一篇單獨看都只是一句過場，要把全站攤開才看得見它已經變成簽名檔。同型的還有「誠實的空白」（3 篇）。寫的時候問一句：**我是在讓讀者停下來，還是在替一段還不夠有力的材料求情？**

**為什麼 AI 特別容易犯**：pipeline 給寫手的每一份規格（投影藍圖的全局功能、研究報告的護欄、查證表的分歧欄）都是**用來指導寫作的語言**，寫手在 context 裡讀了一整輪，下筆時很自然把那套語言帶進正文——它甚至覺得自己很盡責（「我有交代清楚」「我有誠實標註分歧」）。**盡責的地方是後台，不是正文。**

**跟 §紅線焦慮 的關係**：那條講的是「逐字」「原封不動」這類來源焦慮標籤（作者自我紀律的痕跡），是本節第三、四類的一個特例。本節把它擴大到整個後台家族。

**跟幻覺鐵律的關係（形狀七的根）**：MANIFESTO §10 要求誠實面對查無與不確定——那個紀律沒有錯，錯的是表達的位置。**策展人筆記與腳註是後台的兩個合法的家**：查無、信度標註、版本分歧住那裡是紀律的正確表達（醫療法「找不到任何一份⋯」寫在 📝 筆記裡是正確示範），住正文 prose 才是病。材料越依賴單方自述、流傳版本與可考事實落差越大，寫手正文染上查核腔的機率越高——這在研究報告完成時就可以預警。⚠️ **合法的家有容量限制**（2026-08-04 補，黃崇仁頭銜筆記三輪 callout）：窗口收的是**結論級誠實**——查無一句、分歧一句、編輯決定一句；把推理過程整段重播（列證據、下推論、自我辯護「考證有意義」）進筆記，一樣是後台洩漏，只是換了個房間。判準不變：這段話在跟誰說話？完整反例 → §策展人筆記的書寫紀律 反例五。

⚠️ **合法的家還有一條主詞規則**（2026-08-08 補，新冠疫情與疫苗 41 處）：容量限制管的是**寫多少**，這條管的是**誰當主詞**。腳註合法收的是「證據的狀態」——那份 PDF 無法擷取文字、那個連結已失效、全文未公開。不合法的是「編輯的動作」——本文查證階段曾引用、本文複驗時發現、本文因此不再列出、本文改引、本文取整為。**前者的主詞是那份資料，後者的主詞是我。** 讀者打開腳註想知道證據長什麼樣子，拿到的卻是一份工作日誌。而且「本文因此寫 X」多餘——讀者剛讀完 X。

誕生事件值得記：那 41 處不是懶，是**嚴謹紀律的副產品**。一輪四十二條批修，每一條降級、每一個但書、每一次改引，都在腳註誠實留下一句第一人稱交代，累積起來就是一本工作日誌。9,203 篇全掃 20 篇命中，全部集中在最近最嚴謹的幾篇（鎢供應鏈、外送專法、苯駢芘、EZWAY、行道樹）——**查證愈細，這個病愈重**。

**查證內容的層級表**（黃崇仁頭銜三輪 callout 收束——第一輪修語氣、第二輪壓縮筆記、第三輪哲宇裁決「連比較都不需要寫」）：

| 層級           | 收什麼                                                                                                     | 例                                                                   |
| -------------- | ---------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| **正文**       | 直接用查證後認定的版本，零考證痕跡——「媒體叫他 X、官方紀錄寫 Y」的比較是編輯在寫作時就判斷完的事，不寫出來 | 全文直接稱「醫學博士」，「腦神經外科」四個字不出現                   |
| **腳註**       | 來源＋必要時一句稱謂交代（「媒體慣稱 X，官方紀錄為 Y，本文從官方」）                                       | 掛在學歷句的腳註裡一句帶過                                           |
| **策展人筆記** | 只有勘誤本身就是策展洞察時（黑冠麻鷺型「通行說法把因果搞反了」）才配得上這個空間                           | 讀者的預設被翻轉後，對主題的理解會整個改變——那才值得停下來寫一個筆記 |

一句話版本：**讀者需要的是對的內容，不是「我們怎麼知道它是對的」。**

⚠️ **事實勘誤本身也會生產後台洩漏**（2026-08-17 補，2026-08-15 文策院 session 收驗）：修正一個事實時，容易把「查證過程」（「經查」「實際上」「應更正為」「另一說法有誤」）一起寫進正文；正文只留修正後的事實，查證過程收進 frontmatter verification 或研究報告。實例：文策院 session（memory `docs/semiont/memory/2026-08-15-164407-manual.md`）十四席收驗抓出的三處後台洩漏都是修事實時加的。

**一處 callout，全文重掃**：第二輪的 13 段裡多數在第一輪就存在——第一輪逐 callout 修，callout 指哪修哪，等於把「工具警報的單例不代表問題的集群」在正文層重演一次。單點 callout 的正確反應是拿判準句（「這句話在跟誰說話」）全文重掃同族，修集群不修單句。

**儀器**：`prose-health` plugin §backstage **十組**偵測（WARN-only soft-launch；五組 2026-08-03 上線 878 篇校準 29 hits 零誤報，查無聲明＋懸念預告兩組 round 2 加入，891 篇校準 9 hits 全真陽性；結構導覽鷹架＋查核腔第一人稱兩組 2026-08-04 EZWAY round 加入，896 篇校準導覽 0 誤報、查核腔 3 hits 全真陽性，並自帶 blockquote／腳註行排除——不罰後台的合法的家。同 round 另在「強加對比收束句」補「把帳算完／這筆帳有人在問」= settle the account 英文隱喻直譯，vc=2，中文「算帳」是報復或記帳，不當公共問責隱喻用）。**2026-08-08 加第十組「腳註第一人稱編輯自述」，掃描面跟前九組相反——只掃腳註定義行**（9,203 篇校準 20 篇命中 40 處，14 樣本零誤報）。同 round 修一個既有的假陰性 bug：三組行級排除的迴圈原本 `[:6]` **先截斷再排除**，前六個 match 若剛好都落在豁免區，正文的真違規就被靜默丟掉——豁免區把上限額度吃光，屬 REFLEXES #24「工具在說謊」的假陰性型，已改成先排除再截斷。

### 形狀十二：把查證困難升格成論點（論點層的後台洩漏）🚨

> **2026-08-08 哲宇 callout，新冠疫情與疫苗 v1**。前十一個形狀都是句子層的，這一個在論點層——**它會讓整篇文章建在一個假的矛盾上**，所以單獨立節。

那篇的核心論點是「同一年的超額死亡，四組學者算出四個差四五倍的數字，這場疫情沒有一本各方都認的帳」。哲宇的判語只有兩句：

> 「資料問題，不是文章觀點。」
> 「這一點都不重要，這是你查證的問題，不是真實的讀者矛盾。」

四組公衛研究用不同基準線、不同人口老化控制、不同間接死亡定義，算出不同的超額死亡數字——**這在流行病學裡是正常的**，不是醜聞、不是失職、也不是台灣特有。它之所以在我眼裡像個大發現，只因為它是**我查證時遇到的最大難題**：五路研究撞在一起、四個數字對不起來、我花了最多力氣去解消它。**於是我把自己的工作難度誤認成世界的張力。**

**判準（進投影 gate 第七題）**：

> **這個論點，是讀者本來就有的疑問，還是我查證時遇到的困難？**
>
> 具體問：一個沒讀過我研究報告的人，會不會在生活裡自己撞到這個矛盾？撞不到 → 那是後台。

**這個病的三個指紋**（出現任一就回頭檢查論點）：

1. **論點的主詞是「研究」「估計」「統計」「數字」「說法」，不是人、不是機構、不是事件。** 讀者關心的是誰做了什麼、誰承擔了什麼；「四組估計不一致」的主詞是四份論文。
2. **要先解釋方法論，讀者才懂為什麼這是問題。** 需要先教「什麼是反事實基準線」才能讓人感覺到張力，那個張力就不是讀者的，是研究者的。
3. **抽象隱喻密度突然升高**（見下方 §量詞隱喻）。論點接不起來時，寫手會抓一個隱喻反覆敲，用重複製造連貫感的假象——那篇「帳」出現 12 次、「N 本帳」出現 8 次，正是這個。**隱喻密度是論點健康的體溫計。**

**為什麼前面十一道關卡全部沒攔下來**：投影 gate 六題、投影編輯室三席、二十路 persona、十二席大驗證輪——每一關都在問「這個論點有沒有被兌現」「骨架推不推得動」「證據夠不夠」，**沒有一關問「這個論點是不是讀者的」**。論點自洽、證據紮實、骨架推得動，全部成立，而它建在一個只有作者感覺得到的矛盾上。這是 REFLEXES #65 (f) same-DNA 尺的最深一層：所有的尺都以論點為參考系，論點錯了，尺會一起錯。

---

### §量詞隱喻：「帳／本」（2026-08-08，復發）

中文的「帳」不用「本」當量詞數，也不當可數的抽象物件用。哲宇原話：**「說過幾次了不要用幾本『帳』或幾『本』這種寫法，中文沒有這種用法。」**

| ❌                                 | ✅                                                 |
| ---------------------------------- | -------------------------------------------------- |
| 「到 2026 年 8 月，三本帳還開著」  | 直接寫那三件事各自的狀態：法院還在審、救濟還在收件 |
| 「連帳都沒有開的那些人」           | 「這些人的處境從來沒有被統計過」                   |
| 「醫護那一本算得比較晚」           | 「醫護的損失是最晚被算進去的」                     |
| 「這是這場疫情裡又一本沒有開的帳」 | 「這件事到現在沒有人回頭驗證過」                   |

**合法殘餘**：帳單（具體物）、算帳／秋後算帳（既有成語）、記帳、帳本（實體物）。

**儀器**：`prose-health` §量詞隱喻 **v2 家族版**（2026-08-18 哲宇 directive「加入帳與算過之類的完整檢查」）。v1 只抓「本＋帳」量詞組合，連「付了帳」「這筆帳」「沒被算進帳」都漏；**更關鍵是換衣服現象——把「帳」拿掉會用「算」回來**（「代價算進去了嗎」「沒有被算進任何一份統計」），字換了隱喻沒換。v2 打家族不打字：付帳／筆帳／算進／算過／累積帳單／放回帳本。**判準一句話：受詞是錢＝字面（合法），受詞是人的處境＝隱喻（改寫）。**字面會計以 GUARD 濾除（帳簿／記帳／米店／對帳／帳號）：王永慶的米店記帳、辦桌文化的霧峰林家帳簿、公車系統的「獎金沒被算進固定月薪」、水果王國的「小果花苞沒算進去」全部不命中；「算了／算過一筆帳」（真的在做算術）以負向後顧擋掉。9,815 檔校準：真陽性 10 篇、假陽性 0。**≥3 處時警告訊息會附一句論點警訊**——同一個抽象隱喻反覆敲，通常代表論點本身接不起來（見形狀十二指紋 3）。

**第三次復發（2026-08-18，台灣早餐整併）——這次的形態不一樣，值得記**：正文（`knowledge/` 那份）`prose-health` **零命中**，plugin 是乾淨的。命中的全部在**產線文件**：投影藍圖 3 處、論點兌現席審稿報告 13 處，以及主 session 對觀察者的口頭回報。鏈條是——主 session 把「付了帳／帳單」寫進**投影藍圖的論點句**，三個編輯室席位讀藍圖後把這個詞當成本篇的核心詞彙沿用並放大，主 session 再從席位報告抄回自己嘴裡。

兩條可操作的結論：

1. **論點句是下游所有席位的詞彙來源**。寫進論點的每一個隱喻，會被 N 個 agent 當成 canonical 詞彙複製。藍圖的用詞紀律應該比正文更嚴，而不是更鬆。
2. **儀器守著文章，守不到生產文章的文件**。`prose-health` 掃 `knowledge/`，不掃 `reports/article-projection/` 與 `reports/editorial-room/`。這不是 plugin 壞了，是它被指向的地方不含產線——**閘門的覆蓋面跟它的準確度是兩件事**。（候選改法：把 prose-health 的 §量詞隱喻與 §對位句型兩檢查接上 `reports/article-projection/*.md`；未實作，先記在此。）

**同批的因果驗證**：本節自己寫的「≥3 處通常代表論點本身接不起來」在這次成立且可交叉驗證——同一批次的論點兌現席獨立判定「論點後半句『每一次失守，都有具體的人付了帳』只兌現三分之一」。隱喻在替論點做它做不到的事，兩個訊號指向同一個病灶。

---

### §英式接續：句首「而」（2026-08-08）

「而『校正回歸』這個動作本身就是⋯」「而爭論的兩個關鍵詞被混為一談。」「而這一筆帳⋯」「而三本帳都還開著。」——句首「而」是英文 `And` / `And so` 的直譯接續。中文的「而」是**句中**轉折連接詞（「快而準」「起而行」），放句首當段落黏著劑是翻譯腔。

**更重要的是它的診斷價值**：句首「而」最常出現在**作者發現前後兩句接不起來、需要一個詞把它們黏住**的地方。所以它同時是「這裡邏輯有洞」的指標。

**改法**：刪掉「而」直接寫下一句。**如果刪掉之後讀不通，那不是連接詞的問題，是那兩句之間真的缺一個論證。**

**儀器**：`prose-health` §英式接續（密度 ≥4 才報；9,203 篇 18 篇命中，新冠疫情與疫苗 v1 有 15 處為全站最高）。

---

**儀器抓不到的三種形狀，人眼是唯一關卡**（2026-08-03/04 實測後誠實記錄，不硬做）：

- **分層拆解自己的論點**（「所以『誰的帳沒被算』還有第二層意思。第一層是錢⋯第二層是紀錄⋯」，2026-08-04 EZWAY）：跟合法的內容分層列舉（「跑廟的邏輯有三層」「聲明的論述分三層」——列的是**世界裡的東西**）句法完全相同，病的那種列的是**作者剛造出來的論點結構**。896 篇校準「第一層是⋯第二層是」6 hits 全是合法列舉，regex 收這型會複製 PUA 偵測器的假陽性災難。判準：這幾層是讀者在世界裡指得到的東西，還是我對自己 thesis 的拆解？

- **指涉語法回指**（「前者可以等，後者必須動手」）：全 corpus 38 hits，逐條看絕大多數是正當對比——「前者是壓制，後者是收編」指涉的是文中已存在的兩個真實事物；病的那種指涉的是**作者剛造出來的抽象對比**。差別在指涉對象是文中實體還是作者的論述動作，句法上完全一樣。
- **對稱宣告**（「這兩件事完全不同」「兩者的差別在於」）：同上，跟正當的比較句無法用句法區分。

硬收會複製 PUA／媒體焦慮偵測器被移除的錯誤（92-100% 假陽性，見 `prose_health.py` 檔頭）。**寧可漏抓不可哭狼**——這兩種靠念出來判斷：這句話是在描述世界，還是在描述我剛才寫的句子？
...
### 賽事脈絡的稱名（2026-09-05 新增）

哲宇拍板 [OBSERVER-QUEUE #41](../semiont/OBSERVER-QUEUE.md)：奧運 / 亞運 / APEC / WHA 等台灣被迫用「中華台北」（Chinese Taipei）參賽的脈絡，行文主體一律「台灣」，不是「中華台北」——同一條 §自稱台灣紀律延伸到賽事脈絡，不是另一條規則。

**規則**：

1. **行文主體用「台灣」**：敘述誰出賽、誰奪牌、誰加入代表隊，預設寫「台灣」，不寫「中華台北」。
2. **首次出現加註正式參賽名稱**：同一篇文章第一次出現賽事脈絡的稱名時，用括號註記正式名稱——中文「台灣（以中華台北名義）」，英文 `Taiwan (competing as Chinese Taipei)`。**之後不再重複這條註**，後面直接寫「台灣」。
3. **「中華台北」保留情境**（三種，出現時不必換成台灣）：
   - **直接引述**：賽事文件、官方協議條文、人物直接引語（加引號、有出處）
   - **獎牌榜／代表隊官方名**：引用特定賽事的官方獎牌統計、代表隊正式名冊（例：奧運官方獎牌統計、WBC/Premier12 官方代表隊名冊）
   - **解釋名稱本身**：文章主題就是「中華台北」這個名稱的由來、爭議、政治脈絡（例：〈中華台北〉〈台灣體育發展與奧運〉整篇，或段落在講洛桑協議、正名公投）——這種文章的「中華台北」本來就是台灣兩字，不用套用第 1-2 條
4. **組織專有名詞不算**：「中華台北奧會」「中華台北棒球協會」「中華台北電子競技協會」這類團體的正式登記名稱，是專有名詞不是稱呼台灣的方式，照抄原名，不用換。

**正例**（首次出現＋之後不重複）：

> 他連續三屆代表台灣（以中華台北名義）出征奧運，三度都打進八強。……巴黎奧運小組賽，他替台灣隊提振士氣。

**反例**（行文主體誤用中華台北，且無正式名稱脈絡）：

> ~~他連續三屆代表中華台北出征奧運~~——這裡「中華台北」被當成台灣的預設稱呼在用，命中 §自稱台灣要戒的迴避同型：用一個不是台灣人自己選的名字，取代台灣兩個字當日常主詞。

**判準句**：這裡的「中華台北」是在**指稱台灣**（換成台灣），還是在**引用/解釋一份文件、一個獎牌榜、一個名稱本身**（留）？

各語言譯本的對應寫法（「台灣（以 X 名義）」型 vs 禁用「[Chinese Taipei 譯名] 當主體」型）在 [docs/editorial/per-language/](per-language/README.md) 各份 TRANSLATION-{lang}.md §1 國名表；zh/en 之外的十語跟著下一輪該篇 stale 重翻時對齊，不用即刻回頭改舊譯本。
...
**第四題（2026-08-03 round 2 新增）——詮釋句的字面事實測試**：作者自己合成的論點句也是查核對象。「這兩件事，是同一個決定」把投影論點（同一套不清算的邏輯——可辯護的詮釋）壓成字面的事實宣稱，而字面上它是錯的：還債與買回是不同月份、不同主體、不同動作的兩個決定。fact-atom 守恆只查研究報告裡的原子，**合成論點不在原子清單裡，四十個原子零漂移照樣放行一句站不住的斷言**。自檢法：把每一句詮釋性斷言當事實宣稱唸一遍，問「查核員會怎麼判」——過不了就退回詮釋語言（同一種判斷、同一套邏輯）。
...
- 「找不到官方 / 高品質媒體」這個結論，**v6.8 起只在跑完 [Step 1.9.2 圖片素材＋授權矩陣](../pipelines/REWRITE-PIPELINE-SINGLE.md#step-192-圖片素材hero--inline-圖-授權矩陣)（v9 期間的「深度媒體掃描協議」全文在 [archive](../pipelines/archive/rewrite-v9.9-2026-09-19/REWRITE-STAGE-1B-MEDIA.md)）之後才成立**（Chrome MCP rendered-DOM 圖掃 + YouTube 官方頻道影片掃；curl/WebFetch 對 Medium/FB JS-CDN 失效不算「掃過」）。跑過深掃仍無 → 才可不塞，並在 research §6 記 negative finding。影片不是 KPI，但 People/Music/Nature 官方影片通常存在，`media-richness` 0 影片 WARN（不是 INFO）
...
詳細執行 SOP 見 [REWRITE-PIPELINE-SINGLE Step 4.3](../pipelines/REWRITE-PIPELINE-SINGLE.md#step-43-媒體插入)。
