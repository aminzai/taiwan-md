...
**跟幻覺鐵律的關係（形狀七的根）**：MANIFESTO §10 要求誠實面對查無與不確定——那個紀律沒有錯，錯的是表達的位置。**策展人筆記與腳註是後台的兩個合法的家**：查無、信度標註、版本分歧住那裡是紀律的正確表達（醫療法「找不到任何一份⋯」寫在 📝 筆記裡是正確示範），住正文 prose 才是病。材料越依賴單方自述、流傳版本與可考事實落差越大，寫手正文染上查核腔的機率越高——這在研究報告完成時就可以預警。
