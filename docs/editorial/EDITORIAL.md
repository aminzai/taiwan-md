...
status: 'canonical'
current_version: 'v6.15'
last_updated: 2026-08-03
last_session: '2026-08-03-140210-manual（v6.15：+§六 §後台洩漏 四形狀＋prose-health 儀器；v6.14：Title 第 5 原則數字要有象徵重量）'
...
九種高頻歐化病（第 8「是…的」2026-06-07；第 9「英文式短句開場」2026-07-19 哲宇 directive）：
...
六種形狀，六個真實反例（全部出自 2026-08-03 黃崇仁初稿，哲宇逐條 callout）：
...
**儀器**：`prose-health` plugin §backstage 五組偵測（WARN-only soft-launch，2026-08-03 上線，878 篇校準後 29 hits 零誤報）。
