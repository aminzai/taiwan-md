...
四種形狀，四個真實反例（全部出自 2026-08-03 黃崇仁初稿，哲宇逐條 callout）：
...
**儀器**：`prose-health` plugin §backstage 四組偵測（WARN-only soft-launch，2026-08-03 上線）。分析框架類與自我評價類是語意判斷，regex 只抓得到最窄的句法指紋，**人眼仍是主要關卡**——念一遍，問「這句話在跟誰說話」。
