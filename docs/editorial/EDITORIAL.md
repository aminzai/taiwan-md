...
status: 'canonical'
current_version: 'v6.17'
last_updated: 2026-08-04
last_session: '2026-08-04-092431-ezway-rewrite（v6.17：§後台洩漏 八形狀→十形狀——結構導覽鷹架＋查核腔第一人稱，人判清單二→三加分層拆解自己的論點；§歐化 第 10 病補把帳算完 settle-the-account vc=2；prose-health §backstage 七組→九組偵測，896 篇校準）'
...
| **英文式短句開場**    | 「協議並沒有收尾。自救會指控補償被打了六七折、有成員被排除在外，爭議一路打進行政法院。」                                                                | 把短開場併入後句，或改成有具體人事時地的句子起頭                                                                                      | 段落以一句超短平述句（≤ 8 字）定調、緊接一句長得多的展開句 = 英文 topic-sentence 腔（先甩一句短的 setup 再 elaborate）。中文自然行文直接流進主題。**設問（？）與含數字場景句（「1978 年通車了。」）是自然中文，不在此列**。`prose-health` §8e 自動抓                                                                                                              |
