...
status: 'canonical'
current_version: 'v6.16'
last_updated: 2026-08-04
last_session: '2026-08-03-235302-backstage-round2（v6.16：§後台洩漏 六形狀→八形狀＋後台的兩個合法的家＋一處 callout 全文重掃；§歐化 第 10 病英文隱喻直譯＋第 9 病隱喻宣告型變體；§事實鐵三角 第四題詮釋句字面事實測試）'
...
| **英文隱喻直譯**      | 「同一段時間裡，還有另一本帳。」（another ledger）                                                     | 「同一段時間，錢還有另一條流向。」或直接進事實                                                                                        | 英文慣用隱喻逐字搬進中文：中文「帳」只做算帳、一筆帳、舊帳這些延伸，不把「同時期的另一條金錢軌跡」叫「另一本帳」。判準跟三秒檢測法同源：這個比喻中文人講話會用嗎？                                                                                                                                                                                                |
...
**儀器**：`prose-health` plugin §backstage 七組偵測（WARN-only soft-launch；五組 2026-08-03 上線 878 篇校準 29 hits 零誤報，查無聲明＋懸念預告兩組 round 2 加入，891 篇校準 9 hits 全真陽性，並自帶 blockquote／腳註行排除——不罰後台的合法的家）。

**儀器抓不到的兩種形狀，人眼是唯一關卡**（2026-08-03 實測後誠實記錄，不硬做）：
