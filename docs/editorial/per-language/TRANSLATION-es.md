...
research_evidence: '../../../reports/translation-research/es-2026-05-24.md'
audience: 'translator (human + AI)'
---

# TRANSLATION-es — Normas de traducción al español de Taiwan.md

> Evidencia completa y citas en [reports/translation-research/es-2026-05-24.md](../../../reports/translation-research/es-2026-05-24.md). Este documento es la guía canónica accionable; cargar antes de cada traducción. Registro: **español neutro panhispánico con sesgo cauteloso a la norma RAE/FundéuRAE peninsular**.

## TL;DR — 5 reglas de máxima prioridad

1. **`Taiwán` y `Taipéi` con tilde** en todo el cuerpo de texto, frontmatter, pies de imagen y descripciones SEO. Son palabras agudas terminadas en vocal/-n (norma RAE/DPD + FundéuRAE 2024). Sólo se admite la grafía sin tilde dentro de nombres propios institucionales (`Taipei 101`, `Taipei Economic and Cultural Office`, `Taipei Times`) y en URL/slugs ASCII.
2. **Wade-Giles para topónimos y antropónimos taiwaneses**, nunca pinyin RPC. `Kaohsiung` (no `Gaoxiong`), `Hsinchu` (no `Xinzhu`), `Tsai Ing-wen` (no `Cai Yingwen`), `Chiang Kai-shek` (no `Jiang Jieshi`). Mantener el guión entre las dos sílabas del nombre de pila (`Ing-wen`, `Ching-te`).
3. **Orden chino apellido + nombre**: `Tsai Ing-wen`, nunca `Ing-wen Tsai`. En segunda mención: apellido solo (`Tsai`), nunca el nombre de pila solo. Para personas con nombre occidental (`Audrey Tang`, `Joseph Wu`, `Morris Chang`, `Jensen Huang`), usar la forma con que se presentan públicamente.
4. **Tuteo panhispánico neutro** (`tú`). Vosotros descartado (excluye a Latinoamérica entera, ~90% del hispanohablante); voseo rioplatense descartado (rompe neutralidad); usted reservado a citas y protocolo. La voz Taiwan.md es divulgativa: «¿sabes que en Taiwán…?».
5. **Léxico anti-RPC**: usar `Taiwán` como entidad política singular. Prohibido `Taiwán, China`, `provincia china de Taiwán`, `isla rebelde`, `autoridades de Taipéi`, `compatriotas taiwaneses`, `reunificación` (cuando se describe integración futura como hecho). Forma institucional larga: **`República de China (Taiwán)`** (uso de Paraguay, Guatemala y diplomacia taiwanesa) — nunca `República de China` a secas.

## 1. Designación de país / región

| Origen (zh-TW)  | Español recomendado                                                                         | Cuándo usar                                                                  | Nunca usar                                                             | Notas                                                                                                                                                                                                                                                                                                                                                                                                         |
| --------------- | ------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 台灣            | **Taiwán**                                                                                  | Por defecto, en todo contexto                                                | `Taiwan` (sin tilde), `Formosa` (contemporáneo), `provincia de Taiwán` | DPD + FundéuRAE                                                                                                                                                                                                                                                                                                                                                                                               |
| 中華民國        | **República de China (Taiwán)**                                                             | Instituciones formales, Constitución, derecho internacional, citas oficiales | `República de China` a secas (confunde con RPC)                        | Uso de Paraguay/Guatemala                                                                                                                                                                                                                                                                                                                                                                                     |
| 中華台北        | **Taipéi Chino**                                                                            | Sólo contexto COI/Juegos Olímpicos/APEC/WHA                                  | Como sujeto por defecto en la prosa (reescribir como `Taiwán`)         | Sujeto por defecto siempre `Taiwán`. En la primera mención del contexto competitivo en un artículo, anotar `Taiwán (compitiendo como Taipéi Chino)`; después, solo `Taiwán`. Se conserva `Taipéi Chino` en citas directas, medallero oficial, nombre propio de una organización, o pasajes que explican la designación en sí ([EDITORIAL §六 賽事脈絡的稱名](../EDITORIAL.md), 2026-09-05 OBSERVER-QUEUE #41) |
| 兩岸 / 海峽兩岸 | **a ambos lados del estrecho** / **relaciones a ambos lados del estrecho**                  | Relaciones políticas RPC-ROC                                                 | `compatriotas a ambos lados del estrecho` (RPC)                        | Sin presuponer fraternidad                                                                                                                                                                                                                                                                                                                                                                                    |
| 中國大陸        | **China continental** (sólo cuando contraste geográfico relevante) / **China** / **la RPC** | Contexto histórico o contraste geográfico explícito                          | Como sinónimo neutro de `China` (asume marco «una China»)              | Descontextualizado evita                                                                                                                                                                                                                                                                                                                                                                                      |
| 中國            | **China** / **la República Popular China (RPC)**                                            | Referencia al Estado RPC                                                     | —                                                                      | Diferenciar de ROC siempre                                                                                                                                                                                                                                                                                                                                                                                    |
| 我國            | **Taiwán** / **nuestro país** (si la voz es de un taiwanés citado)                          | Reformular según contexto                                                    | Traducción literal sin recontextualizar                                | Contexto-dependiente                                                                                                                                                                                                                                                                                                                                                                                          |
| 台灣海峽        | **estrecho de Taiwán** (minúscula en _estrecho_)                                            | Geografía                                                                    | `Estrecho de Taiwán` (mayúscula incorrecta)                            | Norma Fundéu                                                                                                                                                                                                                                                                                                                                                                                                  |

## 2. Antropónimos — Wade-Giles + orden apellido-nombre

**Reglas**:

- Orden **apellido + nombre** (chino), sin invertir al estilo occidental
- Segunda mención: **apellido solo** (`Tsai`), nunca nombre de pila solo
- **Guión** entre las dos sílabas del nombre de pila: `Ing-wen`, `Ching-te`, `Kai-shek`. Nunca `Ing Wen` (separado), nunca `Ingwen` (junto sin guión)
- **Sin tildes** ortográficas en nombres romanizados (`Tsai Ing-wen` ✓, no `Tsái Íng-wén`)
- En artículos biográficos, añadir caracteres entre paréntesis en primera mención: `Audrey Tang (唐鳳)`
- **Nombres indígenas**: transliterar desde la grafía latina oficial taiwanesa (`Kolas Yotaka`), no desde el mandarín

**Lista canónica de figuras más referenciadas**:

| 漢字            | Taiwan.md (es)                | Pinyin RPC (NO) |
| --------------- | ----------------------------- | --------------- |
...
**Ciudades** (Wade-Giles oficial taiwanés, nunca pinyin RPC):

| 漢字        | Taiwan.md (es)                                | Pinyin (NO)     |
| ----------- | --------------------------------------------- | --------------- |
| 臺北 / 台北 | **Taipéi** (texto) / `Taipei` (institucional) | Taibei          |
...
| 雲林        | **Yunlin**                                    | Yunlin          |
| 南投        | **Nantou**                                    | Nantou          |
| 新北市      | **Nuevo Taipéi** (ciudad de)                  | New Taipei City |

**Distritos y barrios**: construcción `distrito de Xinyi` (con `de`), siguiendo patrón hispano `distrito de Salamanca`. Para barrios con sabor cotidiano cultural admisible `barrio de Ximending`.

**Islas externas** (atención a la disambiguación 馬祖 islas vs 媽祖 diosa):

| 漢字 | Taiwan.md (es)                      | Notas                                                                |
| ---- | ----------------------------------- | -------------------------------------------------------------------- |
| 金門 | **Kinmen**                          | `Quemoy` admisible en contexto Guerra Fría («crisis de Quemoy 1958») |
| 馬祖 | **Matsu** (islas, Wade-Giles)       | **Crítico**: distinguir de 媽祖 `Mazu` (diosa, pinyin)               |
| 澎湖 | **Penghu** / **islas Pescadores**   | Ambas formas viables                                                 |
| 綠島 | **Isla Verde** / `Lüdao`            |                                                                      |
| 蘭嶼 | **Isla de las Orquídeas** / `Lanyu` |                                                                      |

**Montañas y ríos**:

- 玉山 → **`monte Yushan`** + glosa en primera mención: «(literalmente, _Monte de Jade_)». No usar `Monte Jade` como término primario.
- 阿里山 → **`Alishan`** o **`monte Alishan`**
- 日月潭 → **`lago Sol y Luna`** (traducción semántica consolidada)
- 太魯閣 → **`Taroko`** o **`garganta de Taroko`**
- 中央山脈 → **`cordillera Central`**
- 淡水河 → **`río Tamsui`**

## 4. Léxico cultural

**Gastronomía** (política: transliteración + glosa en primera mención para platos icónicos; calco directo cuando es transparente):

| 漢字     | Taiwan.md (es)                                                            | Notas                                        |
| -------- | ------------------------------------------------------------------------- | -------------------------------------------- |
| 滷肉飯   | **`lurou fan`** (arroz con cerdo guisado)                                 | Mantener transliteración                     |
| 牛肉麵   | **`niurou mian`** (fideos con ternera) / **`sopa de fideos con ternera`** | Ambas viables                                |
| 珍珠奶茶 | **`té de burbujas`**                                                      | `bubble tea` admisible; `té de boba` también |
| 鳳梨酥   | **`pastel de piña`** (taiwanés)                                           | `torta de piña` LatAm                        |
| 小籠包   | **`xiaolongbao`** (empanadillas al vapor con caldo)                       | Pinyin extranjero internacional              |
| 臭豆腐   | **`tofu apestoso`**                                                       | Calco literal consolidado                    |
| 蚵仔煎   | **`tortilla de ostras`**                                                  | Calco directo                                |
| 雞排     | **`chuleta de pollo`** / **`milanesa de pollo gigante`**                  | LatAm: milanesa                              |
| 刈包     | **`gua bao`** / **`bocadillo taiwanés`**                                  | Anglicismo internacional                     |
| 夜市     | **`mercado nocturno`**                                                    | Sin discusión                                |
| 小吃     | **`xiaochi`** (aperitivos / bocadillos típicos)                           | Glosa en primera mención                     |

**Religión y mitología**:

- 媽祖 → **`Mazu`** (diosa, pinyin). UNESCO la registra como `el culto a Mazu y sus rituales`. Distinguir siempre de 馬祖 `Matsu` (islas).
...
| 漢字             | Taiwan.md (es)                                                        |
| ---------------- | --------------------------------------------------------------------- |
| 春節 / 過年      | **`Año Nuevo Lunar`** (preferido sobre `Año Nuevo Chino`)             |
| 中秋節           | **`Fiesta del Medio Otoño`**                                          |
| 端午節           | **`Fiesta del Bote del Dragón`**                                      |
| 元宵節           | **`Fiesta de los Faroles`**                                           |
| 清明節           | **`Fiesta de Qingming`** / **`Día del Barrido de Tumbas`**            |
| 七夕             | **`Qixi`** / **`Día de los Enamorados Chino`**                        |
| 中元節           | **`Festival de los Fantasmas`** / **`Festival Zhongyuan`**            |
| 雙十節           | **`Día Doble Diez`** / **`Fiesta Nacional de la República de China`** |
| 二二八和平紀念日 | **`Día de la Paz 2-28`** / **`Día de la Paz del 28 de Febrero`**      |

**Lenguas** (cuidado homonímico: `taiwanés` es a la vez gentilicio y lengua):

| 漢字          | Taiwan.md (es)                                                                                    |
| ------------- | ------------------------------------------------------------------------------------------------- |
| 國語 / 華語   | **`mandarín`** / **`mandarín taiwanés`** (cuando se distingue del de la RPC)                      |
| 台語 / 台灣話 | **`taiwanés`** (lengua) / **`hokkien taiwanés`** (especializado, evita ambigüedad con gentilicio) |
| 閩南語        | **`min nan`** / **`min del sur`**                                                                 |
| 客家話        | **`hakka`**                                                                                       |
| 原住民語      | **`lenguas indígenas`** / **`lenguas formosanas`** / **`lenguas austronesias de Taiwán`**         |

**Transporte / urbano**:

- 高鐵 → **`tren de alta velocidad de Taiwán`** (THSR / HSR)
- 捷運 → **`metro`** (de Taipéi, de Kaohsiung)
- 老街 → **`calle vieja`** / `lao jie`

## 5. Términos políticos / históricos sensibles

| 漢字       | Taiwan.md (es)                                                                                      | Notas                                                                         |
| ---------- | --------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| 二二八事件 | **`Incidente del 28 de Febrero`** / **`Incidente 228`** / **`Masacre 228`** (énfasis represión)     | Consolidado académicamente                                                    |
| 白色恐怖   | **`Terror Blanco`** (mayúsculas como periodo histórico nombrado 1949-1987)                          | `terror blanco` minúsculas sólo como genérico                                 |
| 戒嚴       | **`ley marcial`** (minúsculas); `periodo de ley marcial (1949-1987)`                                | 38 años y 57 días                                                             |
| 解嚴       | **`levantamiento de la ley marcial`**                                                               |                                                                               |
| 民國紀年   | **Convertir silenciosamente al gregoriano** en cuerpo                                               | Mantener doble notación sólo en citas, derecho, artículos sobre el calendario |
| 本省人     | **`benshengren`** + glosa «locales, descendientes de migrantes anteriores a 1945»                   | Pinyin con glosa en primera mención                                           |
| 外省人     | **`waishengren`** + glosa «continentales, migrantes llegados con el KMT entre 1945 y 1949»          | Estructura clave de la historia política post-1945                            |
| 日治時期   | **`periodo colonial japonés`** / **`periodo de dominación japonesa`** (1895-1945)                   | Evitar `ocupación japonesa` (anacrónico)                                      |
| 民主化     | **`democratización`**                                                                               |                                                                               |
| 原住民     | **`pueblos indígenas`** / **`indígenas taiwaneses`** (preferido); `aborígenes taiwaneses` aceptable | Evitar `gaoshan` (高山族, RPC-codificado)                                     |
| 國民黨     | **`Kuomintang`** / **`KMT`** / **`Partido Nacionalista Chino`**                                     | Wade-Giles consolidado en prensa hispana                                      |
| 民進黨     | **`Partido Democrático Progresista`** / **`PDP`** (Fundéu)                                          | Mejor que el anglo `DPP`                                                      |
| 台灣民眾黨 | **`Partido Popular de Taiwán`** / **`PPT`**                                                         | Mejor que `TPP`                                                               |
| 時代力量   | **`Poder del Nuevo Tiempo`** / **`New Power Party`**                                                |                                                                               |
| 行政院     | **`Ejecutivo Yuan`** / **`Yuan Ejecutivo`**                                                         |                                                                               |
| 立法院     | **`Legislativo Yuan`** / **`Yuan Legislativo`**                                                     |                                                                               |
| 司法院     | **`Judicial Yuan`**                                                                                 |                                                                               |
| 總統府     | **`Oficina Presidencial`** / **`Presidencia`**                                                      |                                                                               |
| 外交部     | **`Ministerio de Asuntos Exteriores`** (MOFA)                                                       |                                                                               |
| 國軍       | **`Fuerzas Armadas de Taiwán`** / **`Ejército de la ROC`**                                          |                                                                               |

## 6. Léxico contra fuga RPC-codificada

| RPC-codificado                                            | Reemplazo Taiwan.md                                                           | Severidad | Excepción                                      |
| --------------------------------------------------------- | ----------------------------------------------------------------------------- | --------- | ---------------------------------------------- |
| `Taiwán, China` / `Taiwan, China`                         | **`Taiwán`**                                                                  | crítica   | Sólo artículo sobre el etiquetado mismo        |
| `Taiwán, provincia de China`                              | **`Taiwán`**                                                                  | crítica   | Sólo artículo sobre el etiquetado              |
| `provincia china de Taiwán` / `provincia de Taiwán`       | **`Taiwán`** / **`República de China (Taiwán)`**                              | crítica   | —                                              |
| `la isla rebelde` / `provincia rebelde`                   | **`Taiwán`**                                                                  | crítica   | Nunca                                          |
| `compatriotas taiwaneses` (台灣同胞)                      | **`ciudadanos taiwaneses`** / **`los taiwaneses`**                            | alta      | Cita textual                                   |
| `Taipéi chino` / `Taipei chino`                           | **`Taiwán`**                                                                  | alta      | Sólo contexto COI/Olímpicos/APEC/WHA explícito |
| `autoridades de Taipéi` (en lugar de gobierno)            | **`Gobierno de Taiwán`** / **`Ejecutivo Yuan`** / **`presidencia taiwanesa`** | media     | —                                              |
| `reunificación` (cross-strait, como hecho)                | **`unificación`** (si se cita postura RPC) / reformular                       | media     | Cita textual de fuente RPC                     |
| `reunificar` (futuro, framing RPC)                        | **`anexar`** / **`invadir`** (según situación)                                | media     | Cita                                           |
| `compatriotas a ambos lados del estrecho`                 | **`a ambos lados del estrecho`**                                              | alta      | Cita                                           |
| `la isla` (despectivo, sustituyendo Taiwán como Estado)   | **`Taiwán`**                                                                  | media     | Contexto geográfico explícito                  |
| `Taiwán es parte de China` / `parte inseparable de China` | reformular como postura RPC contextualizada                                   | crítica   | Sólo describiendo la postura RPC               |
| `política de una sola China` (como hecho)                 | **`política de una sola China`** (presentada como postura RPC, no como hecho) | media     | Contextualizar siempre                         |
| `China continental` (sin contexto)                        | **`China`** / **`la RPC`**                                                    | baja      | Cuando contraste geográfico es relevante       |

## 7. Registro y estilo

- **Tuteo panhispánico neutro** (`tú`). Vosotros descartado; voseo descartado; usted sólo en citas/protocolo
- **Comillas españolas** « » como primer nivel → " " como segundo → ' ' como tercero. Aceptable " " por simplicidad técnica Markdown; migrar a « » en pasada estilística final
- **Fechas en cuerpo**: `24 de mayo de 2026` (mes en minúscula). **Metadata/frontmatter**: `2026-05-24` (ISO 8601). **Tablas/infografías**: `24/05/2026` aceptable
- **Horas**: formato 24h con `h`: `19:30 h`. Narrativa: `las siete y media de la tarde`. Evitar `7:30 PM`
- **Números**: separador de miles espacio fino (`12 500`) o punto peninsular (`12.500`); separador decimal coma (`3,14`). Coherencia interna por sección
- **Mayúsculas en títulos**: sólo la primera palabra y nombres propios (`Historia de Taiwán`, no `Historia De Taiwán`). Aplica también a `## secciones`
- **Cursiva**: términos chinos no adaptados (`lurou fan`, `xiaochi`, `bài bài`) en cursiva + glosa en primera mención. Términos adaptados (`Taiwán`, `Taipéi`, `Kuomintang`, `Mazu`) sin cursiva
- **Caracteres chinos**: añadir `(漢字)` entre paréntesis en primera mención de nombres propios biográficos para claridad académica + SEO multilingüe
- **Adjetivo**: `taiwanés` / `taiwanesa` preferido a `taiwanense` (raro) o `de Taiwán` (perífrasis). Evitar `formosano` (anacrónico) y `chino de Taiwán` (RPC-codificado)
- **Variante peninsular vs LatAm**: cuando exista bifurcación léxica relevante (`patata`/`papa`, `coche`/`carro`, `ordenador`/`computadora`), preferir la forma más extendida transatlánticamente

## 8. CI Lint — frases candidatas a hard-fail

Patrones para validador automático (script propuesto: `scripts/tools/article-health.py es-prc-leak-check`):

| Patrón regex                                                                     | Severidad | Excepción en lista blanca                                                      |
| -------------------------------------------------------------------------------- | --------- | ------------------------------------------------------------------------------ |
| `Taiwán,?\s*China`                                                               | crítica   | Artículo sobre el etiquetado ONU/RPC                                           |
| `provincia\s+(china\s+)?de\s+Taiwán`                                             | crítica   | Artículo sobre el reclamo RPC                                                  |
| `provincia\s+rebelde`                                                            | crítica   | Ninguna                                                                        |
| `(la\s+)?isla\s+rebelde`                                                         | crítica   | Ninguna                                                                        |
| `compatriotas\s+taiwaneses`                                                      | alta      | Cita textual                                                                   |
| `Taip[eé]i\s+chino`                                                              | alta      | Contexto COI/Olímpicos/APEC/WHA                                                |
| `autoridades\s+de\s+Taipéi`                                                      | media     | —                                                                              |
| `\breunificación\b`                                                              | media     | Cita textual fuente RPC                                                        |
| `Chiang\s+Kai-chek` (grafía errónea)                                             | baja      | —                                                                              |
| `Cai\s+Yingwen` / `Lai\s+Qingde` / `Jiang\s+Jieshi` (pinyin RPC para taiwaneses) | media     | Artículo sobre romanizaciones                                                  |
