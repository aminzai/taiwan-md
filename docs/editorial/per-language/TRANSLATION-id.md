...
| 中華台北        | **Taipei Tionghoa** / **`Chinese Taipei`** (istilah asli IOC)         | Hanya konteks Olimpiade/IOC/APEC/WHA                             | Sebagai subjek default dalam prosa (tulis ulang jadi `Taiwan`)                    | Subjek default selalu `Taiwan`. Pada kemunculan pertama konteks kompetisi dalam satu artikel, beri anotasi `Taiwan (bertanding sebagai Chinese Taipei)`; setelah itu cukup `Taiwan`. `Chinese Taipei` tetap dipakai apa adanya untuk kutipan langsung, tabel medali resmi, nama resmi organisasi, atau bagian yang menjelaskan penamaan itu sendiri ([EDITORIAL §六 賽事脈絡的稱名](../EDITORIAL.md), 2026-09-05 OBSERVER-QUEUE #41) |
