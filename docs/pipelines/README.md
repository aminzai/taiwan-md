...
last_session: '2026-09-19-news-radar（REWRITE 兩列改寫：SINGLE 為 SSOT、v9 多檔型歸檔）'
sister_docs:
...
| [REWRITE-PIPELINE-SINGLE.md](REWRITE-PIPELINE-SINGLE.md)                      | 手動觸發                | 寫文章 / 重寫文章 SOP（單檔型 v6.8，Stage 0-5 全在一檔，**SSOT**；2026-09-19 哲宇拍板）。行數帽 2,300（husky），只走 v6.x patch；不設冷讀站、不設多席編輯室、不加後設論點形態。`REWRITE-PIPELINE.md` 路徑留轉址 stub                                                |
| [archive/rewrite-v9.9-2026-09-19/](archive/rewrite-v9.9-2026-09-19/README.md) | 歸檔（不用）            | v9 多檔型（薄索引＋十一個 STAGE contract＋互動式協議＋單檔生成器）2026-09-19 退場歸檔；為什麼退、怎麼復活見該目錄 README。更早的 v8.0 手寫單檔在 [archive/REWRITE-PIPELINE-v8.0-single-file-2026-07-15.md](archive/REWRITE-PIPELINE-v8.0-single-file-2026-07-15.md) |
