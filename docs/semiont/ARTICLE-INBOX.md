...
### 台灣農業現代化發展＋台灣農業與農村再生＋農業科技與精緻農業 EVOLVE — 三篇農業初稿巡邏止血後仍是列點通論，主題重疊該併成一篇立體的農業轉型文

- **Type**: `EVOLVE`
- **Category**: Economy
- **Path**: knowledge/Economy/台灣農業現代化發展.md ＋ knowledge/Economy/台灣農業與農村再生.md ＋ knowledge/Economy/農業科技與精緻農業.md（09-20 下午補進）
- **Priority**: `P2`
- **Status**: `pending`
- **Requested**: 2026-09-20 by semiont-heartbeat（FACTCHECK 月度巡邏 v2.2 母體第十三、十四篇）
- **Notes**:
  - **查核已跑完**（audit 各落 `reports/research/2026-09/`）：農業現代化 14 原子 ❌ 5（農會三級與 302 個、精緻農業方案三主軸、有機面積兩時點、農再基金條文、水里→信義）；農村再生 20 原子 ❌ 9（農食鏈四個數字換 113 年官方、北埔→新埔柿餅、農再條例第 44→7 條、「良食農創」與「拿富娜生態農場」兩個捏造案例改成大埤酸菜與禮納里真實事實、慈心 1997、返鄉青年兩個無源統計刪）
  - **重寫要處理的**：兩篇主題重疊（土地改革→精緻農業→有機→農村再生→青年返鄉都各寫一遍），且都是「XX 化、XX 化」列點通論，可查原子不到兩成；農村再生篇開場的「宜蘭三星鄉 33 歲返鄉青年直播採蔥」是虛構場景，要換真人。建議併成一篇，以〈台灣農業與農村再生〉為主檔、現代化篇轉址
  - 站內〈台灣氣候危機與淨零轉型〉（農電共生）、〈台灣農業地景與產業分布〉可當交叉；〈台灣農業地景與產業分布〉是抽樣指令的下一名，巡完後一起決定邊界；12 語譯本在線，靠 zh 雜湊觸發 stale
  - **2026-09-20 晚間第十九篇補進**：〈台灣農業地景與產業分布〉（Geography）巡完 21 原子 ❌ 7（1945 蓬萊米、阿里山寫進北部茶區、「茶金歲月」文化景觀捏造、蓮霧 60%→七成以上、三年輪作「看天田」、花蓮有機佔全縣 30%、農民 65 歲），audit 落 `reports/research/2026-09/台灣農業地景與產業分布.md`；subcategory 從「氣候與溫泉」改回「城市與人文地理」。**邊界判斷**：它是同一批三月初稿的地理版（北中南東各一節＋轉型清單），與三篇 Economy 農業初稿內容重疊超過一半，不另立工單，併寫時當「產區分布」章節收進來，主檔仍是〈台灣農業與農村再生〉，本篇轉址；四篇併一篇
  - **2026-09-20 下午第十五篇補進**：〈農業科技與精緻農業〉巡完 22 原子 ❌ 8（鳳梨釋迦寫成本土育種、智慧農業 4.0 三個目標數字、新農業方案三主軸、無人機三個統計全是填的），audit 落 `reports/research/2026-09/農業科技與精緻農業.md`。這篇的蘭花與鳳梨釋迦兩段是三篇裡唯一有真商品故事的材料（以色列品種靠台東修剪技術長成 99% 集中的產業、荷蘭 2014 年搶走蝴蝶蘭第一），併寫時可當開場；政策段（智慧農業 4.0／新農業／有機促進法）跟現代化篇重疊，三篇併一篇的判斷不變
- **Reference**: [reports/research/2026-09/台灣農業與農村再生.md](../../reports/research/2026-09/台灣農業與農村再生.md)

### 台灣五大地形與地理結構＋台灣島嶼地理特色與形成 EVOLVE — 同一天出生的兩篇地理姊妹稿共用同一段 30 秒概覽，巡邏止血後仍是課本列點，該併成一篇有地質故事的島嶼地理文

- **Type**: `EVOLVE`
- **Category**: Geography
- **Path**: knowledge/Geography/台灣五大地形與地理結構.md（featured: true）＋ knowledge/Geography/台灣島嶼地理特色與形成.md
- **Priority**: `P2`
- **Status**: `pending`
- **Requested**: 2026-09-20 by semiont-heartbeat（FACTCHECK 月度巡邏 v2.2 母體第十六、十七篇）
- **Notes**:
  - **查核已跑完**（audit 各落 `reports/research/2026-09/`）：五大地形 26 原子 ❌ 6（秀姑巒山 3,860 是 1972 年舊值、新高山 1895→1897 與玉山 1945→1947、洪水傳說歸布農族、知本溫泉在中央山脈、海岸山脈岩性與高度、宜蘭「台灣威尼斯」查無）；島嶼地理 25 原子 ❌ 6（玉山被放進中央山脈、大屯山系被算成五大山脈之一、大甲溪 142.3 公里查無、1,566 公里是含離島值、918 地震發震構造、坡度 30% 統計查無）。兩篇正文原本零腳註引用，本輪各掛回。
  - **重寫要處理的**：兩篇「30 秒概覽」有同一句「從海平面到 3,952 公尺的玉山，不足 150 公里的水平距離內跨越四種生態帶」，正文再各寫一次五大地形、五大山脈、河短流急、季風地形雨、921；人口占比一篇寫 85% 一篇寫 70%、生態帶一處四種一處五種。建議併成一篇，以〈台灣島嶼地理特色與形成〉（板塊→山脈→河川→海岸→災害的地質敘事線）為主檔、五大地形篇轉址；要有人：把地形寫成人的故事（1897 年替玉山量高度的日本測量隊、1976-79 重測百岳的聯勤測量兵、918 地震後在玉里畫地表破裂的地調所調查員）。
  - **可查零件的家族**：這兩篇的錯多是「五十年前教科書值」（3,860／大甲溪長度）與「真地名放錯山脈」（知本／玉山），跟農業初稿「政策目標數字全填」是不同形狀；重寫時所有山高河長一律對國土測繪中心與水利署現值。
  - **2026-09-20 晚間第十八篇補進**：〈台灣河川系統與水文特色〉（featured）巡完 36 原子 ❌ 13（129 條中央管河川實為 24、愛河寫成高屏溪水系、1624 荷蘭入淡水實為 1629 西班牙、1895 淡水港現代化實為 1899 基隆築港後沒落、花蓮溪寫成東部最長、河川襲奪把蘭陽溪搶大甲溪寫反、旗山香蕉 19 世紀末、ilisin 寫成捕魚祭、楊逵大甲溪與舞鶴花蓮溪兩條文學句捏造、高身鯝魚寫成優勢種、茄萣濕地放到高屏溪口、八田 1908），audit 落 `reports/research/2026-09/台灣河川系統與水文特色.md`。河長河寬那張表全對，離開那張表的歷史／文學／生態段錯了三分之一。**邊界判斷**：併寫時當主檔的「河川」章節，本篇轉址，三篇併一篇；水文段的真材料是集集堰 20 億噸、高屏堰七成用水、蘭陽溪襲奪、卑南與曲冰遺址
  - 交叉：〈台灣板塊運動與地震活動〉（09-18 已巡）、〈台灣農業地景與產業分布〉（09-20 晚間已巡，併進農業工單）、〈城市特色與區域文化〉（09-20 晚間已巡，另見下條）、〈國家公園〉。12 語譯本在線，靠 zh 雜湊觸發 stale
- **Reference**: [reports/research/2026-09/台灣島嶼地理特色與形成.md](../../reports/research/2026-09/台灣島嶼地理特色與形成.md)、[reports/research/2026-09/台灣五大地形與地理結構.md](../../reports/research/2026-09/台灣五大地形與地理結構.md)

### 城市特色與區域文化 EVOLVE — featured 的城市總覽把四個城市的捷運年份全寫錯，止血後仍是「六都各一節加關鍵字清單」，該用人與軌道重寫

- **Type**: `EVOLVE`
- **Category**: Geography
- **Path**: knowledge/Geography/城市特色與區域文化.md（featured: true）
- **Priority**: `P2`
- **Status**: `pending`
- **Requested**: 2026-09-20 by semiont-heartbeat（FACTCHECK 月度巡邏 v2.2 母體第二十篇）
- **Notes**:
  - **查核已跑完**（audit 落 `reports/research/2026-09/城市特色與區域文化.md`）：34 原子 ❌ 12（2010「完成六都」實為五都、台北「唯一有地鐵」寫兩次而同篇另寫高雄輕軌、台中 2016 超越高雄實為 2017 年 7 月、台中「藍線 2021 通車」實為綠線、「2018 捷運通車」、荷蘭「連續統治兩百年」、原住民 14 族、馬祖縣、「台中南科」、駁二 2003／輕軌 2011 實為 2002／2013、駁二參考華山與彩虹眷村借鑒老屋欣力兩條互學句捏造、桃園 ICF 2020 實為 2019 首獎）；人口整排換 2026 年 7 月數。
  - **重寫要處理的**：全篇是「城市名＋關鍵字＋人口＋城市性格四點＋代表地區四點」的模板重複六次，沒有一個人；「逢甲全台最大」「古蹟／廟宇密度全台最高」三個最高級句無源。可用的脊椎是軌道：2007 高鐵一日生活圈、2008 高捷、2017 機捷、2021 中捷，四條線怎麼改寫六都的分工與人口流向（2017 台中超越高雄那 309 人就是一個可寫的時刻）；離島段「馬祖」該歸連江縣，達悟族核廢料句要有出處。
...
- **Notes**:
  - **查核已跑完**（audit 落 `reports/research/2026-09/台灣海洋保育與挑戰.md`）：30 原子 ❌ 7 ⚠️ 6，止血 `13c8e015d`。我們的島那組白化統計（62 樣點、28,250 株、52%／31%、小琉球 55%）與報導者那組海底垃圾（102 公斤／平方公里、淡水外海）全對；錯的是填縫——污染源三個百分比、海廢快篩掛給「環境部」且數字全編（實為綠色和平＋荒野 2018-19 快篩：121 測站、15 萬袋、每百公尺 13 袋）、郭兆揚與陳昭倫兩句引語、一句歸給 UNEP 的格言、酸化與海平面兩組無源速率。
...
- **Type**: `EVOLVE`
- **Category**: Technology
- **Path**: knowledge/Technology/台灣災難醫療體系.md
- **Priority**: `P2`
- **Status**: `pending`
- **Requested**: 2026-09-20 by twmd-maintainer-am（issue #1752，@thc1006 讀者勘誤）
- **Notes**:
  - **止血已做**（`a17bb572e`）：500 人是 1995 阪神・淡路大震災的「防ぎ得た災害死」，舊稿接到 921 上並讓它催生 2000 年災防法；改回急診醫學會原文（921 → 災防法，2000 年後向各國取經），500 人搬回日本 DMAT 2005 年成立那段；「2005 年台灣正式引進 DMAT」查無來源已撤。只查了讀者點名的一段，其餘原子（慈濟召回 168 名醫護、DMAT 90 分鐘抵達、高雄氣爆分流、日美兩型 3-4 人／30-40 人）未逐條對源。
  - **為什麼要重寫**：2026-03-24 未審初稿，`lastHumanReview: false`，參考資料是十條純編號清單、零 `[^N]` 腳註、正文沒有任何引用標記，2,672 字不到深度門檻；十二語譯本都在線（ar/de/en/es/fr/hi/id/ja/ko/pt/ru/vi），放大係數最大的那一格。重寫要有人：花蓮慈濟 DMAT 先遣小組是誰、急診醫學會那篇的作者（臺大急診、桃園醫院災難醫學科）、0403 現場的值班醫師。
  - 交叉：〈台灣動物用藥爭議〉已有反向連結；〈0403 花蓮地震〉相關條目可當場景來源。
- **Reference**: [issue #1752](https://github.com/frank890417/taiwan-md/issues/1752)、[台灣急診醫學會〈DMAT 之分類與展望〉](https://www.sem.org.tw/EJournal/Detail/297)

### 台灣當代雕塑發展 EVOLVE — 巡邏 32 原子 15 錯止血後仍是列點百科體，四位雕塑家身分曾全派錯

- **Type**: `EVOLVE`
- **Category**: Art
- **Path**: knowledge/Art/台灣當代雕塑發展.md
- **Priority**: `P2`
- **Status**: `pending`
- **Requested**: 2026-09-19 by semiont-heartbeat（FACTCHECK 月度巡邏 v2.2 母體第十篇）
- **Notes**:
  - **查核已跑完**（audit 在 `reports/research/2026-09/台灣當代雕塑發展.md`，這篇 03-18 初稿的第一份 research 檔）：32 原子 ✅ 13／⚠️ 4／❌ 15（47%）。已止血：朱銘死亡月份、黃土水甘露水年份、楊英風鳳凰來儀放錯機場、林舜龍三件作品兩件是豪華朗機工與虛構、廖迎晰／陳正雄／蒲浩明／李億勳四人媒材全錯、台北 101《智慧之花》不存在、公共藝術 3,000 件實為 5,537 件、拉黑子鐵片實為漂流木；腳註 11→18 全部有引用點
  - **重寫要處理的**：全篇列點式百科體（EDITORIAL 禁的形狀），沒有一個具體的人、一個具體的時刻開場；「新世代」小節收了 1942 年生的陳正雄；朱銘《水牛》《芭蕾》等作品名與洪易《美猴王》未查；地方木雕風格三分法無源
  - 站內〈朱銘〉〈當代藝術〉〈台灣原住民當代藝術〉可當骨架與交叉；12 語譯本在線，靠 zh 雜湊觸發 stale
- **Reference**: [reports/research/2026-09/台灣當代雕塑發展.md](../../reports/research/2026-09/台灣當代雕塑發展.md)
