...
### 台灣農業現代化發展＋台灣農業與農村再生 EVOLVE — 兩篇農業初稿巡邏止血後仍是列點通論，主題重疊該併成一篇立體的農業轉型文

- **Type**: `EVOLVE`
- **Category**: Economy
- **Path**: knowledge/Economy/台灣農業現代化發展.md ＋ knowledge/Economy/台灣農業與農村再生.md
- **Priority**: `P2`
- **Status**: `pending`
...
- **Notes**:
  ...
  - 站內〈台灣氣候危機與淨零轉型〉（農電共生）、〈台灣農業地景與產業分布〉、〈農業科技與精緻農業〉可當交叉；後兩篇是抽樣指令的下兩名，同批巡邏後可一起決定邊界；12 語譯本在線，靠 zh 雜湊觸發 stale
