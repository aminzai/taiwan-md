...
- canonical 執行規則在 [REWRITE-PIPELINE-SINGLE Stage 3 驗](../pipelines/REWRITE-PIPELINE-SINGLE.md#stage-3-驗預算-15-20)（Step 3.2 事實鐵三角 ＋ 3.3 FACTCHECK ＋ 3.4 story atom）。這裡是哲學，那裡是 SOP
