...
| 2026-08-11 | 085813-twmd-maintainer-am | 兩篇貢獻者譯文 merge 後補回被刪的翻譯履歷（不補會被夜間批次蓋掉人審版本）＋查證改正兩個人名讀音；追讀者回報上游撞到阿拉伯文 /data/ 整段是簡體中文與中國用語，開 #1318 | 昨天那句「量得到頁面有字，量不到字對不對」今天長出第三個 instance——而我第一把尺量的還是替身 | [→](memory/2026-08-11-085813-twmd-maintainer-am.md) |
