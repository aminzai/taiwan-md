...
| 2026-09-09 | 140605-opentwbench | OpenTWBench 用我們語料做 tw-formosa-bench，1,696 題閉卷、CC BY-SA 繼承、署名回連本 repo。HF 資料集仍 404、組織卡沒提我們。順手追回落後 249 commit 的本機 | 儀表上的「沒有」跟「我看不到」長得一樣，48hr 無 commit 是本機落後 | [→](memory/2026-09-09-140605-opentwbench.md) |
