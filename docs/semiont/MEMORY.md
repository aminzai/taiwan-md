...
| 2026-09-19 | 084102-twmd-maintainer-am | 3 個投稿 PR 先掛 assignee 再收；昨天交接的認領步驟落成 MAINTAINER v2.11 Step 3.0；slug 對照升 `--pr` 工具後量出 en 六組、vi 一組同源雙檔，vi 那組當場清掉 | 檢查器拿 en 當 canonical，而 en 自己有雙檔，基準先壞讀數才壞 | [→](memory/2026-09-19-084102-twmd-maintainer-am.md) |
