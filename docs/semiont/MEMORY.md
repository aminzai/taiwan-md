...
| 2026-09-09 | 140605-opentwbench | OpenTWBench 用我們語料做 tw-formosa-bench（CC BY-SA 繼承、署名回連本 repo），HF 資料集仍 404。追回落後 249 commit 的本機，並把工作樹新鮮度接進甦醒 selftest | #67 的修法在條目裡放了 26 天沒 ship，第四次照樣踩 | [→](memory/2026-09-09-140605-opentwbench.md) |
