---
title: 'REFLEXES'
description: '跨 session 程序記憶 catalog — 82 條 #N 反射（last #82，部分編號 historical 凋亡；本行是條數唯一 SSOT，counts-drift lint 對賬），LESSONS-INBOX distill 後的 instinct 層，候選 MANIFESTO promotion 來源'
type: 'cognitive-organ'
status: 'canonical'
apoptosis: 'never'
current_version: 'v5.9'
last_updated: 2026-07-12
last_session: '2026-07-12-142709-weekly-audience（#56 補觸發 v4：Resend sandbox 註記過時四個月）'
sister_docs:
  - 'DNA.md'
  - 'LESSONS-INBOX.md'
  - 'MEMORY.md'
...
- **相關**：REFLEXES #31 v2（sub-agent self-quality claim 不可信，本條 specific instance）/ REFLEXES #66（gate threshold 用真實產出校準，本條 specific instance）/ REFLEXES #59（製造數字的人最易被數字騙，producer self-validation specific instance）/ REFLEXES #65（awareness instrument cross-verify，awareness layer specific instance）/ **MANIFESTO §外部尺 over 內視（本 meta-umbrella 的哲學母體，2026-06-19 哲宇拍板升 §進化哲學第四維度）** / MANIFESTO §10 寫作幻覺（兄弟結構）
- **跨檔關聯**：[reports/routine-audit-2026-06-07.md §Pattern 1 + Lens C C1](../../reports/routine-audit-2026-06-07.md) + [reports/semiont-full-audit-2026-06-10.md §6 勘誤表](../../reports/semiont-full-audit-2026-06-10.md) + [reports/semiont-full-audit-2026-06-10-execution.md §meta-observation](../../reports/semiont-full-audit-2026-06-10-execution.md) + DIARY 2026-06-07-124521-carousel-charts「視覺自檢≠人眼」（原始 catalyst）+ MEMORY §神經迴路「製造數字的人最易被數字騙」（兄弟條目）
...
- **操作**：→ `scripts/tools/lang-sync/backfill-source-sha.py` / `scripts/tools/inbox-audit.py` / `scripts/core/build-content-dates.mjs`（SPORE_POINTER + MEDIA_ONLY + RELATED_DIARY 三組排除）
...
**#77 Spine type is subject-typed — beloved/institutional/collective-memory 題預設立體群像 spine，只有 genuinely contested 才用矛盾驅動**（2026-07-05 twmd-distill-weekly 升 canonical vc=3 — 2026-04-29 α #675 法輪功 5-7 perspective SSODT + 2026-04-29 α #687 吳百福跨國發明權 SSODT + 2026-06-28 manual 金曲獎 v1 矛盾 spine 炎上退稿 → v2 立體群像救回 + 2026-07-06 施振榮 v1 矛盾 spine 炎上（#77 canonical 隔天違反）→ v2 立體群像救回，vc=3→4，2026-07-06 哲宇 directive 升 v7.7「立體群像＝預設畫布 + 手法選單」+ persona 從 Stage 0 搬研究後，severity=structural）— REWRITE-PIPELINE Stage 0「找核心矛盾當 spine」對「爭議題 / 人物內在張力」是對的，但對「受愛戴的機構 / 傳統 / 集體記憶 / 地方 / 集體慶祝的儀式」這類題材會**結構性製造 contrarian thesis**，把立體的主題壓成論戰、把慶祝壓成批判、把好意壓成炎上。這類題材的預設 spine 應是**立體群像**（多面並陳、慶祝 + 理解、爭議當厚度不當主軸）。**觀點 ≠ 論戰** — 欣賞式 / 群像式也是策展觀點。

- **規則**：(a) Stage 0 §模式判定後加「spine 類型」判定 fork：**contested**（人物內在張力 / 政策爭議 / 產業迭代結構性衝突）→ 矛盾驅動 spine；**beloved · institutional · tradition · place · collective-memory · celebrated-ritual** → **立體群像 default**（不強迫找核心矛盾） (b) 政治敏感題（宗教政治 / 兩岸 / 跨國爭議）走 SSODT 5-7 perspective 立體框架，每個 perspective 獨立站得住不互相消解、各 3-5 獨立 source (c) 非政治主題卻把政治 / 兩岸 / 主權當 spine 或壓軸 = 命中 §自主權邊界 政治立場 = human gate (d) Stage 0.6 加「炎上/立場 self-check」+ SSODT 三讀者測試升 hard gate：**支持者讀完不覺得被攻擊 / 批評者不覺得在幫他們宣傳 / 陌生者能自己決定從哪個維度繼續想** (e) **v7.7 default 升畫布**（2026-07-06 施振榮）：立體群像不是「beloved 題的 default」，是**幾乎所有台灣主題的預設畫布**——原「二選一」誘導「有張力→選矛盾」的誤分類；改「立體群像畫布 + 7 手法選單 + 矛盾驅動需 unlock_reason 才解鎖」（見 [Step 0.1.5](../pipelines/REWRITE-PIPELINE.md)）。DNA 根：[MANIFESTO §13 立體地愛](MANIFESTO.md)（立體＝愛之下仍看見真實、幫台灣被看見） (f) **防誤分類 hook**：一個人物「有真實內在張力」≠ 該用矛盾驅動——受愛戴人物 default 立體群像贏，張力當手法 1「核心矛盾為輔」的一個 facet（施振榮 v1 把「願意公開談失敗」誤讀成「自身選擇的拉扯」去 justify 矛盾驅動） (g) **防 self-check 理性化 hook**：Step 0.6.7 SSODT「支持者不覺被攻擊」判的是**外部效果**（真去想像一個支持者在讀），不是「我能不能自圓其說它不會」——用理性化勾過 = 沒真跑 self-check（施振榮 v1 用「這是他本人 framing」放行；哲宇這把外部尺才接住）
- **Boundary**：(a) 不覆蓋 Stage 1 §核心矛盾 ≤ 30 字（≤ 20 字更佳）鼓勵——那是「若有 spine 則濃縮」的濾鏡，跟本條「該不該用矛盾當 spine」是不同判斷層 (b) 不適用於純技術 / 科學 explainer（用結構清晰勝過群像）(c) beloved 題若 research 過程真的挖出 genuinely contested 面向且哲宇 in-loop 拍板，可 override 走矛盾 spine——但這是 override 不是 default
...
- **操作**：→ REWRITE-PIPELINE Stage 0.1 §模式判定後加 §0.1.5 spine-type fork（subject-type → spine-type mapping table）+ Stage 0.6.7 self-check「非政治主題卻把政治 / 兩岸 / 主權當 spine 或壓軸 = human gate」+ Stage 0.6 SSODT 三讀者測試升 hard gate（現為 soft check）
...
**#56 Pipeline canonical ↔ production drift = dormant entropy**（2026-05-17 twmd-distill-weekly 升 canonical，vc=2 跨域）— routine 飛輪 0 fail 跑越穩，canonical 描述的世界與 production 實況的 drift 越容易累積不被察覺。Production 健康本身會關閉 audit 動機；系統內建 sensor 抓得到「規則被違反 / canonical 引用斷鏈」，但抓不到「這份規則本身描述的對象已經換人了」。
...
**#82 Proxy signal antipattern — 訊號要摸到 ground truth，不是量它的替身**（2026-07-12 twmd-self-evolve-weekly 升 canonical vc=4 — 7/10 hub-template「程式碼都在功能從未存在，健檢照樣全綠」+ 7/10 elections-refresh「lastVerified 蓋章≠驗證，六週漏事實」+ 7/10 weekly-deep-review「fire≠完成 / 年齡≠健康 / 欄位在允許名單≠值安全」三件維運同構 + 7/11 dna-checkup「三把自製量尺同型說謊 — 排序方向 / vc regex / 過期快照」，severity=structural）— sensor / gate / instrument 造出來時常常挑「觀察成本低」的訊號當代理（cron fire / age / 欄位存在 / 檔案存在 / 儀式蓋章），代理跟被代理的 effect 之間有結構性 gap 就會 silent 說謊。跟 #24（工具說謊 9 種形式，同祖先「規則在 A 定義算法在 B 複寫」）差異：#24 是內部實作偏差；本條是**選錯要量的東西**，signal-choice 層的 pattern。
