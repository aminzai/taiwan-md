...
### EXP-2026-07-17-G | 404 根因判斷的收斂驗證

機械到期檢查：due_date: 2026-08-07 | EXP-2026-07-17-G

- **預測**：hreflang 死鏈根源修復（`f369f3c8e`）+ 資料驅動 redirect 部署後，(a) **D+21（2026-08-07）CF 7d 404 率從 14.99% 降到 ≤ 8%**；(b) D+30 monitor-404 的「可解析家族」（slug-variant + cross-lang-slug + untranslated-demand + renamed-or-truncated 合計）從基線 ~8.9k/日下降 ≥ 60%
