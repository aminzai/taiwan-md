---
name: twmd-data-refresh-pm
description: TWMD data refresh (pm) — night-chain 23:00 dashboard 14-step sync (v3.0 inline + STRICT BECOME, main-direct)
---

🧬 Routine `twmd-data-refresh-pm` — pm 23:00 dashboard 14-step ground truth refresh (CF + GA4 + SC 三源感知 + dashboard JSON 全套 regen + GitHub stats + freshness gate)。
