...
tags:
  [
    ...
    'administrative juridical person',
  ]
subcategory: '表演藝術'
author: 'Taiwan.md'
category: 'Culture'
...
A fully hand-built organ from the Dutch firm Flentrop was installed behind the wooden wall above the back stage of the National Concert Hall. This was Taiwan's first concert-hall-grade pipe organ, and at the time the largest baroque-style mechanical pipe organ in Asia[^7][^8].

The numbers: 4,172 pipes, 59 stops, including both metal and wooden pipes; the longest pipe exceeds five meters, the shortest about fifteen centimeters[^11]. The cost at the time was around NT$40 million[^9]. Because it uses pure mechanical tracker action, the player directly drives the mechanical valves when playing, with no electronic assistance. The keys are far heavier than a regular piano — making this a dual challenge of stamina and technique for performers[^10].

In 2015, after nearly thirty years of operation, the organ underwent its first major maintenance — cleaning the dust accumulated inside the pipes and re-tuning to restore optimal sound[^11].
...
During her tenure, the NTCH actively promoted accessible viewing environments, redesigning wheelchair seats so the sightline matches that of regular audiences, and developing "Relaxed Performances" — flexible spaces for audiences with special needs (including Tourette syndrome or autism), allowing sound or movement in the hall[^13]. In 2022, the NTCH's wheelchair ticketing reform was selected as one of the model cases for government accessibility.
...
[^1]: [What the Theater Has Changed, What Has Changed the Theater — PAR Performing Arts magazine](https://par.npac-ntch.org/tw/article/doc/ET7KRZLDAX) — In-depth report by NTCH's official arts magazine PAR, documenting the "Open Door Project" tearing down the iron gates, the oral legend of converting the third-floor VIP rooms into the Experimental Theater, and the NTCH's journey from authoritarian appendage to public arts space.

[^2]: [The NTCH and the Grand Hotel both designed by Yang Cho-cheng — NTCH Official Facebook](https://www.facebook.com/ntch.tw/posts/1286491826853465/) — Official NTCH page explaining the architectural design connections and historical context of three Yang Cho-cheng works (NTCH, Grand Hotel, Chiang Kai-shek Memorial Hall).

[^3]: [Before Tearing Down the CKS Memorial Hall, You Should Know... Why Taiwan Built So Many Chinese Palace-Style Buildings — Storm Media](https://www.storm.mg/lifestyle/157353) — Examining the political context of Taiwan's postwar "Chinese palace-style architecture" trend, explaining the architectural rank difference and meaning of hip-and-gable roof (Theater) vs. half-hip roof (Concert Hall).

[^4]: [Before Tearing Down the CKS Memorial Hall — Storm Media](https://www.storm.mg/lifestyle/157353) — Same as above, original quote: "The National Theater uses the highest imperial palace rank, the hip-and-gable roof; the National Concert Hall uses the more common palace half-hip roof."

[^5]: [The Surge of Administrative Juridical Persons: Savior or Point of No Return? — The Reporter](https://www.twreporter.org/a/taiwan-art-public-corporatization) — In-depth analysis of the pros and cons of administrative juridical-person reform for Taiwan's cultural venues. The NTCH was the first case in 2004, becoming the institutional template for later venues like Taichung National Theater and Weiwuying.

[^6]: [Story of the National Performing Arts Center NTCH Enterprise Union — Taipei City Bureau of Labor](https://bola.gov.taipei/News_Content.aspx?n=7A3C3FFB6914DBB8&sms=F6ADE17B2BE795AE&s=40BC54378337A397) — The Taipei Bureau of Labor records the development story of the NTCH union, covering the institutional evolution from 2004 administrative juridical-person reform to inclusion in the National Performing Arts Center in 2014.

[^7]: [Pipe Organ Knowledge - Construction — NTCH Official Facebook](https://www.facebook.com/ntch.tw/posts/3361329700588324/) — Official NTCH post introducing the Flentrop organ construction process, confirming "4,172 pipes, both metal and wooden," and detailing the Dutch-built, fully hand-crafted history.

[^8]: [The Ultimate Test for Competitors: Taipei National Concert Hall Organ — Classical Music Appreciation Notes](https://feelmusic.com.tw/2017/07/02/flentrop_organ_national_concert_hall/) — A music critic analyzes the touch characteristics of the Flentrop mechanical organ from a player's perspective, explaining the demands the fully mechanical, electronics-free design places on performers.

[^9]: [The Origins of the National Concert Hall Organ — UDN](https://udn.com/upf/newmedia/2015_vist/08/20150819_organ_08/index.html) — United Daily News 2015 in-depth feature during the organ's maintenance period, documenting details such as "composed of 4,172 pipes" and "cost approximately NT$40 million."

[^10]: [Professor Lohmann's Musical Feast! — OrgelkidsTaiwan](https://www.orgelkidstaiwan.org/allblog/2024blog/2024-ludger-lohmann-introduce/) — Taiwan's organ promotion organization introduces a German performer's NTCH performance, illustrating the actual physical demands the mechanical tracker design places on performers.

[^11]: [(Video) Three Concert Hall Organs - 1: Taipei's Classic Baroque — Liberty Times Arts](https://art.ltn.com.tw/article/breakingnews/2752601) — Liberty Times arts coverage of three Taiwan concert hall organs, confirming that the NTCH Flentrop is "composed of 4,172 pipes and 59 stops," and documenting the 2015 large-scale maintenance that cleaned dust to restore the sound.

[^12]: [Relaxed Comfort Is Evolution! NTCH Director Liu Yi-ru: Too Many Rules After 50 Make Life Narrow — fiftyplus](https://www.fiftyplus.com.tw/articles/16011) — In-depth interview with Liu Yi-ru explaining the design philosophy of the NTCH "Relaxed Performance" series. Original quote: "When you make the rules for watching a performance so cumbersome, you've already filtered out certain audiences from the start."

[^13]: [Accessible Seating Isn't Enough! Interview with NTCH Director Liu Yi-ru — Womany](https://womany.net/read/article/28060) — Womany's in-depth interview with Liu, explaining the design philosophy of inclusive services like "Relaxed Performances," and how to identify and remove "invisible barriers."

[^14]: [From the Grand Hotel to the NTCH: Glimpsing the Story of the Red House Through the Cracks — PAR Performing Arts](https://par.npac-ntch.org/tw/article/doc/HCIU3U595H) — PAR magazine traces the NTCH's overall transformation from authoritarian architecture to cultural landmark, from the intersection of architectural history and performing arts.
