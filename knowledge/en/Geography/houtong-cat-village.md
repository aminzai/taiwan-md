---
title: "Houtong: The Camera That Saved a Mountain Town Also Fed Taiwan's Largest Cat Dumping Ground; TNVR Patches Up What Tourism's Good Intentions Couldn't Finish"
description: "In 2009, photographer Chien Pei-ling (Cat Lady) walked into a forgotten mountain town along the Pingxi Line that had been abandoned for 19 years after the Ruisan coal mine ceased operations in 1990. Her camera turned Houtong into one of CNN's six best cat-watching destinations in the world in 2013. But the 'Cat Paradise' label bred Taiwan's largest cat dumping ground — a 2012 feline distemper outbreak, at least 10 cat abuse cases in 2013, and a 2022 abandonment case fined NT$110,000. In 2014, Cat Lady quit, leaving behind the words: 'Endlessly exploiting the cats, exploiting me, exploiting Houtong.' In January 2026, TNVR brought the cat population from 200–300 down to 30-something, and Mirror Weekly reported it under a 'village extinction' frame. But what disappeared wasn't the cat village — it was the 'single influencer IP propping up local revitalization' model."
date: 2026-05-27
...
After she left, Houtong continued to "develop very well, even better and better"[^3] — that's what she herself later said in an interview with _Culture Journal_. But the second half of what she said was: "**Only when people are taken care of can the animals possibly be better.**"[^3]
...
- January 2010: approximately 500 visitors per month[^12]
- Second half of 2010: tens of thousands per month
- November 2013, after the CNN list was published: annual visitors approaching 1 million[^12]
- 2016: approximately 870,000
- January–September 2017: a further 12% increase over the same period the previous year[^12]
...
Academic research has documented this tension. Lin Hung-chi's _The Rise of Cat City: The Construction of Cat Tourism Landscape in Houtong, New Taipei City_ (National Taiwan University master's thesis, 2016) points out that the commodification/symbolization/anthropomorphization process of the cat economy "marginalizes certain residents, other animals (such as dogs), sick and abandoned cats, as well as mining village memory and identity."[^20]
...
She later said in an interview with _Culture Journal_: "**I once thought I was indispensable, but after withdrawing I discovered that Houtong was still developing very well, even better and better.**" "**Only when people are taken care of can the animals possibly be better.**"[^3]
...
- November 2015: 189 cats sterilized[^23]
...
- April 2024: 172 cats on record[^24]
- January 2026: 30-something cats[^25]
...
**Jiufen** took the "shopping street tourism" path, where old street and coal mining memories are layered over with teahouses, taro ball shops, and the ghost of Miyazaki's _Spirited Away_.
...
- **Keelung River Valley Mountain Town Landscape** (hero) — Photo by CharlieDigital ([Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Stairway_to_Keelung_River_near_Houtong_Cat_Village_20160401.jpg)), April 1, 2016. License: [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).
- **Houtong Street Cat Close-up** (scene-mid 1) — Photo by Sun Taro ([Wikimedia Commons](<https://commons.wikimedia.org/wiki/File:2015-05-03_feral_calico_cat_at_Houtong_(cropped_2022).jpg>)), May 3, 2015. License: [CC BY-SA 2.0](https://creativecommons.org/licenses/by-sa/2.0/).
- **Houtong Street Scene Silhouette** (scene-mid 2) — Photo by lienyuan lee ([Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Houtong_Cat_Street_%E4%BE%AF%E7%A1%90%E8%B2%93%E8%A1%97_-_panoramio.jpg)), 2015. License: [CC BY 3.0](https://creativecommons.org/licenses/by/3.0/).

## References

[^1]: [Cat Lady's Facebook Withdrawal Statement — Liberty Times Transcript](https://news.ltn.com.tw/news/society/breakingnews/1063418) — July 24, 2014: Chien Pei-ling's original Facebook post with "endlessly exploiting the cats, exploiting me, exploiting Houtong" and "starting in July, we are officially withdrawing from here," quoted verbatim in the Liberty Times report.
...
[^5]: [Houtong Miners' Cultural History Museum Pit Slogans and Tours — Museum Island](https://www.tmaroc.org.tw/2023article46/) — 2023 in-depth Museum Island interview including "as long as the person is here, the tag is here," "work carefully in the pit," "when the acacia wood screams" — complete collection of miners' orally transmitted slogans, guided by Zhou Chao-nan.

[^6]: [Ruisan Coal Preparation Plant History — National Cultural Memory Bank](https://tcmb.culture.tw/zh-tw/detail?indexCode=Culture_Place&id=313163) — National Cultural Memory Bank detailed account of 1920 Yilan Line opening + Keelung Coal Mining Corporation building a modern coal preparation plant + 1934 Lee Chien-hsing leasing and reorganizing Ruisan Mining, complete timeline.

[^7]: [Lee Chien-hsing Wikipedia](https://zh.wikipedia.org/zh-tw/%E6%9D%8E%E5%BB%BA%E8%88%88) — Mining magnate Lee Chien-hsing's family background: leasing the mining rights Mitsui abandoned in 1934 to establish Ruisan Mining Company.

[^8]: [Houtong Population Curve and Coal Era — Li Wen Blog](https://litwenblog.com/ruifang-houtongcoal/) — Rapid growth after the 1920 coal preparation plant during the Japanese colonial period; peak population of 25,000+ during the 1960s–70s mining boom; dropped to under 1,000 after 1990 closure.

[^9]: [Wikipedia — Houtong Cat Village](https://zh.wikipedia.org/zh-tw/%E7%8C%B4%E7%A1%90%E8%B2%93%E6%9D%91) — Includes Chien Pei-ling's first visit to Guangfu Village in 2009, the October 31, 2009 "With Cats by Your Side, Houtong Is Most Beautiful" campaign launch, at least 10 cat abuse cases in June 2013, early abandonment waves, and complete background.

[^10]: [Wikipedia — Chien Pei-ling](https://zh.wikipedia.org/zh-tw/%E7%B0%A1%E4%BD%A9%E7%8E%B2) — Cat Lady Chien Pei-ling: born in Taoyuan in 1969, photographer, husband is a veterinarian, first visit to Guangfu Village in 2007 for material, intensive documentation from 2008–2009, complete background.

[^11]: [Wikipedia — Houtong Cat Village (same as ^9)](https://zh.wikipedia.org/zh-tw/%E7%8C%B4%E7%A1%90%E8%B2%93%E6%9D%91) — Record of the October 31, 2009 "With Cats by Your Side, Houtong Is Most Beautiful" cat-loving event launch.

[^12]: [GVM City Studies — Houtong Visitor Curve](https://city.gvm.com.tw/article/87327) — Complete curve data from approximately 500 visitors in January 2010 to nearly 1 million visitors in 2017.

[^13]: [New Taipei City Tourism — Houtong Cat Bridge](https://newtaipei.travel/zh-tw/attractions/detail/112430) — Completed March 30, 2013, NT$18 million cost, world's first human-cat shared overpass, coal mining tunnel imagery + coffee-brown cat form, Golden Quality Award in engineering, complete details.

[^14]: [The Pet City — Japanese Cat Islands vs. Houtong Comparison](https://thepetcity.co/article/65682/) — Tashirojima: domestic cats introduced in the 1600s for silkworm pest control / Ainoshima: symbiosis with sardine fishery from 1617 / "Islanders never actively developed tourism" contrasted with Houtong's tourism-spawned cat population.

[^15]: [Wikipedia — Houtong Cat Village (same as ^9)](https://zh.wikipedia.org/zh-tw/%E7%8C%B4%E7%A1%90%E8%B2%93%E6%9D%91) — Includes early abandonment waves causing mass street cat infections and deaths, at least 10 cat abuse cases in June 2013, average street cat lifespan of 3–5 years, complete data.

[^16]: [Environmental Information Center — Houtong Feline Distemper Outbreak, July 2012](https://e-info.org.tw/node/105755) — July 7, 2012: three adult cats plus several kittens died within a week, suspected to have been infected by abandoned cats brought in as disease vectors, complete report.

[^17]: [CNA — Ms. Huang's Cat Abandonment Case Total Fine of NT$110,000](https://www.cna.com.tw/news/asoc/202205240202.aspx) — April 2022: Ms. Huang, who found her cat too aggressive, abandoned it in Houtong with her boyfriend, captured on surveillance camera; animal protection office checked app records; total fine of NT$110,000, complete timeline.

[^18]: [GVM City Studies — Tourist High-Salt Treats and Kidney Failure](https://city.gvm.com.tw/article/129169) — Veterinarian warnings about high-salt/high-phosphorus meat paste treats straining cats' kidneys, many cats suffering kidney failure at a young age, complete background.

[^19]: [Wuo-Wuo "The Beauty and Sadness of Cat Village" Series](https://wuo-wuo.com/topics/stray-animals/63-houtong-cat-village-series/506-beauty-and-sadness-role-debut-cat-village) — Local volunteer Sister Ka vs. tourist "then tell the vendors downstairs not to sell them" dialogue; Black Coal Cat Rescue volunteer Xiao Pei's "dogs are fed this way all the time, how much can a cat eat" quote; in-depth series report.

[^20]: [Lin Hung-chi — The Rise of Cat City: The Construction of Cat Tourism Landscape in Houtong, New Taipei City](https://www.airitilibrary.com/Article/Detail/U0001-0202201614380900) — National Taiwan University master's thesis, 2016; academic analysis of cat economy commodification/symbolization/anthropomorphization + "marginalizes certain residents, other animals (such as dogs), sick and abandoned cats, mining village memory and identity," complete argument.

[^21]: [Cat Lady's July 2014 Withdrawal Controversy — Housefun](https://news.housefun.com.tw/news/article/68885877293.html) — Chien Pei-ling's five years of dedication led to withdrawal intentions after controversy (accused of exploiting cats / unwilling to save cats / sending cats to shelters), complete background.

[^22]: [Cat Lady's September 2014 Post-Withdrawal Interview — Housefun](https://news.housefun.com.tw/news/article/68885877293.html) — Post-withdrawal position: "The cats in Houtong were always street cats, not house cats," distinguishing street cat vs. house cat conceptual correction.

[^23]: [TaiSounds — Complete Houtong TNVR Data](https://www.taisounds.com/news/content/94/237355) — New Taipei City Animal Protection Office launched TNVR in June 2015, completed 189 sterilizations by November 2015, 240 cats in first half of 2016, reached 274 in June 2017, complete curve data.

[^24]: [CNA — Cat Office Unveiled April 29, 2024](https://www.cna.com.tw/news/aloc/202404290169.aspx) — Officially unveiled after three years of preparation; orange cat "Dorayaki" voted first director; 172 registered cats at the time.

[^25]: [Mirror Weekly — Houtong Cat Village Faces "Extinction"](https://www.mirrormedia.mg/story/20260121edi014) — January 21, 2026 report: "from a peak of 300 cats plummeting to only 30," three reasons (TNR sterilization + natural aging + tourist feeding harm) + "Cat Office contractor terminated agreement early" + "care and tourism routes experienced a disconnect," complete current situation.

[^26]: [New Taipei City Animal Protection Office — Houtong Cat Office Preparatory Office](https://www.ahiqo.ntpc.gov.tw/cht/index.php?code=list&flag=detail&ids=23&article_id=3901) — Established in 2021, former TRA dormitory, exterior "Ruifang Gold" tones echoing mining landscape, background.

[^27]: [CNA — Cat Office "Dorayaki" First Director (same as ^24)](https://www.cna.com.tw/news/aloc/202404290169.aspx) — Same article includes exterior electronic display showing cat locations + links to eight animal shelters for adoption function description.

[^28]: [New Taipei City Tourism — Cat Bridge 205 Renovation and Reopening](https://newtaipei.travel/zh-tw/news/detail/3263) — March 26, 2025 major renovation and reopening, nighttime construction 1:00–4:00 AM, 3 hours of work time per day, complete engineering record.

[^29]: [TVBS — 200 Cats Now Only 30](https://news.tvbs.com.tw/local/3104028) — January 2026 follow-up report on "cat population plummeting" frame, with TVBS / ETtoday / TaiSounds / CTWANT reporting in parallel the same month.

[^30]: [A Day Magazine — Houtong Cat Village Is About to Disappear](https://www.adaymag.com/2026/01/23/houtong-cat-village-controversy.html) — January 23, 2026 sharp-positioned in-depth commentary: "animals should never be human toys" frame.

[^31]: [UBrand — Should the Cat Office Breed Cats](https://ubrand.udn.com/ubrand/story/123652/9276555) — Guangfu Village Chief Zhou Jin-yi's proposal "the Cat Office should be responsible for breeding, microchip implantation, and management" + public rebuttal "violates the Cat Office's founding purpose" + Ministry of Agriculture Deputy Director Chen Chung-hsing's statement "cats cannot be privately bred," complete controversy collection.

[^32]: [Smile Taiwan — Houtong Miners' Cultural History Museum](https://smiletaiwan.cw.com.tw/article/8270) — 2023 Smile Taiwan quarterly report on retired miners including Zhou Chao-nan pooling monthly pensions of a little over NT$3,000 to lease and renovate the former Ruisan Main Mine office, serving as their own guides, complete story.

[^33]: [UDN — Ruisan Coal Preparation Plant Phase I Reopening](https://udn.com/news/story/7323/6424633) — Opened September 2022, three years of "restoring the old as old" restoration, 2022 Golden Quality Award in Public Works, nearly 500,000 visitors in the first year, complete record.

[^34]: [UDN — Coal Preparation Plant Phase II Groundbreaking](https://udn.com/news/story/7323/8306882) — 2025 Phase II restoration groundbreaking, total budget of NT$114 million (NT$57 million central + NT$57 million local), focus on machinery relic space restoration and outdoor environmental beautification planning.

[^35]: [Torre Argentina Cat Sanctuary Wikipedia](https://en.wikipedia.org/wiki/Torre_Argentina_Cat_Sanctuary) — Stray cats gathered at the Largo di Torre Argentina temple district (excavated 1929) in Rome's Piazza della Repubblica; volunteers took over spay/neuter in 1994; approximately 150 cats inhabit the ancient Roman ruins; open to visitors daily 12:00–16:30 free of charge — the sanctuary paradigm (vs. Houtong spectacle paradigm comparison).

[^36]: [VICE — Disneyland Feral Cat Program](https://www.vice.com/en/article/disneyland-has-a-feral-cat-problem-1013/) — Disneyland has run TNR since 2001; since 2007 the internal Circle D Ranch has managed the "rat control" pragmatism path, contrasted with Houtong's spectacle path.
