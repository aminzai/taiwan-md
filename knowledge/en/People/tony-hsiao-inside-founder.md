...
He started as a game product manager at Songgang Technology (松崗科技), handling multiple Blizzard titles including _StarCraft: Brood War_. He then moved to Yam (蕃薯藤), a leading Taiwanese internet portal, crossing from games into portal operations, simultaneously managing channels for gaming, stock finance, fortune-telling, and horoscopes. After that, he went to NHN Taiwan, handling dictionary services.[^inside-article]
...
"Cookpad went public, with annual revenue of NT$2 billion — we could probably try this too."[^gvm][^cookpad-correction]
...
> **✦** "Since founding the company, we've never worried about money." — Tony Hsiao (from a _Global Views Monthly_ interview)
...
[^inside-wiki]: [INSIDE 硬塞的網路趨勢觀察 — Wikipedia](https://zh.wikipedia.org/zh-tw/INSIDE_%E7%A1%AC%E5%A1%9E%E7%9A%84%E7%B6%B2%E8%B7%AF%E8%B6%A8%E5%8B%A2%E8%A7%80%E5%AF%9F) — Chinese Wikipedia entry documenting INSIDE's founding date (November 26, 2009), six founders, formal incorporation (October 2011), and acquisition by The News Lens (January 2018).

[^inside-article]: [INSIDE at Ten: fOx Tony Hsiao on Two Lessons from a Decade in the Internet Startup Scene — INSIDE](https://www.inside.com.tw/article/18177-fox-hsiao) — INSIDE's tenth-anniversary retrospective interview, recording Tony Hsiao's career path (Songgang → Yam → NHN → INSIDE co-founder) and the origin of the "li-chang-bo" nickname.

[^gvm]: [Raising NT$300,000 to Build a Site Worth NT$3 Million — Global Views Monthly](https://www.gvm.com.tw/article/18219) — iCook's early founding story; documents the three co-founders' division of labor, iCook's inspiration (Cookpad), and founding timeline (August 2010 incorporation, November 2011 launch).

[^buzzorange]: [Taiwan's First Internet Media Acquisition in 2018: The News Lens Announces Acquisition of INSIDE — TechOrange](https://buzzorange.com/techorange/2018/01/03/inside-married-news-lens/) — Report on The News Lens's acquisition of INSIDE, documenting this as "Taiwan's first formally recorded internet media acquisition."

[^bnext]: [The News Lens Media Group Announces Acquisition of Taiwan's Largest Recipe Platform iCook — Business Next](https://www.bnext.com.tw/article/71676/tnl-media-group-bought-icook) — September 2022 formal report on iCook's acquisition by The News Lens Media Group, explaining strategic intent and business integration direction.

[^wazaiii]: [Flipping Through Tony Hsiao fOx's "AI Travelogue" — Wazaiii](https://www.wazaiii.com/articles?id=interview-ai-fox-hsiao-inside-icook) — Tony Hsiao's Wazaiii interview on his tech-optimist stance, iCook's AI recipe feature launch (May 2023), and his practical approach to the AI wave.

[^tnl]: ["Anxiety Machine" fOx Tony Hsiao: Roaming the Crypto and AI Waves — How to Stay Curious About New Things — The News Lens](https://www.thenewslens.com/article/254336) — Documents Tony Hsiao's experiment of using AI tools to develop and sell a business-card-scanning app, and his personal strategy for navigating rapid technology iteration.

[^inside-icook]: [Tony Hsiao and Richard Lee in Their Own Words: Why Did iCook Choose The News Lens Again? — INSIDE](https://www.inside.com.tw/article/29087-tnl-icook) — Essay by iCook's two co-founders at the time of acquisition, explaining the decision logic for choosing The News Lens and their self-interpretation of both sales.

[^cookpad-correction]: [Cookpad TSE Mothers IPO official record — TechCrunch 2009-06-12](https://techcrunch.com/2009/06/12/a-recipe-site-goes-ipo-in-japan-cookpad/) — Factual correction: Cookpad's actual IPO was July 17, 2009 (Tokyo Stock Exchange Mothers board), not 2008 as mentioned in Tony Hsiao's quoted recollection. The verbatim quote is preserved as his original words at the time of interview; the year discrepancy does not affect the core argument that "the IPO inspired the founding."
