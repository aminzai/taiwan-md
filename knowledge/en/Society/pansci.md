---
title: 'PanSci: From the Black Hole of Science News to the Knowledge Industry Inside the Algorithm'
description: 'In 2011, Cheng Kuo-wei and Hsu Ting-yao turned a canceled project into PanSci. Later academic research would treat it as an important node in the democratization of science communication in Taiwan; but its real problem has been that public scientific discussion must first survive through advertising, courses, video, and algorithms.'
date: 2026-05-07
author: 'Taiwan.md'
category: 'Society'
subcategory: '媒體與言論'
...
In 2013, when _Business Next_ wrote about PanSci, it offered a very early and very precise diagnosis: Taiwan’s mainstream media lacked science news. Cheng Kuo-wei summarized the problem at the time in a bleak sentence: “Science news is a large black hole.” [^bnext]
...
A Taiwan Science Forum report that year noted that PanSci had accumulated more than 80 science bloggers and over 2,780 articles, with more than 20,000 daily visitors and more than 130,000 monthly visitors. [^life] For Taiwan’s internet in the early 2010s, these numbers represented a kind of community density: a group of people willing to translate professional knowledge into public language began to have a fixed point of entry.

In 2014, Cheng Kuo-wei provided another set of early figures: in PanSci’s first year, it had only one full-time editor; he was delighted if an article received 2,000 to 3,000 views, and monthly traffic averaged only twenty to thirty thousand views. Four years later, monthly views had surpassed 2.5 million, and Facebook likes exceeded 170,000. [^letter]
...
> “Science is too important to be left only to scientists.” [^about]
...
In 2020, the Taiwan chapter in ANU Press’s _Communicating Science: A Global Perspective_ wrote the science blogging project PanSci, which began in 2011, into the history of science communication in Taiwan. The chapter described PanSci as one of Taiwan’s largest and most important knowledge communities of science communicators, and placed PanMedia’s transformation into a for-profit company within the context of “building a knowledge ecosystem.” [^anu]
...
When _The News Lens_ organized the controversy at the time, it placed it within the difficulties of media survival and native advertising: without money, media struggle to produce in-depth content; but whose money is accepted, how it is disclosed, and whether the possibility of counterevidence can be preserved directly affect trust. [^tnl]
...
The official page of PanSci Academy positions it as an online course platform under the Pan Knowledge media group, using diverse learning channels, interdisciplinary talent, and applicable topics to disseminate knowledge more effectively. [^school] This is the first layer of PanSci’s shift from “readers” toward “learners.”

Another product closer to school settings is “Science Student.” In 2020, Pan Knowledge, Nan I Book Enterprise, and _Science Monthly_ jointly launched a popular science reading platform, using 10,000 popular science articles on PanSci and the 50-year database of _Science Monthly_, then having teachers rewrite them into short texts and questions suitable for junior and senior high school students. [^student]

The transformation here is interesting. PanSci’s early articles were often written for adults and readers at university level or above. By the time of Science Student, they had to be rewritten into materials of about 400 Chinese characters, aligned with course progress, and usable by teachers for morning reading or literacy-oriented question sets. [^student]
...
This also allows it to be viewed alongside the [Encyclopedia of Taiwan](/en/society/encyclopedia-of-taiwan/). The Encyclopedia of Taiwan was a state project to establish a definitive body of knowledge; PanSci is a private platform that breaks scientific knowledge into articles, question sets, courses, videos, and services. The former asks “who has the authority to define Taiwanese knowledge,” while the latter asks “how knowledge can be seen, read through, transformed, and kept in use.”

## Wednesday Morning Recording Day

In 2026, PanSci’s most visible form may no longer be on its website, but in short videos.

This direction has a history. In 2022, PeoPo Citizen Journalism reported that a PanSci [explainer video on monkeypox / mpox](https://www.youtube.com/watch?v=xmjHnr6u9BM) had received more than 2.2 million YouTube views; the channel at the time had accumulated more than 400 videos and nearly 400,000 subscribers. [^peopo][^yt-mpox]

From the official channel’s [explanation of Webb telescope images](https://www.youtube.com/watch?v=tTe-nwziwCw) in the same year to [PanSci NEWS EP46](https://www.youtube.com/watch?v=x__seBgp4HE) in 2026, one can see PanSci’s video turn testing formats across astronomy, medicine, everyday science, and science news. [^yt-webb][^yt-news46]

A _Mirror Media_ profile wrote that Cheng Kuo-wei, facing a traffic bottleneck, began producing daily short videos on science news. On recording days, colleagues select science news from sources such as _Nature_, _Science_, and Science Alert; Cheng requires scripts to check both the paper itself and reports by other high-quality science media, then uses AI tools to help digest papers and examine the strengths and weaknesses of script versions. [^mirror]
...
The 104 company page says that, based on its content production experience, it introduced data analysis, content production, and advertising monetization systems, with the goal of building a future-oriented digital content industry. [^104] PanMedia’s official website, meanwhile, announced the MARMOT system in 2024, describing it as a multi-channel analytics, revenue optimization, and precise targeting tool designed for explanatory news media and content creators. Its partners include explanatory news media such as FoodNext and the Plain Law Movement. [^marmot]
...
<div class="video-embed" style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;margin:1.5rem 0;border-radius:8px;">
  <iframe src="https://www.youtube.com/embed/ByWmta-51Y4" title="Should we thank Bill Gates and Jensen Huang for 2024? Should PanSci open a fried chicken shop after one million subscribers? The video most people disliked turned out to be...?" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>

_PanSci’s official channel: 2024 year-end review video. It works backward from breakout topics to “what the algorithm chose for you,” then further back to “why this topic exploded” -- this is the most recent year’s self-interview on the trajectory “from website to knowledge industry.”_
...
If [The Reporter](/en/society/the-reporter-investigative-journalism/) uses nonprofit investigative journalism to answer the question “how should public truth be funded,” PanSci answers another question: how can public science survive among commercial platforms, school settings, and social algorithms?
...
- [The Reporter](/en/society/the-reporter-investigative-journalism/) — Also concerned with the publicness of Taiwan’s new media, but The Reporter builds trust through nonprofit investigative journalism, forming a contrast with PanSci’s route as a commercial knowledge platform.
- [CommonWealth Magazine](/en/society/commonwealth-magazine) — A Taiwanese financial media outlet born thirty years before PanSci, also navigating survival between "public service" and "market viability" — but via corporate rankings and paid subscriptions as an authoritative route.
- [Thinking Taiwan Forum](/en/society/thinking-taiwan-forum/) — Also a platform for public discussion, Thinking Taiwan turns political and democratic dialogue into a container for commentary, while PanSci turns scientific discussion into a knowledge industry.
- [Encyclopedia of Taiwan](/en/society/encyclopedia-of-taiwan/) — A contrast between a national knowledge project and a private popular science community: one side pursues an authoritative reference work, while the other pursues readability, circulation, and transformation.
- [Taiwan’s YouTuber Industry and Culture](/en/culture/taiwan-youtuber-industry/) — The larger platform ecosystem PanSci must face after entering short video, MCNs, and the creator economy.
...
- **[One-Shot Interview / The Angry Young Man Is Middle-Aged: PanSci Co-founder Cheng Kuo-wei](https://www.mirrormedia.mg/story/20260402pol001)** (hero) — Photo: Chen Chang-yuan / _Mirror Media_, interview published 2026-04-12. Fair use editorial commentary on PanSci founder reference photo.
- **[PanSci homepage banner](https://pansci.asia/)** — PanSci official brand material (banner1.jpg), fair use editorial commentary on PanSci's brand identity.
- **[PanSci logo](https://pansci.asia/aboutus)** — PanSci official logo, fair use editorial commentary on PanSci's brand identity.

## References

[^about]: [PanSci: About Us](https://pansci.asia/aboutus) — Official page documenting its 2011 founding, status as Taiwan’s largest science website and community, content sources, and business model.

[^letter]: [Cheng Kuo-wei: To Every Partner at PanSci: We Are Taking the Next Step](https://pansci.asia/archives/67958) — A 2014 first-person account explaining the project’s origins, early scale, the independent founding of Pan Knowledge, and its social enterprise positioning.

[^life]: [Life: 2013 Taiwan Science Forum report](https://life.tw/?app=view&no=109512) — Records the scale at the time: more than 80 science bloggers, over 2,780 articles, and average daily and monthly visitors.

[^bnext]: [Business Next reprint: Independent Media: Growing the Field of Popular Science, PanSci Spreads Cool Knowledge with Heat](https://life.tw/?app=view&no=50318) — An early 2013 interview recording the “science news black hole,” the forum of more than 300 people, and PanSci’s still-immature business model.

[^nccu]: [NCCU Academic Hub: Social Networking Sites and Public Engagement: A User Study of the “Pansci” Facebook Page](https://ah.lib.nccu.edu.tw/item?item_id=113872&locale=zh_TW) — A 2016 communication study, N = 1,160, analyzing the relationship between PanSci use and informational participation and civic participation.

[^airiti]: [Airiti Library: A Preliminary Study on the Characteristics and Communication Effects of Popular Science Websites Across the Strait](https://www.airitilibrary.com/Article/Detail/P20180326001-201701-201803260017-201803260017-93-132) — A 2017 content analysis comparing Guokr and PanSci on topics, vividness, interactivity, and credibility.

[^anu]: [ANU Press / ResearchGate: TAIWAN: From nationalising science to democratising science](https://www.researchgate.net/publication/344233284_TAIWAN_From_nationalising_science_to_democratising_science) — A 2020 chapter on the history of science communication in Taiwan, placing PanSci within the context of science communication democratization and knowledge communities.

[^technews]: [TechNews: Pan Knowledge Officially Invests in the flyingV Crowdfunding Platform](https://technews.tw/2018/06/15/panmedia-flyingv/) — A 2018 report on a strategic alliance, providing context for Pan Knowledge’s expansion into a knowledge services group.

[^cna]: [Central News Agency: Should Ting Hsin Be Boycotted? PanSci Editor-in-Chief: I Don’t Know](https://www.cna.com.tw/news/afe/201606210480.aspx) — The 2016 Lin Feng Ying / Wei Chuan sponsorship controversy and Cheng Kuo-wei’s response.

[^tnl]: [The News Lens: How Should We View the Popular Science Website PanSci Accepting Wei Chuan Sponsorship for an Investigation?](https://www.thenewslens.com/article/42549) — Organizes the incident background, online criticism, and discussions of sponsorship and media survival.

[^school]: [PanSci Academy: About the Academy](https://school.pansci.asia/about-us) — Official positioning and service information for PanSci Academy.

[^student]: [PanSci: PanSci, Nan I, and Science Monthly Launch “Science Student”](https://pansci.asia/archives/190485) — Sources for the Science Student platform, teacher needs, 10,000 PanSci articles, and the 50-year _Science Monthly_ database.

[^104]: [104 Job Bank: Pan Knowledge Co., Ltd.](https://www.104.com.tw/company/1a2x6bjflf) — Company capital, employee count, products and services, digital content industry positioning, and YouTube MCN status.

[^saleskit]: [Pan Knowledge Media Kit 2022](https://pansci.asia/wp-content/uploads/2022/04/%E6%B3%9B%E7%A7%91%E7%9F%A5%E8%AD%98sales-kit_%E5%B0%88%E6%A1%88%E4%BB%8B%E7%B4%B9%E7%B6%B2%E9%A0%81%E7%89%88_202204-.pdf) — A 2022 sales presentation disclosing monthly pageviews, social readership, and brand content service items.

[^marmot]: [PanMedia: Taking News Digital to the Next Level: PanMedia Partners with YouTube to Launch the MARMOT System](https://panmedia.asia/en/home-en/) — PanMedia’s 2024 explanation of the MARMOT system, positioned as a tool for explanatory news video creators.

[^peopo]: [PeoPo Citizen Journalism: From Monkeypox to the Universe, PanSci Uses Video to Popularize Knowledge](https://www.peopo.org/news/605018) — A 2022 student report recording more than 2.2 million views for the monkeypox video, more than 400 videos, and about 400,000 subscribers.

[^yt-mpox]: [PanSci YouTube: Taiwan’s Local Monkeypox / Mpox Has Arrived!](https://www.youtube.com/watch?v=xmjHnr6u9BM) — Official channel video from 2022-06-20; retrieved with yt-dlp on 2026-05-07, showing uploader as PanSci and view count above 2.33 million.

[^yt-webb]: [PanSci YouTube: Full Explanation of the Latest Images! What Makes the Webb Telescope So Powerful?](https://www.youtube.com/watch?v=tTe-nwziwCw) — Official channel video from 2022-07-14; retrieved with yt-dlp on 2026-05-07, showing uploader as PanSci and view count above 1.03 million.

[^yt-news46]: [PanSci YouTube: PanSci NEWS EP46: Is This Okay? Replacing Exercise with Medicine! The True Face of Plant Toxins](https://www.youtube.com/watch?v=x__seBgp4HE) — Official channel video from 2026-02-13, used as a case of the 2026 science news video format.

[^mirror]: [Mirror Media: One-Shot Interview / The Angry Young Man Is Middle-Aged: PanSci Co-founder Cheng Kuo-wei](https://www.mirrormedia.mg/story/20260402pol001) — A 2026 profile describing the short-video transition, science news script workflow, and traffic anxiety.

[^lis]: [PanSci reprint of LIS interview: PanSci Co-founder Cheng Kuo-wei: The First Step of Scientific Literacy Is Bravely Admitting That You Do Not Know](https://pansci.asia/archives/356365) — Cheng Kuo-wei on scientific literacy and “admitting that one does not know.”
