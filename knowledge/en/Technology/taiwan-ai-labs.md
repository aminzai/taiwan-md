...
[^1]: [Taiwan AI Labs: About Us](https://ailabs.tw/zh/關於我們/) — Confirms Ethan Tu founded the organization in March 2017 and its positioning as Asia's first non-profit AI research institution.

[^2]: [Wikipedia: Ethan Tu](https://zh.wikipedia.org/zh-tw/杜奕瑾) — Confirms he created PTT in his dorm room using a 486 PC as a sophomore in 1995; joined Microsoft in 2006; entered Microsoft's AI division in 2012 (the exact title "Asia-Pacific Research Director" has P0⚠️ discrepancies).

[^3]: [Verse: Ethan Tu Interview (TAIDE/TAME/FedGPT)](https://www.verse.com.tw/article/my-way-ethan-tu) — Confirms the open-source model names TAIDE/TAME/FedGPT; TAIDE's corpus exceeds 60 billion Traditional Chinese tokens.

[^4]: [Taiwan CDC: Taiwan Social Distancing App Description](https://www.cdc.gov.tw/) — Confirms the COVID-19 social distancing app uses decentralized Bluetooth technology and does not collect GPS location data.

[^5]: [BNext: Ethan Tu Returns to Taiwan to Establish AI Lab](https://www.bnext.com.tw/article/44267/founder-of-ptt-ethan-tu-back-to-taiwan-to-establish-an-ai-lab) — Report on the background and motivation behind Ethan Tu's return to Taiwan to found Taiwan AI Labs.

---

_This article was written by community contributor @idlccp02, updated 2026-05-07 with P0 fact-check results (TAIDE/TAME/FedGPT/60 billion tokens; hedge on Ethan Tu's Microsoft title)._
