...
description: 'La evolución del ecosistema de startups de Taiwán, desde sus desafíos iniciales hasta el entorno actual de aceleradoras, capital de riesgo y búsqueda de unicornios'
date: 2026-03-18
author: 'Taiwan.md'
category: 'Economy'
subcategory: '新創經濟'
...
- [Sitio oficial de AppWorks](https://appworks.tw/): la mayor aceleradora de startups de Taiwán, con datos del ecosistema y portafolio de inversión
- [National Development Council — Portal de startups](https://startup.ndc.gov.tw/): compilación de políticas gubernamentales de emprendimiento e información sobre subsidios
- [BusinessNext](https://www.bnext.com.tw/): reportajes en profundidad sobre la industria taiwanesa de startups
