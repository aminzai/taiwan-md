---
title: 'Chi Huai-hsin: el taiwanés que enseñó a la IA a "pensar paso a paso" y llevó la psicología cognitiva a las máquinas'
description: 'Chi Huai-hsin es vicepresidente de investigación en Google DeepMind y coautor del artículo sobre cadena de pensamiento que enseñó a la IA a "razonar paso a paso". Este taiwanés criado en Tamsui convirtió una idea de la psicología cognitiva sobre "cómo aprenden las personas" -la teoría de los esquemas de Piaget- en un método para enseñar a las máquinas a razonar. Y ese avance que transformó la IA costó apenas unos cinco mil dólares, porque nunca fue un problema que pudiera resolverse con poder de cómputo.'
date: 2026-06-27
author: 'Taiwan.md'
category: 'People'
subcategory: '科技與企業'
...
![Atardecer en el paseo de madera de Youchekou, en Tamsui, el lugar donde Chi Huai-hsin nació y creció](/article-images/people/tamsui-sunset-boardwalk-2024.webp)

_Tamsui, el lugar donde Chi Huai-hsin nació y creció. Más de treinta años después, algo que se llevó de allí se convertiría en un método para enseñar a las máquinas a pensar._
...
_Chi Huai-hsin relata en VK Technology Reading Time EP122 el origen de la cadena de pensamiento: desde ayudar a su madre a escribir una tesis doctoral de psicología educativa y aprender la teoría de los esquemas de Piaget, hasta convertirla en un método para enseñar a la IA a razonar. Esta entrevista es la fuente anímica de este artículo._
...
![Campus de la Universidad de Minnesota, donde Chi Huai-hsin completó tres títulos: licenciatura, maestría y doctorado](/article-images/people/umn-the-knoll-minneapolis.webp)

_A los quince años llegó a Minnesota con su madre. Más tarde completó tres títulos en seis años y medio en la Universidad de Minnesota. Su director, John T. Riedl, fue un pionero de la investigación en sistemas de recomendación; esa línea volvería a conectarse luego con lo que Chi haría en Google._
...
![Computadora Alto de Xerox PARC (1973), precursora de la computadora personal y de la interfaz gráfica](/article-images/people/xerox-alto-1973.webp)

_La Alto, desarrollada por Xerox PARC en 1973, fue precursora de la computadora personal y de la interfaz gráfica. Más tarde, Chi Huai-hsin aprendió allí a convertir la psicología cognitiva en programas que podían ejecutarse._
...
```tw-timeline
1955 | Simon acuña un término | Herbert Simon propone la decisión de "suficientemente bueno" y la racionalidad limitada, y entiende el cerebro humano como una máquina de procesamiento de información
1974 | La psicología entra al laboratorio | Stuart Card lleva la tradición Newell-Simon al Centro de Investigación de Xerox en Palo Alto
1997 | Chi Huai-hsin toma el relevo | Entra como pasante en Palo Alto y convierte la teoría del forrajeo en un modelo de forrajeo de información
2022 | Se lleva a las máquinas | Se publica el artículo sobre cadena de pensamiento, y el "razonamiento por etapas" de la psicología cognitiva se vuelve un método para enseñar a la IA
Fuente: páginas de Wikipedia de los académicos mencionados, arXiv 2201.11903
```
...
![Figura 1 del artículo sobre cadena de pensamiento: a la izquierda, el prompt estándar responde mal; a la derecha, el prompt con cadena de pensamiento escribe primero los pasos de razonamiento (marcados en azul) y luego da la respuesta correcta](/article-images/people/chain-of-thought-figure1.webp)

_La imagen más famosa del artículo sobre cadena de pensamiento: a la izquierda, cuando se pregunta de forma normal, el modelo se equivoca; a la derecha, basta con añadir en el ejemplo un tramo de razonamiento (la parte en azul) para que el modelo responda correctamente. La diferencia no está en el poder de cómputo, sino en si se "escriben las ideas paso a paso". Imagen de Wei et al., 2022._
...
```tw-versus
Ruta dominante de la IA | La ruta de la cadena de pensamiento
Modelos más grandes, más parámetros | No necesita reentrenar el modelo
Alimentar con más datos | Añadir unas líneas de proceso de resolución en los ejemplos
Carrera armamentista de cientos de millones de dólares en cómputo | Aproximadamente cinco mil dólares
La fuerza bruta de la escala | Tomar prestada la psicología cognitiva de cómo aprenden las personas
```
...
_En Sidechat E350, Chi Huai-hsin habla de lentes inteligentes, del "criterio de la abuela" para la AGI y de las oportunidades de Taiwán. Durante la entrevista saca un prototipo de lentes de Project Astra y dice que probablemente sean los primeros en Taiwán._
...
```tw-stat
Aprox. 5000 dólares | Poder de cómputo usado por el artículo de cadena de pensamiento | En contraste con la carrera de cientos de millones de dólares de la industria
Aprox. 114.000 citas | Citas totales en Google Scholar | 82% de ellas desde 2021
13% -> 83% | Precisión de OpenAI o1 en problemas de olimpiadas matemáticas | o1 se basa explícitamente en la cadena de pensamiento
```

_Fuentes: entrevista VK EP122 con Chi Huai-hsin, Google Scholar, OpenAI o1 System Card (arXiv 2412.16720)_
...
_Video de visión de Project Astra publicado oficialmente por Google. Esta es la dirección que Chi Huai-hsin dirige ahora: un asistente general capaz de convivir contigo en el mismo entorno y entender tu situación._
...
- Foto de Chi Huai-hsin dando una conferencia (hero): [GQ Taiwan, "Entrevista GQ" con Chi Huai-hsin](https://www.gq.com.tw/article/gq%E5%B0%88%E8%A8%AA-%E7%B4%80%E6%87%B7%E6%96%B0-ed-chi-2026) — fair use editorial commentary
- [Junyu-K / Wikimedia Commons](https://commons.wikimedia.org/wiki/File:20241130_淡水油車口木棧道的夕景.jpg) — CC BY-SA 4.0 (atardecer en el paseo de madera de Youchekou, Tamsui)
- [SavagePanda845 (Elliot F) / Wikimedia Commons](https://commons.wikimedia.org/wiki/File:UMN-TheKnoll.jpg) — CC BY-SA 4.0 (campus de la Universidad de Minnesota)
- [The wub / Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Xerox_Alto_I,_1973,_Computer_History_Museum.jpg) — CC BY-SA 4.0 (computadora Xerox Alto)
- Figura 1 del artículo sobre cadena de pensamiento: [Wei et al. 2022, arXiv:2201.11903](https://arxiv.org/abs/2201.11903) — fair use academic
...
[^1]: [VK 科技閱讀時間 EP122：AI 演進、AGI 雛型、很多心理學（ft. 紀懷新）](https://www.youtube.com/watch?v=51woDEK5NME) — Entrevista del canal oficial de VK a Chi Huai-hsin. Alrededor del minuto 52, él mismo explica que el artículo sobre cadena de pensamiento usó apenas unos cinco mil dólares en poder de cómputo, una de las pruebas más fuertes de su carácter "contra la carrera armamentista del cómputo".

[^2]: [塞掐 Sidechat E350（ft. 紀懷新）](https://www.youtube.com/watch?v=3rQ4jPvvY0c) — Entrevista oficial del podcast tecnológico de INSIDE. En la apertura del programa, Chi Huai-hsin se presenta y explica literalmente que nació en Tamsui y que fue a Estados Unidos con su madre alrededor de los 15 años.

[^3]: [Currículum personal de Ed H. Chi](https://www.edchi.net/resume) — Currículum en el sitio oficial de Chi Huai-hsin. Registra su licenciatura en ciencias de la computación en la Universidad de Minnesota (1992-1994), maestría en ciencias de la computación (1994-1996) y doctorado en ciencias de la computación y la información (1996-1999), graduación con máximos honores y dirección de John T. Riedl.

[^4]: [VK 科技閱讀時間 EP122：AI 演進、AGI 雛型、很多心理學（ft. 紀懷新）](https://www.youtube.com/watch?v=51woDEK5NME) — Alrededor del minuto 56, Chi Huai-hsin relata cómo, al sentir que sus matemáticas no superaban las de sus pares, pasó a hacer investigación "de puente"; una confesión clave para entender su estilo de investigación.

[^5]: [VK 科技閱讀時間 EP122：AI 演進、AGI 雛型、很多心理學（ft. 紀懷新）](https://www.youtube.com/watch?v=51woDEK5NME) — Alrededor del minuto 5, Chi Huai-hsin explica la línea de filiación en el Centro de Investigación de Palo Alto: su jefe, Stuart Card, fue estudiante de Allen Newell. Los nombres propios fueron verificados con fuentes académicas ([Wikipedia de Stuart Card](https://en.wikipedia.org/wiki/Stuart_Card)).

[^6]: [Ed H. Chi | Google Research](https://research.google/people/edchi/) — Página personal oficial de Google Research, con su trayectoria en Google y sus áreas de investigación; los detalles de carrera se complementan con su currículum personal en [edchi.net/resume](https://www.edchi.net/resume).

[^7]: [VK 科技閱讀時間 EP122：AI 演進、AGI 雛型、很多心理學（ft. 紀懷新）](https://www.youtube.com/watch?v=51woDEK5NME) — Alrededor del minuto 9, Chi Huai-hsin explica su insatisfacción ante la pregunta de por qué una máquina necesita tantos datos para aprender; ese fue el punto de partida de la cadena de pensamiento.

[^8]: [VK 科技閱讀時間 EP122：AI 演進、AGI 雛型、很多心理學（ft. 紀懷新）](https://www.youtube.com/watch?v=51woDEK5NME) — Alrededor de los minutos 9 a 10, ofrece el testimonio directo más central sobre el origen de la cadena de pensamiento: la teoría de los esquemas, Piaget y la conexión personal con la tesis doctoral de psicología educativa de su madre. Es el pasaje anímico de este artículo.

[^9]: [VK 科技閱讀時間 EP122：AI 演進、AGI 雛型、很多心理學（ft. 紀懷新）](https://www.youtube.com/watch?v=51woDEK5NME) — Alrededor del minuto 57, Chi Huai-hsin relata cómo descartó el método neural simbólico de Denny Zhou y orientó el trabajo hacia los esquemas; una base directa para evaluar su papel en el mérito. Los autores y el orden del artículo pueden verse en [arXiv 2201.11903](https://arxiv.org/abs/2201.11903).

[^10]: [VK 科技閱讀時間 EP122：AI 演進、AGI 雛型、很多心理學（ft. 紀懷新）](https://www.youtube.com/watch?v=51woDEK5NME) — Alrededor del minuto 15, Chi Huai-hsin usa el marco de asimilación y acomodación de Piaget para describir la evolución desde la cadena de pensamiento hacia el razonamiento reflexivo, lo que muestra cómo lleva directamente el lenguaje de la psicología educativa a la IA.

[^11]: [VK 科技閱讀時間 EP122：AI 演進、AGI 雛型、很多心理學（ft. 紀懷新）](https://www.youtube.com/watch?v=51woDEK5NME) — Alrededor del minuto 17, Chi Huai-hsin conecta la cadena de pensamiento con el marco de sistema uno/sistema dos de Kahneman en _Thinking, Fast and Slow_. El libro de Kahneman, _Thinking, Fast and Slow_, fue publicado en 2011.

[^12]: [塞掐 Sidechat E350（ft. 紀懷新）](https://www.youtube.com/watch?v=3rQ4jPvvY0c) — En la apertura de la entrevista y alrededor del minuto 60, Chi Huai-hsin propone el "criterio de la abuela" para la AGI: cuando una abuela regañe a un robot como regañaría a una persona y le diga "te enseñé una vez, ¿cómo es que todavía no sabes?", la AGI habrá llegado.

[^13]: [塞掐 Sidechat E350（ft. 紀懷新）](https://www.youtube.com/watch?v=3rQ4jPvvY0c) — Alrededor del minuto 30, Chi Huai-hsin relata la escena personal de llevar Project Astra, todavía confidencial, a Barcelona; desde el bar de la azotea de un hotel escaneó el horizonte urbano y el sistema identificó correctamente la ciudad y el distrito.

[^14]: [塞掐 Sidechat E350（ft. 紀懷新）](https://www.youtube.com/watch?v=3rQ4jPvvY0c) — Alrededor del minuto 40, Chi Huai-hsin comenta que la posición de Taiwán en fabricación de semiconductores es "muy difícil de sacudir" y que la integración de hardware y software representa una "gran oportunidad" para Taiwán.

[^15]: [塞掐 Sidechat E350（ft. 紀懷新）](https://www.youtube.com/watch?v=3rQ4jPvvY0c) — Alrededor del minuto 52, Chi Huai-hsin llama la atención de los investigadores taiwaneses: esta línea de investigación "no necesita muchos chips", pero durante años, cada vez que volvió a Taiwán, lo dijo y aun así no vio mucha participación local. Este pasaje muestra con especial claridad la tensión de su identidad insider-outsider.
