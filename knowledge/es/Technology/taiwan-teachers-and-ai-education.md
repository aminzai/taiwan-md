...
![Estudiantes de la Escuela Secundaria Baozhong del condado de Yunlin usando la plataforma Junyi](/article-images/technology/taiwan-students-digital-learning-2019.webp)
_Estudiantes de la Escuela Secundaria Baozhong del condado de Yunlin tomando clases en la plataforma Junyi, 2019. La foto es anterior a la ola de IA generativa, pero marca el punto de partida cotidiano de las herramientas digitales entrando en las aulas taiwanesas. Foto: Sitio web de la Escuela Secundaria Baozhong, CC BY 2.0._
...
```tw-stat
92% | Ha usado la IA frecuentemente o ocasionalmente | Pincheng × Google, 4,765 encuestas de profesores
95.6% | Indica que aún necesita aprender sobre IA | Fondo Educativo de Profesor Huang Kun-hui, 3,328 encuestas de profesores
81.7% | Espera la creación de una comunidad de aprendizaje de IA entre escuelas | La misma encuesta del fondo
...
En junio de 2026, el Ministerio de Educación anunció el "Plan del Arca del Talento para la IA" (para los años 115-118), con tres direcciones: construir un entorno de aprendizaje y un nuevo sistema de aprendizaje; formar talento docente multidisciplinario y establecer capacidades digitales y asistencia práctica; y usar los datos educativos para apoyar la toma de decisiones pedagógicas. La política ha avanzado de "proporcionar herramientas" a "formar talento" y "asistencia práctica", lo que al menos muestra que una sola compra no es suficiente para cambiar el aula.[^6]

![Gráfico de las tres direcciones del Plan del Arca del Talento de IA del Ministerio de Educación, incluyendo entorno de aprendizaje, talento multidisciplinario y toma de decisiones basada en datos](/article-images/technology/taiwan-moe-ai-talent-ark-2026.webp)
_El Ministerio de Educación condensó su plan para 2026-2029 en tres direcciones: entorno de aprendizaje, talento docente multidisciplinario y toma de decisiones basada en datos. Mi interés está en la segunda parte, "asistencia práctica", una vez que sale del gráfico político y entra en la semana de un maestro. Imagen: Ministerio de Educación, 2026, edición del gráfico de política oficial._
...
| :-------------------------------------------------- | :---------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------- |
| `taiwan-students-digital-learning-2019.webp` (hero) | Estudiantes de la Escuela Secundaria Baozhong usando la plataforma Junyi, 2019                        | [Sitio web de la Escuela Secundaria Baozhong, vía Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Baozhong_Junior_High_School_Students_Using_Junyi_Academy.jpg) | CC BY 2.0                               |
| `taiwan-moe-ai-talent-ark-2026.webp`                | Gráfico de las tres direcciones del Plan del Arca del Talento de IA del Ministerio de Educación, 2026 | [Plan del Arca del Talento de IA del Ministerio de Educación](https://www.edu.tw/News_Content.aspx?n=4F8ED5441E33EA7B&s=B8CC264D791737F0)                                  | Edición del gráfico de política oficial |

## Referencias

[^1]: [“Se sienten solos después de la capacitación” Él crea un mercado de agencias de IA](https://www.cw.com.tw/article/5140065) — Entrevista especial con Xu Tai-ping en "Tianxia", 2026, sobre el taller de la Escuela Primaria Da Jia y su plataforma compartida con unas trescientas agencias.

[^2]: [¿La carga de trabajo no disminuye sino que aumenta? Gran encuesta sobre los desafíos de la transformación digital escolar](https://teachersblog.edu.tw/info/2472) — Encuesta realizada por Pincheng (親子天下) en colaboración con Google for Education, presentando resultados de 4,765 muestras de docentes sobre enseñanza digital y uso de IA.

[^3]: [“Resultados de la encuesta sobre las necesidades y expectativas de los maestros respecto a la aplicación de la IA en la educación”](https://www.hkh-edu.com/news2025/1220-news.html) — El Fondo Educativo de Profesor Huang Kun-hui presenta el método, las necesidades de aprendizaje, los recursos y las expectativas de comunidad entre escuelas basadas en 3,328 encuestas en línea.

[^4]: [Teaching for today’s world: Results from TALIS 2024](https://www.oecd.org/en/publications/results-from-talis-2024_90df6235-en/full-report/teaching-for-today-s-world_eefb146b.html) — Informe oficial en inglés de la OCDE, que proporciona la proporción y el uso de la IA por parte de los maestros de secundaria en sistemas educativos, así como las diferencias entre países.

[^5]: [En una clase de informática del Instituto de Neihu se crea un servicio al cliente con IA; los estudiantes actúan como "clientes" buscando fallas](https://www.cna.com.tw/news/ahel/202607070204.aspx) — Reportaje de CNA en julio de 2026 sobre los casos prácticos de Luo Ching-te, Lin Ying-jun y Cai Bang-ju que combinan IA, seguridad y currículo existente.

[^6]: [Plan del Arca del Talento para la IA (Años 115–118)](https://www.edu.tw/News_Content.aspx?n=4F8ED5441E33EA7B&s=B8CC264D791737F0) — El Ministerio de Educación anunció tres direcciones políticas en junio de 2026, cubriendo el entorno de aprendizaje, el talento docente multidisciplinario y la toma de decisiones educativa.

[^7]: [What you need to know about UNESCO’s new AI competency frameworks](https://www.unesco.org/en/articles/what-you-need-know-about-unescos-new-ai-competency-frameworks-students-and-teachers?hub=343) — Explicación oficial de la UNESCO en inglés, que enumera las cinco áreas de competencia de IA para maestros y los principios de desarrollo educativo humano y ético a largo plazo.
