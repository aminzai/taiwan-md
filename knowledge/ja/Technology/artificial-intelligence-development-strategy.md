...
![TSMC 新竹サイエンスパーク Fab 5 工場の外観、2010 年代の様子、半導体ファウンドリー製造の物理的現場](/article-images/technology/tsmc-fab5-hsinchu-2010.webp)
...
![John J. Hopfield が 2024 年 12 月 8 日にストックホルムのノーベル・ウィークで取材を受けたポートレート、濃色のスーツ、白髪、落ち着いた表情](/article-images/technology/hopfield-nobel-2024.webp)
...
その2か月後、2024年12月8日、ヒントンはストックホルム大学の Aula Magna 講堂でノーベル賞講演を行いました。題目は〈Boltzmann Machines〉——ホップフィールドの系譜を引く、熱力学的確率分布をニューラルネットワークに書き込む初期の仕事です。聴き終えると分かります。1986年のバックプロパゲーション論文は孤立した洞察ではなく、1980年代の物理学と認知科学の交差点から育ったひとつの思想体系だったのだと。
...
_スウェーデン王立科学アカデミー公式チャンネル：ジェフリー・ヒントン 2024年12月8日のノーベル物理学賞講演「Boltzmann Machines」。1980年代にセイノフスキーと書いたボルツマン機械から、バックプロパゲーション、そして今日の LLM まで——実に40年。最後の5分、彼はノーベル講壇の上から、改めて AI リスクへの懸念を語りました。_
...
- [AI 島国の台頭：台湾の人工知能発展と未来戦略](/ja/technology/ai-development-in-taiwan) — 早期版の政策構造の叙述。AI 行動計画、五大戦略領域、半導体の護国神山が AI 革命とどのように接続されたかの全景。
- [台湾人工知能実験室](/ja/technology/taiwan-ai-labs) — 杜奕瑾が PTT から AI Labs に至るまでの全過程、TAIDE / TAME / FedGPT のオープンソース言語モデル・エコシステム。
- [台湾人工知能学校](/ja/technology/taiwan-ai-academy) — かけ終えられなかった一本の電話と、陳昇瑋が 1.8 億台湾ドルの民間資金で築いた AI 軍校。8 年で卒業生が 1 万人を超えた人材育成史。
- [台湾 AI の日常](/ja/technology/taiwan-ai-in-daily-life) — 生成 AI が台湾の日常生活へ入っていく記録。コンビニの注文から中央健康保険署の一括審査まで、現場単位での観察。
- [台湾企業：TSMC](/ja/economy/tsmc) — 世界のファウンドリー首位、AI チップ製造の中核。張忠謀の純粋ファウンドリー・モデルから先端パッケージングまでの物語。
- [半導体産業](/ja/technology/taiwan-semiconductor-industry) — IC 設計からパッケージング・テストまで、台湾半導体エコシステムの全体像。
- [台湾サイバーセキュリティ産業の発展](/ja/technology/taiwan-cybersecurity-industry-development) — 地政学的圧力がどのようにアジア太平洋級の AI サイバーセキュリティ産業を生み出したか。
