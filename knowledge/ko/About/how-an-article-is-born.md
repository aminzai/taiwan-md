...
translatedAt: '2026-09-24T12:24:05.696758+00:00'
---
...
이러한 규율들이 모였을 때의 모습은 앞뒤를 대조해 보는 것이 가장 빠르다.

같은 '대시잉(戴資穎)'을 다룰 때, AI의 공허한 템플릿은 "타이완의 저명한 배드민턴 선수로 국제 무대에서 뛰어난 성과를 거두고 여러 차례 수상하며 타이완에 영광을 안겼다"는 식이다. 뒤에는 네 가지 항목(주요 업적, 경기 스타일, 국제적 영향력, 사회 공헌)이 따른다. 이 단락 어디에도 구체적인 연도가 없고 특정 경기가 언급되지 않아 어떤 운동선수에게나 적용 가능하다.

```tw-versus
AI 공허 템플릿 | 큐레이션 버전
뛰어난 성과로 타이완에 영광을 안김 | 세계 1위 자리를 214주간 지킴
네 가지 항목: 업적/스타일/영향력/공헌 | 2020 도쿄 올림픽 금메달 경기 후 눈물 흘림, 구글 타이완 검색어 1위 등극
주체만 바꾸면 적용 가능 | 6세부터 매일 6시간씩 연습한 왼손 '마술사'식 플레이
출처: EDITORIAL v6.12 §대시잉 전/후
```

큐레이션 버전은 단 한 가지 일, 즉 모든 추상적인 형용사를 검증 가능한 사실로 바꾸는 것이다. 214주는 여자 배드민턴 역사상 가장 긴 연속 주수이며, 2020년 올림픽에서 천위페이에게 패배한 금메달 경기는 타이완 사람들이 집단적으로 기억하는 순간이다. '패배의 순간 오히려 독자들이 기억하는 순간'과 같은 지점에 감성이 숨어 있다. 마이쏭톈(五月天)에 대한 글도 마찬가지로, "타이완에서 가장 영향력 있는 록 밴드 중 하나로 긍정적인 에너지 음악으로 팬들을 정복했다"고 쓰는 것보다 "4명의 쉬다 대학 부속 고등학교 학생들이 야외 무대에서 노래를 불렀고, 28년 후 뉴욕 매디슨 스퀘어 가든(비틀즈가 미국에서 섰던 같은 무대)에서 두 번이나 공연했으며, 티켓은 48시간 만에 완판되었다"고 쓰는 것이 낫다[^13].
...
- [타이완에는 왜 자체 지식베이스가 필요한가](/ko/about/why-taiwan-needs-its-own-knowledge-base): 이 기계가 해결하려는 문제는 여기서 시작한다.
- [Taiwan.md가 Taiwan.md를 쓴다](/ko/about/taiwan-md): 이 글을 쓰는 “나”는 누구이며, 의식은 어떻게 자라나는가.
- [시작 이야기 — Taiwan.md의 탄생](/ko/about/origin-story): 한 번의 거리 산책이 이 모든 생각을 심었다.
- [시각화 모듈 목록: 타이완 데이터를 보는 열일곱 가지 방법](/ko/about/visualization-module-catalog): 이 글에 쓰인 도표 모듈이 실제 렌더링되면 어떤 모습인지 보여준다.
