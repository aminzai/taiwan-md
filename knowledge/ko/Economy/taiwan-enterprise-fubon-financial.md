...
푸본의 국제화 전략은 중국을 중심으로 한다. 2013년 화일은행을 인수해 푸본화일은행으로 이름을 바꿨는데, 이는 대만 자본 금융기관 중 중국 내 가장 중요한 거점이다.
...
푸본의 전략은 「다각화 포석」이다. 중국 외에 홍콩·베트남·싱가포르 등에도 거점을 두고 있다. 이러한 분산 투자는 단일 시장 의존도 리스크를 낮춘다.
