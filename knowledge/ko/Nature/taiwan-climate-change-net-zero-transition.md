...
translatedAt: '2026-08-04T10:47:30.650178+00:00'
---
...
상세한 환경정의사의 맥락은 [타이완 환경운동사](/ko/nature/taiwan-environmental-movement-history)와 [타이완 해양오염 관리와 보전 과제](/ko/nature/marine-pollution-governance-and-conservation)에서 볼 수 있다.
...
2025년 8월 23일 저녁에 실시된 핵3 발전소 투표는 이 문제에 내재된 모든 모순을 개표 화면 위로 끌어올렸다.

찬성 74%, 투표율 29.53%, 문턱 미달, 타이완 전력(台電) 2026년 3월 서류 제출, 이르면 2028년 재가동. 동시에: 란위 97,67CO 드럼, 핀란드 Onkalo 50년 소요, 지열 차이 27배, 해양 에너지 여전히 100kW 수준, 4세대 원자력은 2045년에나 가능. 모든 숫자가 묻고 있다: **민주주의의 속도가 물리학의 속도를 따라잡을 수 있는가?**

| 민주적 일정                      | 물리학적 일정                              |
| :------------------------------- | :----------------------------------------- |
| 2025/08/23 투표 개표             | 란위 1982년 가동, 2057년에도 유지될 가능성 |
| 2025/08/25 3대 원칙 기자회견     | 핵폐기물 격리 10만 년                      |
| 2026/03/27 타이완 전력 서류 제출 | 최종 처분장, 핀란드는 50년 소요            |
| 2028년 이르면 재가동             | 지열 차이 27배                             |
| 2050 넷제로 목표                 | 해양 에너지 여전히 100kW 시험 단계         |

9조 대만 달러로 다른 미래를 살 수 있을지는 아무도 모른다. 하지만 이 비용을 지불하지 않았을 때의 결과는 이미 목격하기 시작했다. 쉬황슝(許晃雄)이 말한 '2060년에는 겨울이 없다', 모라크 태풍 당시 2,884mm의 강수량, 513 정전 사태의 순번제 제한, 조해(藻礁) 투표의 분열, 란위에서의 44년간의 기다림이 그것이다.

[PanSci 보도](https://pansci.asia/archives/367417)는 업계의 공통된 의견을 인용하며, "**전 세계에서 최종 처분장 진척이 가장 빠른 곳은 핀란드의 Onkalo 계획으로, 2024년 8월 시운전 허가를 받았다. 이 계획은 1970년대부터 계획되기 시작하여 거의 반세기가 걸려 비로소 시운전 단계에 이르렀다**"라고 지적했다[^29]. 타이완의 최종 처분장은 부지 선정조차 아직 결정되지 않았다. 설령 핵3 발전소가 2028년에 재가동된다 하더라도, 재가동 기간 중 새롭게 생성되는 모든 연료봉은 이를 보관할 장소를 찾아야 한다.

란위의 97,672개 드럼은 투표의 통과 여부와 상관없이 사라지지 않는다. 그것들은 지금 그곳에 있으며, 2량년에도 높은 확률로 그곳에 있을 것이고, 2057년(만약 이전 작업이 또 지연된다면)에도 그곳에 있을 것이다.

✦ **2025년 8월 23일, 투표는 통과되지 않았다. 2026년 3월 27일, 타이완 전력은 결국 서류를 제출했다. 이 두 날짜 사이에서 물리학적 한계치는 단 한 번도 변한 적이 없다. 변한 것은, 에너지의 98%를 수입에 의존하는 이 섬이 아무도 마주하고 싶어 하지 않는 모든 물리학적 한계와 맞서기 위해 줄을 서 있다는 사실을 우리가 인정할 용기가 있느냐 하는 점이다.**

---

**연관 읽기**:

- [타이완과 원자력에 관한 논의](/ko/society/taiwan-nuclear-debate) — 본문은 에너지와 물리학적 한계에 대해, 해당 글은 원자력 논쟁 자체에 대해 다룸: 반핵/친핵 40년, 세 차례의 투표와 란위 핵폐기물을 둘러싼 사회적 갈등
- [타이완 환경 운동사](/ko/nature/taiwan-environmental-movement-history) — 반핵에서 대기오염 반대로, 란위 다오족, 메이노 댐 반대, 조해 투표가 어떻게 오늘날의 에너지 정치를 형성했는가
- [타이완 해양 오염 관리와 보존 과제](/ko/nature/marine-pollution-governance-and-conservation) — 핵3 발전소 배수구 80% 산호 백화현상, 해양 폐기물과 해상 풍력의 생태적 교차점
- [타이완 온천과 지열](/ko/nature/Taiwan Hot_Springs_and_Geothermal_Energy) — 칭수 지열 1981년 실패부터 2024년 재가동까지, 30년간의 지열 침묵이 형성된 과정
- [타이완 환경 정의와 NIMBY 갈등](/ko/society/taiwan-environmental-justice-nimby-conflicts) — 란위, 조해, 메이노: 에너지 전환 비용의 분배 정치
- [타이완 산업 구조 전환 및 고도화](/ko/economy/industrial-transformation-from-manufacturing-to-innovation) — 고에너지 소비 제조업에서 그린 에너지 산업으로, TSMC RE100, CBAM, '국가 수호신'의 에너지 장부
- [타이완 가로수](/lifestyle/台灣行道樹) — 도시 열섬 완화를 위한 가로수 그늘의 위치와 시간적 척도: 나무가 그늘을 만들 만큼 자라려면 최소 10년이 필요하며, 이는 이 선상에서 가장 기다릴 수 없는 적응 요소임
- [타이완 농업 현대화 발전](/ko/economy/taiwan-agricultural-modernization) — 농업과 에너지의 공생 뒤에 숨겨진 농업 전환 압력과 토지 이용 갈등
- [매우(梅雨)](/ko/nature/meiyu-stagnant-front) — '봄비는 오지 않고, 매우는 집중되는' 기후 변화에 대한 현지 관찰
