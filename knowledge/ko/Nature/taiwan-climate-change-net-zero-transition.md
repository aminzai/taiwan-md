...
translatedAt: '2026-09-19T13:13:40.960115+00:00'
---
...
2025년 8월 23일 밤의 핵삼 공표는, 이 모든 갈등을 개표 화면 위로 끌어올렸다.

74% 찬성, 29.53% 투표율, 문턱 미충족, 타이전 2026년 3월 제출, 최속 2028년 재가동. 동시에: 란유 97,672개, 핀란드 온칼로 50년, 지열 27배 차이, 해양에너지는 아직 100kW 실험단계, 4세대 핵에너지는 2045년. 모든 숫자가 묻고 있다: 민주의 속도가 물리의 속도를 따라잡을 수 있을까?

| 민주적 시점                | 물리적 시점                         |
| -------------------------- | ----------------------------------- |
| 2025/08/23 공표 개표       | 란유 1982년 가동, 2057년까지 가능성 |
| 2025/08/25 삼원칙 기자회견 | 핵폐료 10만 년 격리 필요            |
| 2026/03/27 타이전 제출     | 최종 처리장 핀란드 50년 소요        |
| 2028 최속 재가동           | 지열 27배 차이                      |
| 2050 순제로 목표           | 해양에너지 아직 100kW 실험          |

9조 대만 달러가 다른 미래를 살 수 있을지 누구도 알지 못한다. 하지만 이 돈을 쓰지 않을 때의 결과는 이미 보기 시작했다: 허홍수의 2060년 무겨울, 모라크의 2,884mm, 513번 정전 교대, 조개초 공표의 갈등, 란유의 44년 대기.

[PanSci 보도](https://pansci.asia/archives/367417)에서 산업계 합의를 인용하면, "전 세계 최종 처리장 진행 속도가 가장 빠른 것은 핀란드의 온칼로 계획으로, 2024년 8월 시운전 허가를 받았다. 이 계획은 1970년대에 시작되어 거의 반 세기 동안 시운전 단계에 도달하는 데 걸렸다"[^29]고 한다. 대만의 최종 처리장은 아직 부지 선정조차 끝나지 않았다. 심지어 핵삼이 2028년 재가동된다 하더라도, 재가동 기간 동안 새로 발생하는 모든 연료 막대는 처리할 장소를 찾아야 한다.

란유의 97,672개 막대는 공표가 통과하든 통과하지 않든 사라지지 않는다. 지금 그곳에 있고, 2029년에도 거의 확실히 그곳에 있을 것이며, 2057년(이사 연기가 또다시 늦어진다면)에도 그곳에 있을 것이다.

✦ 2025년 8월 23일, 공표는 통과하지 않았다. 2026년 3월 27일, 타이전은 여전히 제출했다. 이 두 날짜 사이에 물리적 한계는 단 한 번도 변하지 않았다. 변한 것은, 우리가 이 98% 에너지를 수입에 의존하는 섬이, 모든 사람이 피하고 싶어 하는 물리적 한계를 마주하기 위해 줄 서 있는 것을 인정할 것인지 여부이다.

---

**관련 읽기**:

- [대만과 핵에너지에 대한 논의](/ko/society/taiwan-nuclear-debate) — 본 글는 에너지와 물리적 한계를 다루고, 그 글은 핵에너지 논쟁 자체를 다룬다: 반핵/전핵 40년, 세 차례 공표와 란유 핵폐료의 사회적 갈등
- [대만 환경운동사](/ko/nature/taiwan-environmental-movement-history) — 반핵에서 공해 저감까지, 란유 달루족, 미농 반발 저항, 조개초 공표가 오늘날 에너지 정치를 어떻게 형성했는가
- [대만 해양 오염 관리와 보전 과제](/ko/nature/marine-pollution-governance-and-conservation) — 핵삼 발전소 배수구 80% 조개초 화이트블, 해양 폐기물과 해상 풍력의 생태적 교차점
