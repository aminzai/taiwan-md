...
2017년부터 2023년까지 기록된 삵의 로드킬은 130마리 이상이다.[^2] 발견되지 않은 것이 얼마나 되는지는 아무도 모른다.
...
2021년부터 농업부는 '삵 생태 지급 방안'을 추진했다.[^3] 삵 서식지 범위 안에서 친환경 농법(독이 든 미끼 미사용, 덫 미사용)을 채택한 농민은 헥타르당 최대 2만 위안의 보조금을 받는다. 자동 카메라에 삵이 포착되면 추가로 1만 위안이 지급된다.
...
**아후(阿虎)**, 농업부 생물다양성연구소(생다소)의 삵은 인공번식 프로그램에 참여하고 있다.[^4] 인공번식으로 태어나는 삵 새끼 한 마리 한 마리가 뉴스가 된다.
...
결국 여론의 압박 속에서 먀오리현은 2019년 12월 10일 대만 최초의 삵 보전 자치조례를 3독 통과시켰다.[^1] 그러나 이 과정 자체가, 대만의 '말로만 하는 보전'과 '실제 행동' 사이의 거대한 괴리를 보여주는 고전적 사례가 되었다.
...
- [워워: 과소평가된 위협 — 개에 의한 삵 피살](https://wuo-wuo.com/topics/widlife/dogkill) — 개 피살 사례 기록.
- [농업부 임업 및 자연보전서](https://www.forest.gov.tw/) — 삵 서식지 보전 정책.
- [삵 보전 홍보대사 — 아후 가족](https://www.facebook.com/LeopardCatTaiwan/) — 생다소 삵 인공번식 근황.
