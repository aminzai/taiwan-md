...
![TSMC 신주과학단지 Fab 5 공장 외관, 2010년대 모습. 반도체 파운드리 제조의 물리적 현장](/article-images/technology/tsmc-fab5-hsinchu-2010.webp)
...
두 달 뒤, 2024년 12월 8일, 힌튼은 스톡홀름 대학교 Aula Magna 강당에서 노벨상 강연을 했다. 제목은 〈Boltzmann Machines〉였다. 힌튼과 호프필드가 이어받은 열역학 확률분포를 신경망에 쓰는 초기 연구였다. 강연을 들으면 알 수 있다. 1986년 backpropagation 논문은 고립된 통찰이 아니라, 1980년대 물리학과 인지과학이 교차하는 지점에서 자라난 하나의 사유 체계에서 나온 것이었다.
...
_스웨덴 왕립과학원 공식 채널: 제프리 힌튼의 2024년 12월 8일 노벨 물리학상 강연 「Boltzmann Machines」. 1980년대 세이노프스키와 함께 쓴 볼츠만 머신부터 backpropagation, 그리고 오늘의 LLM까지 통틀어 40년이다. 마지막 5분에서 그는 AI 위험에 대한 우려를 다시 말했다. 이번에는 노벨 강단에 서서._
...
- [AI 섬나라의 부상: 대만 인공지능 발전과 미래 전략](/ko/technology/ai-development-in-taiwan) — 초기 버전의 정책 구조 서사. AI 행동계획, 5대 전략 분야, 반도체 호국신산이 AI 혁명과 어떻게 접목되는지의 전경.
- [대만 인공지능 실험실](/ko/technology/taiwan-ai-labs) — 두이진이 PTT에서 AI Labs까지 걸어온 전체 과정, TAIDE / TAME / FedGPT 오픈소스 언어모델 생태계.
- [대만 인공지능 학교](/ko/technology/taiwan-ai-academy) — 끝까지 걸지 못한 그 전화, 그리고 천성웨이가 민간 모금 1억 8천만 원으로 세운 AI 사관학교. 8년 동안 동문 1만 명을 넘긴 인재 양성사.
- [대만 AI 일상](/ko/technology/taiwan-ai-in-daily-life) — 생성형 AI가 대만의 일상생활에 들어온 기록. 편의점 주문부터 건강보험서의 일괄 심사까지, 장면 단위의 관찰.
- [대만 기업: TSMC](/ko/economy/tsmc) — 전 세계 파운드리 선두 기업이자 AI 칩 제조의 핵심. 모리스 창의 순수 파운드리 모델부터 첨단 패키징까지의 이야기.
- [반도체 산업](/ko/technology/taiwan-semiconductor-industry) — IC 설계부터 패키징·테스트까지, 대만 반도체 생태계의 전체상.
- [대만 보안 산업 발전](/ko/technology/taiwan-cybersecurity-industry-development) — 지정학적 압력이 어떻게 아시아태평양급 AI 보안 산업을 낳았는가.
