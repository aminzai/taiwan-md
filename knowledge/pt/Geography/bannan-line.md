---
title: 'Linha Bannan: os 26,5 km que cosem duas cidades no subsolo'
description: 'Em 24 de dezembro de 1999, a Linha Bannan primeiro conectou Ximen, Longshan Temple e a Prefeitura; depois, estendeu-se até Dingpu e o Centro de Exposições de Nangang. Esta linha subterrânea de 23 estações e 26,5 km reescreveu os tempos de deslocamento, fluxos comerciais, percursos a pé e imaginários de solo entre Banqiao, Taipé e Nangang, deixando também as perguntas de quem acolhe o fluxo de pessoas, quem arca com a mudança e como os últimos 500 metros são percorridos.'
date: 2026-08-21
category: 'Geography'
tags:
  [
...
# Linha Bannan: os 26,5 km que cosem duas cidades no subsolo
...
![Comboio C371 do Metro de Taipé, a carroceria azul é uma das memórias visuais mais reconhecíveis da Linha Bannan.](https://commons.wikimedia.org/wiki/Special:FilePath/Taipei_MRT_Train_C371_3CarSet_No_3398.JPG)
_Imagem: Jiahwang／Wikimedia Commons, CC BY-SA 2.5. A foto mostra um comboio C371 do Metro de Taipé, tirada na Estação Beitou, não sendo um comboio exclusivo da Linha Bannan.[^10]_
...
![Mapa oficial da rede do Metro de Taipé em 2023, a Linha Bannan assinalada a azul.](https://commons.wikimedia.org/wiki/Special:FilePath/2023_Taipei_MRT_official_map.png)
_Imagem: Metro de Taipé／Wikimedia Commons, sob anúncio de dados abertos do site governamental do Metro de Taipé, com indicação de fonte.[^11]_
...
A Linha Bannan também mudou a forma como as pessoas imaginam a moradia. Um estudo tomando como objeto as estações entre Longshan Temple e Prefeitura, analisando o volume de entrada/saída por estação, o valor atual do solo anunciado nas redondezas e o índice de preços de habitação por distrito, descobriu que, após a chegada do metro, a reação positiva do imobiliário comercial foi maior que a do residencial. O estudo também indica que a área da estação pode virar uso comercial pelo aumento de fluxo, enquanto a habitação se desloca para a periferia da estação.[^5]

Não é a história simples de "o metro inaugura e o preço da casa sobe". Uma análise de políticas aponta que a variação de preços do "imobiliário de metro" costuma concentrar-se antes e depois da inauguração; à medida que a rede se completa e a conveniência se generaliza, a sensação de escassez original diminui. Morar perto do metro não é garantia de valorização eterna.[^6]
...
Durante a obra do trecho de Nangang, a equipe de engenharia também lidou com a preservação histórica. A página oficial em inglês relata que, durante a construção, foram descobertos pilares de pedra e de madeira da fundação da antiga muralha de Taipé; parte dos elementos foi escavada, restaurada e exposta no local da rua subterrânea da Rua Zhongxiao Oeste.[^8] Isso faz da obra subterrânea do metro não apenas a instalação de um novo sistema, mas também a trazida de vestígios da cidade antiga para um novo espaço público.
...
![Plataforma da Estação Prefeitura, mostrando o corpo de estação subterrâneo e a escala da plataforma no trecho leste da Linha Bannan.](https://commons.wikimedia.org/wiki/Special:FilePath/Taipei_City_Hall_Metro_Station_Platform.jpg)
_Imagem: Robert S. Donovan／Wikimedia Commons, CC BY 2.0. Foto na Estação Prefeitura.[^13]_

O significado da Estação Centro de Exposições de Nangang não se limita a empurrar a linha azul mais para leste. O Departamento de Engenharia lista separadamente os projetos arquitetônicos das estações da Linha Bannan para Nangang e Centro de Exposições, colocando o Centro de Exposições e o Parque de Software de Nangang no mesmo contexto de desenho urbano. A estação torna-se assim porta de entrada onde indústria, exposições e baldeação se reconhecem mutuamente, não apenas uma caixa subterrânea para embarque e desembarque.[^16]
...
![Plataformas 3 e 4 da Estação Principal de Taipé, passageiros cruzam a plataforma no nó de baldeação.](https://commons.wikimedia.org/wiki/Special:FilePath/Platform_3_%26_4,_MRT_Taipei_Main_Station_20190812.jpg)
_Imagem: NG LAU Hears／Wikimedia Commons, CC BY-SA 4.0. Foto de 12 de agosto de 2019 na Estação Principal de Taipé.[^14]_

As estatísticas de transporte da Companhia de Metro de Taipé incluem a Linha Bannan no sistema de alta capacidade. Dados oficiais fornecem totais anuais e mensais das linhas de alta capacidade, mas não desagregam os números da Linha Bannan isoladamente; por isso, este artigo não confunde o total de alta capacidade com o volume de uma única linha.[^9]
...
- [Companhia de Metro de Taipé: apresentação da linha](https://www.metro.taipei/cp.aspx?n=CCF30033E6ED8008): ver rede atual e estações, extensão da Linha Bannan.
- [Departamento de Engenharia de Transporte Rápido do Governo da Cidade de Taipé: explicação do traçado da Linha Bannan](https://www.dorts.gov.taipei/cp.aspx?n=5E61169F8C735065): ver histórico de engenharia do trecho de Nangang e decisões de subterranização.

## Fontes das imagens

Ficheiro de imagem: [File:Taipei MRT Train C371 3CarSet No 3398.JPG](https://commons.wikimedia.org/wiki/File:Taipei_MRT_Train_C371_3CarSet_No_3398.JPG), autor Jiahwang, Wikimedia Commons, Creative Commons Attribution-ShareAlike 2.5 Generic. Foto de 24 de julho de 2006 na Estação Beitou; este artigo insere via hotlink do Commons, sem descarregar a imagem.

Ficheiro de imagem: [File:MRT Taipei Main Station Platform 1 20070503.jpg](https://commons.wikimedia.org/wiki/File:MRT_Taipei_Main_Station_Platform_1_20070503.jpg), autor Taiwan Junior, Wikimedia Commons, CC BY-SA 3.0. Inserção via hotlink do Commons, sem descarregar.

Ficheiro de imagem: [File:2023 Taipei MRT official map.png](https://commons.wikimedia.org/wiki/File:2023_Taipei_MRT_official_map.png), titular dos direitos: Metro de Taipé, conforme anúncio de dados abertos do site governamental.

Ficheiro de imagem: [File:Taipei City Hall Metro Station Platform.jpg](https://commons.wikimedia.org/wiki/File:Taipei_City_Hall_Metro_Station_Platform.jpg), autor Robert S. Donovan, Wikimedia Commons, CC BY 2.0. Inserção via hotlink do Commons, sem descarregar.

Ficheiro de imagem: [File:Platform 3 & 4, MRT Taipei Main Station 20190812.jpg](https://commons.wikimedia.org/wiki/File:Platform_3_%26_4,_MRT_Taipei_Main_Station_20190812.jpg), autor NG LAU Hears, Wikimedia Commons, CC BY-SA 4.0. Inserção via hotlink do Commons, sem descarregar.

## Referências

[^1]: [Departamento de Engenharia de Transporte Rápido do Governo da Cidade de Taipé: Linha Bannan—Explicação do traçado de Nangang](https://www.dorts.gov.taipei/cp.aspx?n=5E61169F8C735065) — Registo oficial do traçado de Nangang, dificuldades de engenharia, mudanças no planeamento da linha azul, coordenação de subterranização, função de baldeação em Nangang e dados de inauguração por etapas entre 1999 e 2000.

[^2]: [Companhia de Transporte Rápido de Massa de Taipé: Cronologia](https://www.metro.taipei/cp.aspx?n=B27E7BC8CBBCDA61) — Anuário oficial da companhia, regista a inauguração do trecho Dingpu–Yongning da Linha Bannan em 2015 e o aumento de extensão operacional, entre outros marcos de desenvolvimento da rede.

[^3]: [Companhia de Transporte Rápido de Massa de Taipé: Apresentação da linha](https://www.metro.taipei/cp.aspx?n=CCF30033E6ED8008) — Dados atuais da rede da companhia, lista a Linha Bannan Dingpu–Centro de Exposições de Nangang, 26,5 km, 23 estações e totalmente subterrânea, entre outras informações básicas.

[^4]: [Sistema de Valorização do Conhecimento de Teses e Dissertações de Taiwan: Impacto da inauguração da Linha Bannan no comércio do Templo Longshan](https://ndltd.ncl.edu.tw/handle/83149587825388381296) — Resumo da tese de mestrado de Cheng Ting-wen (2010), compila resultados de pesquisa sobre a percepção de comerciantes e consumidores quanto a conveniência de transporte, conversão de receita, ligação pedonal e planeamento comercial.

[^5]: [Biblioteca Online Huayi: Estudo sobre a influência do fluxo de pessoas nas estações de metro nos preços imobiliários circundantes](https://www.airitilibrary.com/Article/Detail/U0002-2007200921240000) — Resumo da tese de mestrado de Lo Wei-cheng (2009), com as estações Longshan Temple a Prefeitura da Linha Bannan como âmbito, analisa fluxo, preços do solo e diferença entre imóveis comerciais e residenciais.

[^6]: [Fundação Nacional de Pesquisa de Políticas: Imobiliário de metro já não é o que era](https://www.npf.org.tw/2/18617) — Análise de políticas de Hsieh Ming-jui (2018), discute variação de preços antes e depois da inauguração do metro, desenvolvimento conjunto e limites da homogeneização da conveniência após rede completa.

[^7]: [Perfil de investigação da Universidade Nacional Yang Ming Chiao Tung: Estratégia de desenvolvimento orientado ao transporte em Taiwan](https://scholar.nycu.edu.tw/en/publications/transit-oriented-development-strategy-in-taiwan-an-application-of/) — Página de detalhes do estudo de Yen, Feng e Lee publicado em 2023 na _Asian Transport Studies_, com ligação ao DOI e artigo em acesso aberto, analisa normas TOD de Taipé, raio de 500 metros da estação, bônus de volumetria e mecanismo de captura de mais-valia do solo.

[^8]: [Department of Rapid Transit Systems: The MRT—More Than Just Transportation](https://english.dorts.gov.taipei/cp.aspx?n=DF8A2EBD88679100) — Artigo oficial em inglês do Departamento de Engenharia de Transporte Rápido de Taipé, explica espaço do metro, arte pública, desenho das estações do trecho de Nangang, ruas subterrâneas e preservação de elementos da antiga muralha.

[^9]: [Companhia de Transporte Rápido de Massa de Taipé: Dados estatísticos anuais e do mês anterior de volume de transporte](https://www.metro.taipei/cp.aspx?n=FED7CC0F31E0A664) — Página oficial de estatísticas da companhia, explica que a estatística de alta capacidade inclui a Linha Bannan, e fornece totais anuais e mensais com notas de unidade.

[^10]: [Wikimedia Commons: File:Taipei MRT Train C371 3CarSet No 3398.JPG](https://commons.wikimedia.org/wiki/File:Taipei_MRT_Train_C371_3CarSet_No_3398.JPG) — Página de detalhes da imagem, regista autor Jiahwang, data da foto, local e licença Creative Commons Attribution-ShareAlike 2.5 Generic.

[^11]: [Wikimedia Commons: File:2023 Taipei MRT official map.png](https://commons.wikimedia.org/wiki/File:2023_Taipei_MRT_official_map.png) — Página de detalhes do mapa oficial da rede do Metro de Taipé, indica o Metro de Taipé como titular dos direitos, fornecido conforme anúncio de dados abertos do site governamental com exigência de citação de fonte.

[^12]: [Wikimedia Commons: File:MRT Taipei Main Station Platform 1 20070503.jpg](https://commons.wikimedia.org/wiki/File:MRT_Taipei_Main_Station_Platform_1_20070503.jpg) — Página de detalhes da imagem, regista autor Taiwan Junior, data da foto e local (primeira plataforma da Estação Principal de Taipé), com licença CC BY-SA 3.0.

[^13]: [Wikimedia Commons: File:Taipei City Hall Metro Station Platform.jpg](https://commons.wikimedia.org/wiki/File:Taipei_City_Hall_Metro_Station_Platform.jpg) — Página de detalhes da imagem, regista autor Robert S. Donovan, fonte Flickr, local (Estação Prefeitura) e licença CC BY 2.0.

[^14]: [Wikimedia Commons: File:Platform 3 & 4, MRT Taipei Main Station 20190812.jpg](https://commons.wikimedia.org/wiki/File:Platform_3_%26_4,_MRT_Taipei_Main_Station_20190812.jpg) — Página de detalhes da imagem, regista autor NG LAU Hears, local (plataformas 3 e 4 da Estação Principal de Taipé) e licença CC BY-SA 4.0.

[^15]: [Departamento de Engenharia de Transporte Rápido do Governo da Cidade de Taipé: Linha Bannan—Explicação do traçado do prolongamento leste de Nangang](https://www.dorts.gov.taipei/cp.aspx?n=5E61169F8C735065&s=D392F4A16D3932DF) — Detalha oficialmente o prolongamento leste de 2,5 km de Kunyang ao Centro de Exposições de Nangang, duas estações, estrutura de três ferrovias, custo da obra e inaugurações por etapas em 2008 e 2011.

[^16]: [Departamento de Engenharia de Transporte Rápido do Governo da Cidade de Taipé: Desenho arquitetônico das estações—Linha Bannan](https://www.dorts.gov.taipei/cp.aspx?n=980C85299DA2890A&s=30FCACCAB334BFA2) — Entrada oficial dos projetos das estações da Linha Bannan, lista separadamente Nangang e Centro de Exposições de Nangang, e insere o Centro de Exposições e o Parque de Software de Nangang no mesmo contexto de desenho urbano da estação.
