---
title: 'Ed Chi: o taiwanês que ensinou a IA a "pensar passo a passo" levou a psicologia cognitiva para dentro da máquina'
description: 'Ed Chi é vice-presidente de pesquisa do Google DeepMind e coautor do artigo Chain of Thought, que fez a IA aprender a "raciocinar passo a passo". Este taiwanês nascido em Tamsui transformou o conceito de "como as pessoas aprendem" da psicologia cognitiva (a teoria dos esquemas de Piaget) num método para ensinar máquinas a raciocinar. E o avanço que mudou a IA custou apenas cerca de cinco mil dólares, porque nunca foi um problema resolvível com mais poder de computação.'
date: 2026-06-27
category: 'People'
tags:
  [
...
translatedAt: '2026-07-27T04:56:50+08:00'
---
...
![Pôr do sol no passadiço de madeira de Youchekou, Tamsui, onde Ed Chi nasceu e cresceu](/article-images/people/tamsui-sunset-boardwalk-2024.webp)

_Tamsui, onde Ed Chi nasceu e cresceu. Trinta e tantos anos depois, o que ele levou dali viraria método para ensinar máquinas a pensar._
...
<div class="video-embed" style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;margin:1.5rem 0;border-radius:8px;">
  <iframe src="https://www.youtube.com/embed/51woDEK5NME" title="VK Tech Reading Time EP122 ft. Ed Chi" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>

_Ed Chi no VK Tech Reading Time EP122 conta em primeira pessoa a origem do Chain of Thought, desde ajudar a mãe com a tese de psicologia da educação, aprender a teoria dos esquemas de Piaget, até transformar isso em método para ensinar IA a raciocinar. Esta entrevista é a fonte viva deste artigo._
...
![Campus da Universidade de Minnesota, onde Ed Chi concluiu licenciatura, mestrado e doutorado, três diplomas](/article-images/people/umn-the-knoll-minneapolis.webp)

_Aos quinze anos foi com a mãe para Minnesota; depois, na Universidade de Minnesota, gastou seis anos e meio a tirar três diplomas. O orientador John T. Riedl é pioneiro na investigação de sistemas de recomendação: esta linha mais tarde ligar-se-ia ao que ele fez no Google._
...
![Computador Alto do Xerox PARC (1973), pioneiro do computador pessoal e da interface gráfica](/article-images/people/xerox-alto-1973.webp)

_O Alto, desenvolvido pelo Xerox PARC em 1973, é pioneiro do computador pessoal e da interface gráfica. Ed Chi esteve lá depois e aprendeu a transformar psicologia cognitiva em programa que roda._
...
```tw-timeline
1955 | Simon cria termo | Herbert Simon propõe "satisficing" e racionalidade limitada, vê o cérebro como máquina de processamento de informação
1974 | Psicologia entra no laboratório | Stuart Card leva a tradição Newell-Simon para o Xerox PARC
1997 | Ed Chi pega o bastão | Estagia no PARC, engenheira a teoria do forrageamento óptimo em modelo de forrageamento de informação
2022 | Entra na máquina | Artigo Chain of Thought publicado, "raciocínio passo a passo" da psicologia cognitiva vira método para ensinar IA
Fontes: Wikipédias dos académicos, arXiv 2201.11903
```
...
![Figure 1 do artigo Chain of Thought: à esquerda prompt padrão erra, à direita Chain of Thought escreve passos de raciocínio (fundo azul) e acerta](/article-images/people/chain-of-thought-figure1.webp)

_A figura mais famosa do artigo Chain of Thought: à esquerda, pergunta-se do modo padrão, o modelo erra; à direita, apenas se acrescenta um trecho de processo de raciocínio nos exemplos (a parte a azul), e o modelo acerta. A diferença não está no poder de computação, está em ter ou não "escrito o pensamento passo a passo". Figura de Wei et al., 2022._
...
```tw-versus
Mainstream da IA | Caminho do Chain of Thought
Modelos maiores, mais parâmetros | Não precisa re-treinar o modelo
Enfiar mais dados | Acrescentar algumas linhas de resolução nos exemplos
Centenas de milhões em armamento computacional | Cerca de cinco mil dólares
Busca de escala pela força bruta | Emprestar da psicologia cognitiva como as pessoas aprendem
```
...
<div class="video-embed" style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;margin:1.5rem 0;border-radius:8px;">
  <iframe src="https://www.youtube.com/embed/3rQ4jPvvY0c" title="Sakai Sidechat E350 ft. Ed Chi" style="position:absolute;top:0;left:0;width:100%;height:100%;border:0;" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>

_Ed Chi no Sakai Sidechat E350 fala de óculos inteligentes, padrão da avó para AGI e oportunidade de Taiwan. Na entrevista tira do bolso uns óculos protótipo com Project Astra, diz que "deve ser" o primeiro par em Taiwan._
...
```tw-stat
~ 5 000 USD | Poder de computação gasto no artigo Chain of Thought | Contra centenas de milhões da indústria
~ 114 000 | Citações totais no Google Scholar | 82% depois de 2021
13% → 83% | Precisão do OpenAI o1 em problemas da Olimpíada de Matemática | o1 construído explicitamente sobre Chain of Thought
```

_Fonte: entrevista VK EP122 de Ed Chi, Google Scholar, OpenAI o1 System Card (arXiv 2412.16720)_
...
_Vídeo de visão do Project Astra lançado oficialmente pelo Google, esta é a direção que Ed Chi lidera agora: um assistente universal que convive no mesmo ambiente que você, entende o seu contexto._
...
- Foto de Ed Chi em palestra (hero): [GQ Taiwan "Entrevista GQ" Ed Chi](https://www.gq.com.tw/article/gq%E5%B0%88%E8%A8%AA-%E7%B4%80%E6%87%B7%E6%96%B0-ed-chi-2026) — fair use comentário editorial
- [Junyu-K / Wikimedia Commons](https://commons.wikimedia.org/wiki/File:20241130_淡水油車口木棧道的夕景.jpg) — CC BY-SA 4.0 (pôr do sol no passadiço de Youchekou, Tamsui)
- [SavagePanda845 (Elliot F) / Wikimedia Commons](https://commons.wikimedia.org/wiki/File:UMN-TheKnoll.jpg) — CC BY-SA 4.0 (campus da Universidade de Minnesota)
- [The wub / Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Xerox_Alto_I,_1973,_Computer_History_Museum.jpg) — CC BY-SA 4.0 (computador Xerox Alto)
- Figure 1 do artigo Chain of Thought: [Wei et al. 2022, arXiv:2201.11903](https://arxiv.org/abs/2201.11903) — fair use académico
...
[^1]: [VK Tech Reading Time EP122: Evolução da IA, embrião de AGI, muita psicologia (c/ Ed Chi)](https://www.youtube.com/watch?v=51woDEK5NME) — entrevista oficial do canal VK, Ed Chi em pessoa. Por volta dos 52 min explica que o artigo Chain of Thought usou apenas ~5 000 USD de computação, a prova mais direta de "anti-armamento computacional".

[^2]: [Sakai Sidechat E350 (c/ Ed Chi)](https://www.youtube.com/watch?v=3rQ4jPvvY0c) — podcast de tecnologia do INSIDE, entrevista oficial. Na abertura Ed Chi apresenta-se, diz textualmente que nasceu em Tamsui, emigrou aos ~15 anos com a mãe.

[^3]: [Currículo de Ed H. Chi](https://www.edchi.net/resume) — site oficial de Ed Chi, regista licenciatura em Eng. Informática na Universidade de Minnesota (1992–1994), mestrado (1994–1996), doutorado em Ciência da Computação e Informação (1996–1999), Summa Cum Laude, orientador John T. Riedl.

[^4]: [VK Tech Reading Time EP122: Evolução da IA, embrião de AGI, muita psicologia (c/ Ed Chi)](https://www.youtube.com/watch?v=51woDEK5NME) — por volta dos 56 min, Ed Chi relata que, por a matemática não ser melhor que a dos pares, virou para investigação "ponte", auto-retrato chave para entender o seu estilo.

[^5]: [VK Tech Reading Time EP122: Evolução da IA, embrião de AGI, muita psicologia (c/ Ed Chi)](https://www.youtube.com/watch?v=51woDEK5NME) — por volta dos 5 min, Ed Chi explica a linhagem do PARC, chefe Stuart Card aluno de Allen Newell. Nomes próprios corrigidos contra fontes académicas ([Stuart Card Wikipédia](https://en.wikipedia.org/wiki/Stuart_Card)).

[^6]: [Ed H. Chi | Google Research](https://research.google/people/edchi/) — página oficial do Google Research, regista trajetória e áreas de pesquisa na Google; detalhes de carreira noutra fonte no currículo pessoal [edchi.net/resume](https://www.edchi.net/resume).

[^7]: [VK Tech Reading Time EP122: Evolução da IA, embrião de AGI, muita psicologia (c/ Ed Chi)](https://www.youtube.com/watch?v=51woDEK5NME) — por volta dos 9 min, Ed Chi expõe a insatisfação com "por que tanta data para a máquina aprender", ponto de partida do Chain of Thought.

[^8]: [VK Tech Reading Time EP122: Evolução da IA, embrião de AGI, muita psicologia (c/ Ed Chi)](https://www.youtube.com/watch?v=51woDEK5NME) — por volta dos 9–10 min, relato nuclear em primeira pessoa da origem do Chain of Thought: teoria dos esquemas, Piaget, e a ligação pessoal de ajudar a mãe com a tese de psicologia da educação. Alma deste artigo.

[^9]: [VK Tech Reading Time EP122: Evolução da IA, embrião de AGI, muita psicologia (c/ Ed Chi)](https://www.youtube.com/watch?v=51woDEK5NME) — por volta dos 57 min, Ed Chi relata ter vetado o neural symbolic do Denny Zhou e virado para esquemas, processo decisivo para avaliar o seu papel. Autores e ordem no artigo em [arXiv 2201.11903](https://arxiv.org/abs/2201.11903).

[^10]: [VK Tech Reading Time EP122: Evolução da IA, embrião de AGI, muita psicologia (c/ Ed Chi)](https://www.youtube.com/watch?v=51woDEK5NME) — por volta dos 15 min, Ed Chi usa o quadro de assimilação/acomodação de Piaget para descrever a evolução do Chain of Thought para raciocínio reflexivo, mostra como leva a linguagem da psicologia da educação direto para a IA.

[^11]: [VK Tech Reading Time EP122: Evolução da IA, embrião de AGI, muita psicologia (c/ Ed Chi)](https://www.youtube.com/watch?v=51woDEK5NME) — por volta dos 17 min, Ed Chi liga Chain of Thought ao quadro Sistema 1/Sistema 2 de Kahneman em "Rápido e Devagar". Livro publicado em 2011.

[^12]: [Sakai Sidechat E350 (c/ Ed Chi)](https://www.youtube.com/watch?v=3rQ4jPvvY0c) — abertura e por volta dos 60 min da entrevista, Ed Chi propõe o "padrão da avó" para AGI: quando a avó ralhar com o robô "ensinei uma vez como é que ainda não sabes", a AGI chegou.

[^13]: [Sakai Sidechat E350 (c/ Ed Chi)](https://www.youtube.com/watch?v=3rQ4jPvvY0c) — por volta dos 30 min, Ed Chi narra ter levado o Project Astra ainda confidencial a Barcelona, no bar do terraço do hotel varrer o horizonte, ele identificar corretamente cidade e bairro, cena vivida por ele.

[^14]: [Sakai Sidechat E350 (c/ Ed Chi)](https://www.youtube.com/watch?v=3rQ4jPvvY0c) — por volta dos 40 min, Ed Chi comenta que a posição de fabrico de semicondutores de Taiwan "é muito difícil de abalar", e que integração hardware-software para Taiwan é "grande oportunidade".

[^15]: [Sakai Sidechat E350 (c/ Ed Chi)](https://www.youtube.com/watch?v=3rQ4jPvvY0c) — por volta dos 52 min, Ed Chi dirige-se a investigadores de Taiwan: esta pesquisa "não precisa de muitos chips" mas "volto há anos, cada vez falo e não vejo investigadores de Taiwan a investir". Trecho que melhor expõe a tensão identitária outsider-insider dele.
