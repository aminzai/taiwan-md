---
title: 'Hệ sinh thái Lanyu: Mật mã sự sống tại biên giới Dòng chảy Kuroshio'
description: 'Lanyu không thuộc về Taiwan, ít nhất về mặt sinh học. Hòn đảo nhỏ này ở cực bắc của cung đảo lửa Philippines, được lấp đầy bởi sự sống nhiệt đới mang theo bởi Dòng chảy Kuroshio, và trong trí tuệ sinh thái hàng nghìn năm của người Tao, đã tìm thấy sự cân bằng giữa con người và tự nhiên.'
date: 2026-04-01
category: 'Nature'
tags:
  [
    ...
    'loài đặc hữu',
    'cá bay',
    'Bướm phượng hoàng Lanyu',
    'Bọ tượng mũi heo lưng cầu',
    'bảo tồn',
    'sinh thái đảo',
    'sinh vật địa lý',
  ]
...
dừa (_Birgus latro_), hai cào mở rộng có thể đạt một mét, là động vật khớp chân to
...
Người Đa Vự có một cách gọi: Lan Dử tên là _Ponso no Tao_, nghĩa là "Đảo của con người". Không phải "khu bảo tồn tự nhiên", không phải "điểm du lịch", mà là nơi con người sinh sống.
