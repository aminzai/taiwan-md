...
last_generated: 2026-08-20 06:13
...
>
> Last generated: **2026-08-20 06:13** · 頂層 \*.md 共 **269** files · SSOT: [reports-archival-audit-2026-05-27.md §4 Layer 3](reports-archival-audit-2026-05-27.md)

## 📦 子目錄 status

| Subdir                  | Files | Size     | 用途                                                 |
| ----------------------- | ----: | -------- | ---------------------------------------------------- |
| `research/`             |   512 | 29.0 MB  | REWRITE-PIPELINE Stage 1 canonical (year-month 分槽) |
| `editorial-room/`       |    83 | 650.1 KB | —                                                    |
| `article-evolve/`       |    35 | 1.3 MB   | —                                                    |
| `article-projection/`   |    33 | 602.6 KB | —                                                    |
