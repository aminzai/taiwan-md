...
目前狀態：第一波與 Rewrite Guide 均已合併、正式部署並完成線上驗證。文件收官另以 PR #1685 留存。
...
Rewrite Guide PR #1684 六項 CI 通過，19:32:11 合併提交 `38a8e2af36d2da5c67473746bc13e8397f3a2b22`。部署 [run 34117125305](https://github.com/frank890417/taiwan-md/actions/runs/34117125305) 全部成功：20:03:28 建置完成、20:05:06 部署完成、20:06:12 線上字型閘門通過。正式瀏覽器看到共享編輯台標題及「Rewrite Guide · 互動工作協議」連結，目的地為 main 上的 REWRITE-GUIDE.md，console error 為空。Python urllib 的直連請求收到 403，故此入口驗收採實際瀏覽器結果，沒有將該請求記作 HTTP 200。
