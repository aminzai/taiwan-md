> ⚠️ **這是歷史快照，不是 canonical**：REWRITE-PIPELINE v6.7（2026-06-04，單檔 158KB）從 commit `b19194bea2`（2026-06-06 〈國宅與居住正義〉ship 當天）原封抽出，供 2026-09-19 「單檔案版 pipeline 順一遍」實驗的寫手完整讀。現行 canonical 是 v9 薄索引＋十個 stage contract。哲宇：「用單檔案版 rewrite-pipeline + editorial 來順一遍，我們看會不會好一點」。實驗結果進 reports/，不改 canonical。
...
# REWRITE-PIPELINE.md — 文章改寫主流程 v6.5
