...
def translate_chunk(backend, lang, chunk, guide_tldr):
    system = (
        f"You translate UI strings for taiwan.md (Taiwan knowledge base, Taiwan's own voice).\n"
        ...
        "4. Brand/product names (Taiwan.md, taiwan.md, GitHub, Threads, X, Astro, Ollama, "
        "CC BY-SA…) stay as-is.\n"
