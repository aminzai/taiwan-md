...
RANGES = {
    ...
    'fr':    (1.50, 2.00, 4.00),
    'de':    (1.50, 2.00, 4.00),
    'vi':    (1.50, 2.00, 4.20),  # 2026-07-18 provisional（拉丁+聲調符，Stage 2 校準後定案）
    'id':    (1.50, 2.00, 4.00),  # 2026-07-18 provisional
    'pt':    (1.50, 2.00, 4.00),  # 2026-07-18 provisional（借 es 姊妹 band）
    'hi':    (1.20, 1.60, 3.60),  # 2026-07-18 provisional（天城文較緊湊，Stage 2 校準後定案）
