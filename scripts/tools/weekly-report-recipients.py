#!/usr/bin/env python3
"""
weekly-report-recipients.py — Taiwan.md 週報收件人清單收成器 / weekly-report BCC harvester

中文：
Taiwan.md 的週報信會 BCC 給過去 N 天內對這個 repo 有貢獻或互動過的每一個人。
...
English:
Taiwan.md's weekly report email is BCC'd to everyone who contributed to or
...
def render_summary(
    ...
    lines: list[str] = []
    lines.append(f"# Taiwan.md 週報收件人活躍度摘要 — {repo}")
    lines.append("")
