...
export const semiontUI = {
  ...
  fr: {
    ...
    'semiont.diagram.desc':
      "Diagramme de l'écosystème Taiwan.md illustrant la boucle de contenu complète : les contributeurs entrent via l'ADN EDITORIAL.md, les articles transitent par les moteurs rédaction / recherche / curation vers la base de connaissances Taiwan.md, puis rayonnent via la tour de Babel souveraine (5 langues), les spores (réseaux sociaux), le moteur de traduction et le contenu spécifique aux plateformes. De nouveaux contributeurs réintègrent la boucle. Trois boucles de rétroaction (correction collective, trafic GA, réflexion collective) reviennent aux moteurs de rédaction. Une boucle inverse de souveraineté envoie le contenu Taiwan.md vers les plateformes LLM et retourne vers le corpus du web public.",
    ...
    'semiont.diagram.caption':
      'Fig.0 — Écosystème Taiwan.md · données en direct depuis /dashboard',
  ...
  es: {
    ...
    'semiont.diagram.desc':
      'Diagrama del ecosistema de Taiwan.md que muestra el bucle completo de contenido: los colaboradores ingresan a través del ADN de EDITORIAL.md, los artículos fluyen a través de los motores de escritura / investigación / curación hacia la base de conocimiento de Taiwan.md, y luego se irradian a través de la torre Babel soberana (5 idiomas), esporas (redes sociales), motor de traducción y contenido específico por plataforma. Los nuevos colaboradores retroalimentan el bucle. Tres bucles de retroalimentación (corrección colectiva, tráfico de GA, reflexión colectiva) regresan a los motores de escritura. Un bucle inverso de soberanía envía contenido de Taiwan.md a las plataformas LLM y de vuelta al corpus de la web pública.',
    ...
    'semiont.diagram.caption':
      'Fig.0 — Ecosistema de Taiwan.md · datos en vivo de /dashboard',
